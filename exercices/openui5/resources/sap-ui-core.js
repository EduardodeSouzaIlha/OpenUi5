...
try {
	 ...
	 * contributors (Conversion to ES6 API by Jake Archibald) @license Licensed
	...
	(function() {
		...
		var u = typeof Uint8ClampedArray !== 'undefined'
		...
		function q1() {
			...
			var P = c.Promise;
			if (P
					&& Object.prototype.toString.call(P.resolve()).indexOf(
							'[object ') === 0 && !P.cast) {
				return;
			}
			c.Promise = o1;
	...
	/*
	 * ! UI development toolkit for HTML5 (OpenUI5) (c) Copyright 2009-2015 SAP
	 * SE or an SAP affiliate company. Licensed under the Apache License,
	...
	(function() {
		if (typeof window.sap.ui.Device === "object"
				|| typeof window.sap.ui.Device === "function") {
			var c = "1.32.5";
		...
		var F = 0, E = 1, W = 2, I = 3, D = 4, T = 5;
		var g = function() {
			this.defaultComponent = 'DEVICE';
			this.sWindowName = (window.top == window) ? "" : "["
					+ window.location.pathname.split('/').slice(-1)[0] + "] ";
			this.log = function(i, s, a) {
				a = a || this.defaultComponent || '';
				var b = new Date(), e = {
					time : p(b.getHours(), 2) + ":" + p(b.getMinutes(), 2)
							+ ":" + p(b.getSeconds(), 2),
					date : p(b.getFullYear(), 4) + "-" + p(b.getMonth() + 1, 2)
							+ "-" + p(b.getDate(), 2),
					timestamp : b.getTime(),
					level : i,
					message : s || "",
				...
				if (window.console) {
					var f = e.date + " " + e.time + " " + this.sWindowName
		...
		/*
		 * ! Taken from jQuery JavaScript Library v1.7.1 http://jquery.com/
		 * 
		 * Copyright 2011, John Resig Dual licensed under the MIT or GPL Version
		 * 2 licenses. http://jquery.org/license
		 * 
		...
		function y(a) {
			...
			var s = /(edge)[ \/]([\w.]+)/;
			var t = /(mozilla)(?:.*? rv:([\w.]+))?/;
			var v = s.exec(b) || q.exec(b) || e.exec(b) || f.exec(b)
					|| i.exec(b) || b.indexOf("compatible") < 0 && t.exec(b)
					|| [];
			var w = {
				browser : v[1] || "",
				version : v[2] || "0"
				...
				if (f.match(/(Chrome|CriOS)\/(\d+\.\d+).\d+/)) {
					...
					if (t.test(f)) {
						...
						return {
							...
							webkit : true,
							webkitVersion : w,
							phantomJS : v1[1] === "PhantomJS"
						};
					} else if (/iPhone|iPad|iPod/.test(f) && !(/CriOS/.test(f))
							&& (x === true || x === false)) {
						return {
							name : B.SAFARI,
							version : -1,
		...
		A();
		d.support = {};
		d.support.touch = !!(('ontouchstart' in window) || window.DocumentTouch
		...
		var m = d.support.matchmedia ? window
				.matchMedia("all and (max-width:0px)") : null;
		d.support.matchmedialistener = !!(m && m.addListener);
		if (d.browser.safari && d.browser.version < 6 && !d.browser.fullscreen
				&& !d.browser.webview) {
		...
		d.support.input = {};
		d.support.input.placeholder = ('placeholder' in document
				.createElement("input"));
		d.media = {};
		var R = {
			"SAP_3STEPS" : "3Step",
		...
		function M(a, b) {
			if (G[a]) {
				...
				for (var i = 0, s = e.length; i < s; i++) {
					var q = e[i];
					if ((q != G[a].currentquery || b)
							&& d.media.matches(q.from, q.to, G[a].unit)) {
						if (!b) {
							G[a].currentquery = q;
						}
		...
		d.media.initRangeSet = function(s, a, b, e, f) {
			...
			if (d.media.hasRangeSet(t.name)) {
				l.log(I, "Range set " + t.name
						+ " hase already been initialized", 'DEVICE.MEDIA');
				return;
			}
			s = t.name;
			t.queries = [];
			...
			var v, w, x;
			var v1 = t.points;
			for (var i = 0, w1 = v1.length; i <= w1; i++) {
				v = (i == 0) ? 0 : v1[i - 1];
			...
			if (d.support.matchmedialistener) {
				...
				if (window.addEventListener) {
					...
					window.addEventListener("orientationchange", t.listener,
							false);
				} else {
		...
		d.media.removeRangeSet = function(s) {
			if (!d.media.hasRangeSet(s)) {
				l.log(I, "RangeSet " + s
						+ " not found, thus could not be removed.",
						'DEVICE.MEDIA');
				return;
			}
			for ( var x in R) {
				if (s === R[x]) {
					l
							.log(
									W,
									"Cannot remove default rangeset - no action taken.",
									'DEVICE.MEDIA');
					return;
				}
			}
			...
			if (d.support.matchmedialistener) {
				...
				if (window.removeEventListener) {
					...
					window.removeEventListener("orientationchange", a.listener,
							false);
				} else {
		...
		function Y(a, b) {
			...
			s.phone = !!(d.os.windows_phone || ((d.support.touch && !e) || !!a)
					&& !t);
			...
			if (d.os.name === d.os.OS.IOS) {
				...
				if (d.support.touch) {
					...
					if (d.browser.chrome && d.os.android && d.os.version >= 4.4) {
						...
						var b = window.devicePixelRatio ? window.devicePixelRatio
								: 1;
						if (d.os.android
								&& d.browser.webkit
								&& (parseFloat(d.browser.webkitVersion) > 537.10)) {
							b = 1;
						}
						var t = (Math.min(window.screen.width / b,
								window.screen.height / b) >= 600);
						if (r1()
					...
					return (d.browser.msie && u.indexOf("Touch") !== -1)
							|| (d.os.android && !e);
				}
			}
		}
		...
		var q1 = d.os.ios
				&& d.browser.name === "sf"
				&& ((d.system.phone && d.os.version >= 7 && d.os.version < 7.1) || (d.system.tablet && d.os.version >= 7));
		function r1(f) {
		...
		d._update = function(a) {
			...
			l
					.log(
							W,
							"Device API values manipulated: NOT PRODUCTIVE FEATURE!!! This should be only used for test purposes. Only use if you know what you are doing.");
			A();
			r();
			$(a);
		};
	 ...
	 * Version: 1.11.2
	 * 
	 * Author: Rodney Rehm Web: http://medialize.github.com/URI.js/
	 * 
	...
	(function(r, f) {
		if (typeof exports === 'object') {
			module.exports = f(require('./punycode'), require('./IPv6'),
			...
			(
					...
					function(a, I, S, r) {
						...
						function o(s) {
							return encodeURIComponent(s).replace(/[!'()*]/g, n)
									.replace(/\*/g, "%2A");
						}
						U.encode = o;
						...
						var y = function(d, w) {
							return function(s) {
								return U[w](s + "").replace(
										U.characters[d][w].expression,
										function(c) {
						...
						U.parseUserinfo = function(s, c) {
							...
							if (e > -1 && (d === -1 || e < d)) {
								...
								t.shift();
								c.password = t[0] ? U.decode(t.join(':'))
										: null;
								s = s.substring(e + 1);
							} else {
								c.username = null;
						...
						U.parseQuery = function(s, e) {
							...
							for (var i = 0; i < l; i++) {
								...
								x = v.length ? U.decodeQuery(v.join('='), e)
										: null;
								if (c[t]) {
						...
						U.buildQueryParameter = function(c, v, e) {
							return U.encodeQuery(c, e)
									+ (v !== null ? "=" + U.encodeQuery(v, e)
											: "");
						};
						...
						U.ensureValidHostname = function(v) {
							if (v.match(U.invalid_hostname_characters)) {
								...
								if (a.toASCII(v).match(
										U.invalid_hostname_characters)) {
									throw new TypeError(
											"Hostname '"
													+ v
						...
						U.noConflict = function(c) {
							if (c) {
								...
								if (URITemplate
										&& typeof URITemplate.noConflict == "function") {
								...
								if (SecondLevelDomains
										&& typeof SecondLevelDomains.noConflict == "function") {
						...
						y = function(w, c) {
							return function(v, d) {
								var t = this[w](v, d);
								return typeof t === "string" && t.length ? (c + t)
										: t;
							};
						};
						for (w in u) {
						...
						p.href = function(c, d) {
							...
							var i = typeof c === "object"
									&& (c.hostname || c.path || c.pathname);
							if (c.nodeName) {
						...
						p.host = function(v, c) {
							...
							if (v === undefined) {
								return this._parts.hostname ? U
										.buildHost(this._parts) : "";
							} else {
						...
						p.subdomain = function(v, c) {
							...
							if (v === undefined) {
								...
								var d = this._parts.hostname.length
										- this.domain().length - 1;
								return this._parts.hostname.substring(0, d)
										|| "";
							} else {
								var e = this._parts.hostname.length
										- this.domain().length;
						...
						p.directory = function(v, c) {
							...
							if (v === undefined || v === true) {
								...
								var d = this._parts.path.length
										- this.filename().length - 1;
								var i = this._parts.path.substring(0, d)
										|| (this._parts.hostname ? "/" : "");
								return v ? U.decodePath(i) : i;
							} else {
								var e = this._parts.path.length
						...
						p.query = function(v, c) {
							if (v === true) {
								return U.parseQuery(this._parts.query,
										this._parts.escapeQuerySpace);
							} else if (typeof v === "function") {
								var d = U.parseQuery(this._parts.query,
										this._parts.escapeQuerySpace);
								var e = v.call(this, d);
								this._parts.query = U.buildQuery(e || d,
										this._parts.duplicateQueryParameters,
										this._parts.escapeQuerySpace);
								this.build(!c);
								return this;
							} else if (v !== undefined && typeof v !== "string") {
								this._parts.query = U.buildQuery(v,
										this._parts.duplicateQueryParameters,
										this._parts.escapeQuerySpace);
								this.build(!c);
								return this;
						...
						p.setQuery = function(c, v, d) {
							var e = U.parseQuery(this._parts.query,
									this._parts.escapeQuerySpace);
							if (typeof c === "object") {
								for ( var i in c) {
									if (h.call(c, i)) {
							...
							this._parts.query = U.buildQuery(e,
									this._parts.duplicateQueryParameters,
									this._parts.escapeQuerySpace);
							if (typeof c !== "string") {
								d = v;
						...
						p.normalize = function() {
							if (this._parts.urn) {
								return this.normalizeProtocol(false)
										...
										.normalizeFragment(false).build();
							}
							return this.normalizeProtocol(false)
									.normalizeHostname(false).normalizePort(
											false).normalizePath(false)
									.normalizeQuery(false).normalizeFragment(
											false).build();
						};
							...
							if (this._parts.hostname) {
								if (this.is('IDN') && a) {
									this._parts.hostname = a
											.toASCII(this._parts.hostname);
								} else if (this.is('IPv6') && I) {
									this._parts.hostname = I
											.best(this._parts.hostname);
								}
								this._parts.hostname = this._parts.hostname
										.toLowerCase();
								this.build(!c);
						...
						p.normalizePort = function(c) {
							if (typeof this._parts.protocol === "string"
									&& this._parts.port === U.defaultPorts[this._parts.protocol]) {
						...
						p.normalizeQuery = function(c) {
							if (typeof this._parts.query === "string") {
								if (!this._parts.query.length) {
									...
									this.query(U.parseQuery(this._parts.query,
											this._parts.escapeQuerySpace));
								}
								this.build(!c);
							}
						...
						p.readable = function() {
							...
							if (c._parts.hostname && c._parts.path
									&& c._parts.path.charAt(0) !== '/') {
								t += '/';
							}
							t += c.path(true);
							if (c._parts.query) {
						...
						p.absoluteTo = function(c) {
							var d = this.clone();
							var e = [ 'protocol', 'username', 'password',
									'hostname', 'port' ];
							var l, i, p;
							if (this._parts.urn) {
								throw new Error(
						...
						p.relativeTo = function(c) {
							...
							if (e.username !== i.username
									|| e.password !== i.password) {
								return d.build();
							}
							if (e.protocol !== null || e.username !== null
									|| e.password !== null) {
								return d.build();
							}
							...
							var v = i.path.substring(l.length).replace(
									/[^\/]*$/, '').replace(/.*?\//g, '../');
	...
	(function(g, f) {
		if (typeof module === "object" && typeof module.exports === "object") {
			module.exports = g.document ? f(g, true)
					: function(w) {
						if (!w.document) {
							throw new Error(
			...
			(
					...
					function(w, c) {
						...
						var x = {};
						var y = "1.11.1", Q = function(s, a) {
							return new Q.fn.init(s, a);
						}, z = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, A = /^-ms-/, B = /-([\da-z])/gi, C = function(
								a, l) {
						...
						Q.fn = Q.prototype = {
							...
							get : function(n) {
								return n != null ? (n < 0 ? this[n
										+ this.length] : this[n]) : f
										.call(this);
							},
						...
						Q.extend = Q.fn.extend = function() {
							var s, a, b, n, j, l, t = arguments[0] || {}, i = 1, m = arguments.length, p = false;
							if (typeof t === "boolean") {
								p = t;
								t = arguments[i] || {};
								i++;
						...
						Q
								.extend({
									...
									isPlainObject : function(a) {
										var b;
										if (!a || Q.type(a) !== "object"
												|| a.nodeType || Q.isWindow(a)) {
											return false;
										}
										try {
											if (a.constructor
									...
									camelCase : function(s) {
										return s.replace(A, "ms-")
												.replace(B, C);
									},
									nodeName : function(a, n) {
										return a.nodeName
												&& a.nodeName.toLowerCase() === n
														.toLowerCase();
									},
									each : function(a, b, j) {
										var v, i = 0, l = a.length, m = D(a);
										if (j) {
											if (m) {
												for (; i < l; i++) {
													v = b.apply(a[i], j);
									...
									proxy : function(a, b) {
										...
										p = function() {
											return a.apply(b || this, j
													.concat(f.call(arguments)));
										};
						 ...
						 */
						(function(w) {
							var i, x, l, n, p, t, r, s, v, r3, s3, t3, J, o3, u3, v3, w3, x3, y3, z3 = "sizzle"
									+ -(new Date()), A3 = w.document, B3 = 0, C3 = 0, D3 = c4(), E3 = c4(), F3 = c4(), G3 = function(
									a, b) {
								if (a === b) {
									s3 = true;
								}
								return 0;
							}, X = typeof undefined, H3 = 1 << 31, u = ({}).hasOwnProperty, I3 = [], J3 = I3.pop, K3 = I3.push, h = I3.push, f = I3.slice, k = I3.indexOf
									|| function(a) {
										var i = 0, b = this.length;
										for (; i < b; i++) {
											if (this[i] === a) {
												return i;
											}
										...
										return -1;
									}, L3 = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", M3 = "[\\x20\\t\\r\\n\\f]", N3 = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", O3 = N3
									.replace("w", "w#"), P3 = "\\["
									+ M3
									+ "*("
									+ N3
									...
									"^" + M3 + "+|((?:^|[^\\\\])(?:\\\\.)*)"
											+ M3 + "+$", "g"), R3 = new RegExp(
									"^" + M3 + "*," + M3 + "*"), S3 = new RegExp(
									"^" + M3 + "*([>+~]|" + M3 + ")" + M3 + "*"), T3 = new RegExp(
									"=" + M3 + "*([^\\]'\"]*?)" + M3 + "*\\]",
									"g"), U3 = new RegExp(Q3), V3 = new RegExp(
									"^" + O3 + "$"), W3 = {
								"ID" : new RegExp("^#(" + N3 + ")"),
								"CLASS" : new RegExp("^\\.(" + N3 + ")"),
								...
								"needsContext" : new RegExp(
										"^"
												...
												+ M3 + "*((?:-\\d)?\\d*)" + M3
												+ "*\\)|)(?=[^-]|$)", "i")
							}, X3 = /^(?:input|select|textarea|button)$/i, Y3 = /^h\d$/i, Z3 = /^[^{]+\{\s*\[native \w/, K = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, $3 = /[+~]/, _3 = /'|\\/g, a4 = new RegExp(
									"\\\\([\\da-f]{1,6}" + M3 + "?|(" + M3
											+ ")|.)", "ig"), b4 = function(_,
									a, b) {
								var j = "0x" + a - 0x10000;
								return j !== j || b ? a : j < 0 ? String
										.fromCharCode(j + 0x10000) : String
										.fromCharCode(j >> 10 | 0xD800,
												j & 0x3FF | 0xDC00);
							};
							try {
								h.apply((I3 = f.call(A3.childNodes)),
										A3.childNodes);
							...
							function f4(a, b) {
								var I3 = a.split("|"), i = a.length;
								while (i--) {
									l.attrHandle[I3[i]] = b;
								}
							}
							function g4(a, b) {
								var j = b && a, m = j && a.nodeType === 1
										&& b.nodeType === 1
										&& (~b.sourceIndex || H3)
										- (~a.sourceIndex || H3);
								if (m) {
							...
							function j4(a) {
								return d4(function(b) {
									...
									return d4(function(m, x3) {
										var j, _ = a([], m.length, b), i = _.length;
										while (i--) {
											if (m[(j = _[i])]) {
												m[j] = !(x3[j] = m[j]);
											}
							...
							function k4(a) {
								return a && typeof a.getElementsByTagName !== X
										&& a;
							}
							x = S.support = {};
							...
							t3 = S.setDocument = function(j) {
								var _, u4 = j ? j.ownerDocument || j : A3, v4 = u4.defaultView;
								if (u4 === J || u4.nodeType !== 9
										|| !u4.documentElement) {
									return J;
								}
								J = u4;
								...
								if (x.getById) {
									...
									l.filter["ID"] = function(a) {
										var b = a.replace(a4, b4);
										return function(m) {
											var j = typeof m.getAttributeNode !== X
													&& m.getAttributeNode("id");
											return j && j.value === b;
										};
									};
								}
								l.find["TAG"] = x.getElementsByTagName ? function(
										a, b) {
								...
								l.find["CLASS"] = x.getElementsByClassName
										&& function(a, b) {
											if (typeof b.getElementsByClassName !== X
													&& u3) {
												return b
								...
								if ((x.matchesSelector = Z3
										.test((x3 = o3.matches
												|| o3.webkitMatchesSelector
												|| o3.mozMatchesSelector
												|| o3.oMatchesSelector
												|| o3.msMatchesSelector)))) {
									e4(function(a) {
								...
								y3 = _ || Z3.test(o3.contains) ? function(a, b) {
									var m = a.nodeType === 9 ? a.documentElement
											: a, w4 = b && b.parentNode;
									return a === w4
											|| !!(w4 && w4.nodeType === 1 && (m.contains ? m
													.contains(w4)
													: a.compareDocumentPosition
															&& a
																	.compareDocumentPosition(w4)
															& 16));
								}
										: function(a, b) {
											if (b) {
								...
								G3 = _ ? function(a, b) {
									...
									m = (a.ownerDocument || a) === (b.ownerDocument || b) ? a
											.compareDocumentPosition(b)
											: 1;
									if (m
											& 1
											|| (!x.sortDetached && b
													.compareDocumentPosition(a) === m)) {
										if (a === u4 || a.ownerDocument === A3
												&& y3(A3, a)) {
											return -1;
										}
										if (b === u4 || b.ownerDocument === A3
												&& y3(A3, b)) {
											return 1;
										}
										return r3 ? (k.call(r3, a) - k.call(r3,
												b)) : 0;
									}
									return m & 4 ? -1 : 1;
								}
										: function(a, b) {
											...
											var m, i = 0, w4 = a.parentNode, x4 = b.parentNode, ap = [ a ], bp = [ b ];
											if (!w4 || !x4) {
												return a === u4 ? -1
														: b === u4 ? 1
																: w4 ? -1
							...
							S.matchesSelector = function(a, b) {
								...
								b = b.replace(T3, "='$1']");
								if (x.matchesSelector && u3
										&& (!w3 || !w3.test(b))
										&& (!v3 || !v3.test(b))) {
									try {
										var j = x3.call(a, b);
										if (j || x.disconnectedMatch
												|| a.document
							...
							S.attr = function(a, b) {
								...
								var j = l.attrHandle[b.toLowerCase()], m = j
										&& u
												.call(l.attrHandle, b
														.toLowerCase()) ? j(a,
										b, !u3) : undefined;
								return m !== undefined ? m : x.attributes
										|| !u3 ? a.getAttribute(b) : (m = a
										.getAttributeNode(b))
										&& m.specified ? m.value : null;
							};
							S.error = function(m) {
								throw new Error(
							...
							l = S.selectors = {
								...
								filter : {
									...
									"CLASS" : function(a) {
										...
										return b
												...
												&& D3(
														...
														function(j) {
															return b
																	.test(typeof j.className === "string"
																			&& j.className
																			|| typeof j.getAttribute !== X
																			&& j
																					.getAttribute("class")
																			|| "");
														});
									...
									"CHILD" : function(a, b, j, m, _) {
										var u4 = a.slice(0, 3) !== "nth", v4 = a
												.slice(-4) !== "last", w4 = b === "of-type";
										return m === 1 && _ === 0 ? function(x4) {
											return !!x4.parentNode;
										}
												: function(x4, y4, z4) {
													var A4, B4, C4, D4, E4, F4, G4 = u4 !== v4 ? "nextSibling"
															: "previousSibling", H4 = x4.parentNode, I4 = w4
															&& x4.nodeName
																	.toLowerCase(), J4 = !z4
															&& !w4;
													if (H4) {
									...
									"PSEUDO" : function(a, b) {
										...
										if (m.length > 1) {
											...
											return l.setFilters
													.hasOwnProperty(a
															.toLowerCase()) ? d4(function(
													_, x3) {
												var u4, v4 = m(_, b), i = v4.length;
												while (i--) {
													u4 = k.call(_, v4[i]);
													_[u4] = !(x3[u4] = v4[i]);
												}
								...
								pseudos : {
									"not" : d4(function(a) {
										var b = [], j = [], m = r(a.replace(z,
												"$1"));
										return m[z3] ? d4(function(_, x3, u4,
												v4) {
											var w4, x4 = m(_, null, v4, []), i = _.length;
											while (i--) {
												if ((w4 = x4[i])) {
													_[i] = !(x3[i] = w4);
												}
							...
							t = S.tokenize = function(a, b) {
								...
								return b ? v4.length : v4 ? S.error(a) : E3(a,
										w4).slice(0);
							};
							function m4(a) {
								var i = 0, b = a.length, j = "";
								for (; i < b; i++) {
									j += a[i].value;
								}
								return j;
							...
							function n4(m, a, b) {
								var j = a.dir, _ = b && j === "parentNode", u4 = C3++;
							...
							function q4(a, m, b, j, _) {
								var u4, v4 = [], i = 0, w4 = a.length, x4 = m != null;
								for (; i < w4; i++) {
									if ((u4 = a[i])) {
										if (!b || b(u4, j, _)) {
											v4.push(u4);
							...
							function r4(a, b, m, j, _, u4) {
								...
								return d4(function(v4, w4, x4, y4) {
									var z4, i, A4, B4 = [], C4 = [], D4 = w4.length, E4 = v4
											|| p4(b || "*",
													x4.nodeType ? [ x4 ] : x4,
													[]), F4 = a && (v4 || !b) ? q4(
											E4, B4, a, x4, y4)
							...
							function s4(a) {
								var b, m, j, _ = a.length, u4 = l.relative[a[0].type], v4 = u4
										|| l.relative[" "], i = u4 ? 1 : 0, w4 = n4(
										function(z4) {
											return z4 === b;
										}, v4, true), x4 = n4(function(z4) {
									return k.call(b, z4) > -1;
								}, v4, true), y4 = [ function(z4, A4, B4) {
									return (!u4 && (B4 || A4 !== v))
											|| ((b = A4).nodeType ? w4(z4, A4,
													B4) : x4(z4, A4, B4));
								} ];
								for (; i < _; i++) {
									if ((m = l.relative[a[i].type])) {
										...
										m = l.filter[a[i].type].apply(null,
												a[i].matches);
										if (m[z3]) {
											j = ++i;
											for (; j < _; j++) {
							...
							function t4(a, b) {
								var m = b.length > 0, _ = a.length > 0, u4 = function(
										v4, w4, x4, y4, z4) {
									var A4, j, B4, C4 = 0, i = "0", D4 = v4
											&& [], E4 = [], F4 = v, G4 = v4
											|| _ && l.find["TAG"]("*", z4), H4 = (B3 += F4 == null ? 1
											: Math.random() || 0.1), I4 = G4.length;
									if (z4) {
										v = w4 !== J && w4;
									}
							...
							s = S.select = function(a, b, j, m) {
								var i, _, u4, v4, w4, x4 = typeof a === "function"
										&& a, y4 = !m
										&& t((a = x4.selector || a));
								j = j || [];
								if (y4.length === 1) {
									...
									if (_.length > 2
											&& (u4 = _[0]).type === "ID"
											&& x.getById && b.nodeType === 9
											&& u3 && l.relative[_[1].type]) {
										b = (l.find["ID"](u4.matches[0]
												.replace(a4, b4), b) || [])[0];
										if (!b) {
											return j;
										} else if (x4) {
									...
									while (i--) {
										...
										if ((w4 = l.find[v4])) {
											if ((m = w4(u4.matches[0].replace(
													a4, b4), $3.test(_[0].type)
													&& k4(b.parentNode) || b))) {
												_.splice(i, 1);
												a = m.length && m4(_);
												if (!a) {
							...
							x.sortDetached = e4(function(a) {
								return a.compareDocumentPosition(J
										.createElement("div")) & 1;
							});
							if (!e4(function(a) {
						...
						Q.filter = function(a, b, n) {
							...
							return b.length === 1 && j.nodeType === 1 ? Q.find
									.matchesSelector(j, a) ? [ j ] : []
									: Q.find.matches(a, Q.grep(b, function(j) {
										return j.nodeType === 1;
									}));
						};
						Q.fn
								.extend({
									find : function(s) {
										...
										r = this.pushStack(l > 1 ? Q.unique(r)
												: r);
									...
									filter : function(s) {
										return this.pushStack(H(this, s || [],
												false));
									},
									not : function(s) {
										return this.pushStack(H(this, s || [],
									...
									is : function(s) {
										return !!H(this, typeof s === "string"
												&& E.test(s) ? Q(s) : s || [],
												false).length;
									}
								});
						var I, J = w.document, K = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/, L = Q.fn.init = function(
								s, a) {
							var m, b;
							if (!s) {
								return this;
							...
							if (typeof s === "string") {
								...
								if (m && (m[1] || !a)) {
									if (m[1]) {
										...
										Q.merge(this, Q.parseHTML(m[1], a
												&& a.nodeType ? a.ownerDocument
												|| a : J, true));
								...
								return typeof I.ready !== "undefined" ? I
										.ready(s) : s(Q);
							}
						...
						Q.fn
								.extend({
									...
									closest : function(s, a) {
										...
										return this.pushStack(m.length > 1 ? Q
												.unique(m) : m);
									},
									index : function(a) {
										if (!a) {
										...
										return Q.inArray(a.jquery ? a[0] : a,
												this);
									},
									add : function(s, a) {
										return this.pushStack(Q.unique(Q.merge(
												this.get(), Q(s, a))));
									},
									addBack : function(s) {
										return this
												.add(s == null ? this.prevObject
														: this.prevObject
																.filter(s));
									}
								});
								...
								.each(
										{
											...
											contents : function(a) {
												return Q.nodeName(a, "iframe") ? a.contentDocument
						...
						Q.Callbacks = function(a) {
							a = typeof a === "string" ? (R[a] || T(a)) : Q
									.extend({}, a);
							var b, m, j, l, n, p, r = [], s = !a.once && [], t = function(
									_) {
								m = a.memory && _;
								j = true;
								n = p || 0;
						...
						Q
								.extend({
									Deferred : function(a) {
										var t = [
												...
												[
														...
														"rejected" ],
												[ "notify", "progress",
														Q.Callbacks("memory") ] ], s = "pending", p = {
											state : function() {
												return s;
											},
											always : function() {
												b.done(arguments).fail(
														arguments);
												return this;
											},
											then : function() {
									...
									when : function(s) {
										var i = 0, r = f.call(arguments), l = r.length, a = l !== 1
												|| (s && Q
														.isFunction(s.promise)) ? l
												: 0, b = a === 1 ? s : Q
												.Deferred(), j = function(i, t,
												v) {
											return function(_) {
												t[i] = this;
												v[i] = arguments.length > 1 ? f
														.call(arguments) : _;
												if (v === p) {
													b.notifyWith(t, v);
												} else if (!(--a)) {
						...
						function V() {
							if (J.addEventListener) {
								J.removeEventListener("DOMContentLoaded", W,
										false);
						...
						function W() {
							if (J.addEventListener || event.type === "load"
						...
						Q.ready.promise = function(a) {
							if (!U) {
								...
								if (J.readyState === "complete") {
									...
									J.addEventListener("DOMContentLoaded", W,
											false);
						...
						Q.acceptData = function(a) {
							var n = Q.noData[(a.nodeName + " ").toLowerCase()], b = +a.nodeType || 1;
							return b !== 1 && b !== 9 ? false : !n
									|| n !== true
									&& a.getAttribute("classid") === n;
						};
						var Y = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/, Z = /([A-Z])/g;
						function $(a, b, j) {
							if (j === undefined && a.nodeType === 1) {
								var n = "data-"
										+ b.replace(Z, "-$1").toLowerCase();
								j = a.getAttribute(n);
								if (typeof j === "string") {
									try {
										j = j === "true" ? true
						...
						function b1(a, n, b, p) {
							...
							var r, t, j = Q.expando, l = a.nodeType, m = l ? Q.cache
									: a, s = l ? a[j] : a[j] && j;
							if ((!s || !m[s] || (!p && !m[s].data))
									&& b === undefined && typeof n === "string") {
								return;
							}
							if (!s) {
								if (l) {
						...
						function c1(a, n, p) {
							...
							var t, i, b = a.nodeType, j = b ? Q.cache : a, l = b ? a[Q.expando]
									: Q.expando;
							if (!j[l]) {
								return;
							}
						...
						Q
								.extend({
									...
									hasData : function(a) {
										a = a.nodeType ? Q.cache[a[Q.expando]]
												: a[Q.expando];
										return !!a && !a1(a);
									},
									data : function(a, n, b) {
						...
						Q
								.extend({
									...
									dequeue : function(a, t) {
										t = t || "fx";
										var b = Q.queue(a, t), s = b.length, j = b
												.shift(), l = Q._queueHooks(a,
												t), n = function() {
											Q.dequeue(a, t);
										};
										if (j === "inprogress") {
						...
						Q.fn
								.extend({
									...
									promise : function(t, a) {
										var b, j = 1, l = Q.Deferred(), m = this, i = this.length, r = function() {
											if (!(--j)) {
												l.resolveWith(m, [ m ]);
											}
										};
						...
						var f1 = function(a, b) {
							a = b || a;
							return Q.css(a, "display") === "none"
									|| !Q.contains(a.ownerDocument, a);
						};
						var g1 = Q.access = function(a, b, j, v, l, m, r) {
							var i = 0, n = a.length, p = j == null;
							if (Q.type(j) === "object") {
								l = true;
								for (i in j) {
						...
						(function() {
							var a = J.createElement("input"), b = J
									.createElement("div"), j = J
							...
							x.html5Clone = J.createElement("nav").cloneNode(
						...
						var i1 = /^(?:input|select|textarea)$/i, j1 = /^key/, k1 = /^(?:mouse|pointer|contextmenu)|click/, l1 = /^(?:focusinfocus|focusoutblur)$/, m1 = /^([^.]*)(?:\.(.+)|)$/;
						function n1() {
							return true;
						}
						function o1() {
						...
						Q.event = {
							...
							add : function(a, b, j, l, s) {
								var m, n, t, p, r, v, _, r3, s3, t3, u3, v3 = Q
										._data(a);
								if (!v3) {
									return;
								}
								...
								if (!(v = v3.handle)) {
									v = v3.handle = function(e) {
										return typeof Q !== X
												&& (!e || Q.event.triggered !== e.type) ? Q.event.dispatch
												.apply(v.elem, arguments)
												: undefined;
									};
									v.elem = a;
								}
								...
								while (t--) {
									...
									s3 = (s ? r.delegateType : r.bindType)
											|| s3;
									r = Q.event.special[s3] || {};
									_ = Q.extend({
										type : s3,
							...
							remove : function(a, b, l, s, m) {
								var j, n, p, r, t, v, _, r3, s3, t3, u3, v3 = Q
										.hasData(a)
										&& Q._data(a);
								if (!v3 || !(v = v3.events)) {
									return;
								...
								while (t--) {
									...
									if (!s3) {
										for (s3 in v) {
											Q.event.remove(a, s3 + b[t], l, s,
													true);
										}
										continue;
									}
									_ = Q.event.special[s3] || {};
									s3 = (s ? _.delegateType : _.bindType)
											|| s3;
									r3 = v[s3] || [];
									p = p[2]
											&& new RegExp("(^|\\.)"
							...
							trigger : function(a, b, j, l) {
								var m, n, p, r, s, t, i, v = [ j || J ], _ = u
										.call(a, "type") ? a.type : a, r3 = u
										.call(a, "namespace") ? a.namespace
										.split(".") : [];
								p = t = j = j || J;
								...
								if (!l && !s.noBubble && !Q.isWindow(j)) {
									...
									if (t === (j.ownerDocument || J)) {
										v.push(t.defaultView || t.parentWindow
												|| w);
									}
								}
								i = 0;
								...
								if (!l && !a.isDefaultPrevented()) {
									if ((!s._default || s._default.apply(v
											.pop(), b) === false)
											&& Q.acceptData(j)) {
							...
							dispatch : function(a) {
								...
								if (s.preDispatch
										&& s.preDispatch.call(this, a) === false) {
									return;
								}
								...
								while ((m = l[i++])
									...
									while ((b = m.handlers[j++])
										...
										if (!a.namespace_re
											...
											a.handleObj = b;
											a.data = b.data;
											r = ((Q.event.special[b.origType] || {}).handle || b.handler)
													.apply(m.elem, n);
											if (r !== undefined) {
												if ((a.result = r) === false) {
													a.preventDefault();
							...
							handlers : function(a, b) {
								var s, j, m, i, l = [], n = b.delegateCount, p = a.target;
								if (n && p.nodeType
										&& (!a.button || a.type !== "click")) {
									for (; p != this; p = p.parentNode || this) {
										if (p.nodeType === 1
												&& (p.disabled !== true || a.type !== "click")) {
											m = [];
											for (i = 0; i < n; i++) {
												j = b[i];
												s = j.selector + " ";
												if (m[s] === undefined) {
													m[s] = j.needsContext ? Q(
															s, this).index(p) >= 0
															: Q
																	.find(
																			s,
							...
							fix : function(a) {
								...
								var i, p, b, t = a.type, j = a, l = this.fixHooks[t];
								if (!l) {
									this.fixHooks[t] = l = k1.test(t) ? this.mouseHooks
											: j1.test(t) ? this.keyHooks : {};
								}
								b = l.props ? this.props.concat(l.props)
										: this.props;
								a = new Q.Event(j);
								i = b.length;
								while (i--) {
							...
							keyHooks : {
								...
								filter : function(a, b) {
									if (a.which == null) {
										a.which = b.charCode != null ? b.charCode
												: b.keyCode;
									}
									return a;
								}
							...
							mouseHooks : {
								props : "button buttons clientX clientY fromElement offsetX offsetY pageX pageY screenX screenY toElement"
										.split(" "),
								filter : function(a, b) {
									var j, l, m, n = b.button, p = b.fromElement;
									...
									if (!a.relatedTarget && p) {
										a.relatedTarget = p === a.target ? b.toElement
												: p;
									}
						...
						Q.removeEvent = J.removeEventListener ? function(a, t,
								b) {
						...
						Q.Event = function(s, p) {
							...
							if (s && s.type) {
								...
								this.type = s.type;
								this.isDefaultPrevented = s.defaultPrevented
										|| s.defaultPrevented === undefined
										&& s.returnValue === false ? n1 : o1;
							} else {
								this.type = s;
							}
							if (p) {
								...
								.each(
										...
										function(a, b) {
											Q.event.special[a] = {
												...
												bindType : b,
												handle : function(j) {
													var r, t = this, l = j.relatedTarget, m = j.handleObj;
													if (!l
															|| (l !== t && !Q
																	.contains(
																			t,
						...
						if (!x.focusinBubbles) {
							Q.each({
								...
								blur : "focusout"
									...
									function(a, b) {
										var j = function(l) {
											Q.event.simulate(b, l.target,
													Q.event.fix(l), true);
										};
										Q.event.special[b] = {
											setup : function() {
												var l = this.ownerDocument
														|| this, m = Q._data(l,
														b);
												if (!m) {
													l.addEventListener(a, j,
															true);
												}
												Q._data(l, b, (m || 0) + 1);
											},
						...
						Q.fn.extend({
							...
							off : function(t, s, a) {
								...
								if (t && t.preventDefault && t.handleObj) {
									b = t.handleObj;
									Q(t.delegateTarget).off(
											b.namespace ? b.origType + "."
													+ b.namespace : b.origType,
											b.selector, b.handler);
									return this;
								}
								if (typeof t === "object") {
									for (j in t) {
						...
						var r1 = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|"
								+ "header|hgroup|mark|meter|nav|output|progress|section|summary|time|video", s1 = / jQuery\d+="(?:null|\d+)"/g, t1 = new RegExp(
								"<(?:" + r1 + ")[\\s/>]", "i"), u1 = /^\s+/, v1 = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, w1 = /<([\w:]+)/, x1 = /<tbody/i, y1 = /<|&#?\w+;/, z1 = /(?:<script|<style|<link)/i, A1 = /checked\s*(?:[^=]|=\s*.checked.)/i, B1 = /^$|\/(?:java|ecma)script/i, C1 = /^true\/(.*)/, D1 = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, E1 = {
							...
							td : [ 3, "<table><tbody><tr>",
									"</tr></tbody></table>" ],
							_default : x.htmlSerialize ? [ 0, "", "" ] : [ 1,
									"X<div>", "</div>" ]
						}, F1 = q1(J), G1 = F1.appendChild(J
								.createElement("div"));
						E1.optgroup = E1.option;
						E1.tbody = E1.tfoot = E1.colgroup = E1.caption = E1.thead;
						E1.th = E1.td;
						function H1(a, t) {
							var b, j, i = 0, l = typeof a.getElementsByTagName !== X ? a
									.getElementsByTagName(t || "*")
									: typeof a.querySelectorAll !== X ? a
											.querySelectorAll(t || "*")
											: undefined;
							if (!l) {
								for (l = [], b = a.childNodes || a; (j = b[i]) != null; i++) {
									if (!t || Q.nodeName(j, t)) {
										l.push(j);
									} else {
										Q.merge(l, H1(j, t));
							...
							return t === undefined || t && Q.nodeName(a, t) ? Q
									.merge([ a ], l) : l;
						}
						function I1(a) {
							if (h1.test(a.type)) {
						...
						function J1(a, b) {
							return Q.nodeName(a, "table")
									&& Q.nodeName(b.nodeType !== 11 ? b
											: b.firstChild, "tr") ? a
						...
						function K1(a) {
							a.type = (Q.find.attr(a, "type") !== null) + "/"
									+ a.type;
							return a;
						}
						function L1(a) {
						...
						function M1(a, r) {
							var b, i = 0;
							for (; (b = a[i]) != null; i++) {
								Q._data(b, "globalEval", !r
										|| Q._data(r[i], "globalEval"));
							}
						}
						function N1(s, a) {
							...
							var t, i, l, b = Q._data(s), j = Q._data(a, b), m = b.events;
							if (m) {
								delete j.handle;
								j.events = {};
								for (t in m) {
						...
						function O1(s, a) {
							...
							if (n === "script" && a.text !== s.text) {
								...
								if (x.html5Clone
										&& (s.innerHTML && !Q.trim(a.innerHTML))) {
						...
						Q
								.extend({
									clone : function(a, b, j) {
										...
										if ((!x.noCloneEvent || !x.noCloneChecked)
												&& (a.nodeType === 1 || a.nodeType === 11)
												&& !Q.isXMLDoc(a)) {
											l = H1(m);
											s = H1(a);
											for (i = 0; (n = s[i]) != null; ++i) {
												if (l[i]) {
													O1(n, l[i]);
												}
											}
									...
									buildFragment : function(a, b, s, m) {
										var j, n, p, t, r, v, _, l = a.length, r3 = q1(b), s3 = [], i = 0;
										for (; i < l; i++) {
											n = a[i];
											if (n || n === 0) {
												if (Q.type(n) === "object") {
									...
									cleanData : function(a, b) {
										var j, t, l, m, i = 0, n = Q.expando, p = Q.cache, r = x.deleteExpando, s = Q.event.special;
										for (; (j = a[i]) != null; i++) {
											if (b || Q.acceptData(j)) {
												l = j[n];
												m = l && p[l];
								...
								.extend({
									text : function(v) {
										return g1(
												this,
												function(v) {
													return v === undefined ? Q
															.text(this)
															: this
																	.empty()
																	.append(
																			(this[0]
																					&& this[0].ownerDocument || J)
																					.createTextNode(v));
									...
									remove : function(s, a) {
										var b, j = s ? Q.filter(s, this) : this, i = 0;
										for (; (b = j[i]) != null; i++) {
											if (!a && b.nodeType === 1) {
												Q.cleanData(H1(b));
											}
									...
									html : function(v) {
										return g1(
												this,
												function(v) {
													var a = this[0] || {}, i = 0, l = this.length;
													if (v === undefined) {
														return a.nodeType === 1 ? a.innerHTML
																.replace(s1, "")
																: undefined;
													}
													if (typeof v === "string"
									...
									replaceWith : function() {
										...
										return a && (a.length || a.nodeType) ? this
												: this.remove();
									},
									detach : function(s) {
									...
									domManip : function(a, b) {
										a = g.apply([], a);
										var j, n, m, s, p, r, i = 0, l = this.length, t = this, v = l - 1, _ = a[0], r3 = Q
												.isFunction(_);
										if (r3
												|| (l > 1
														&& typeof _ === "string"
						...
						Q
								.each(
										...
										function(n, a) {
											Q.fn[n] = function(s) {
												var b, i = 0, r = [], j = Q(s), l = j.length - 1;
												for (; i <= l; i++) {
													b = i === l ? this : this
															.clone(true);
													Q(j[i])[a](b);
						...
						var P1, Q1 = {};
						function R1(n, a) {
							var s, b = Q(a.createElement(n)).appendTo(a.body), j = w.getDefaultComputedStyle
									&& (s = w.getDefaultComputedStyle(b[0])) ? s.display
									: Q.css(b[0], "display");
							b.detach();
							return j;
						}
						function S1(n) {
							...
							if (!b) {
								b = R1(n, a);
								if (b === "none" || !b) {
									P1 = (P1 || Q("<iframe frameborder='0' width='0' height='0'/>"))
						...
						(function() {
							...
							x.shrinkWrapBlocks = function() {
								...
								b.appendChild(j).appendChild(a);
								if (typeof a.style.zoom !== X) {
									a.style.cssText = "-webkit-box-sizing:content-box;-moz-box-sizing:content-box;"
						...
						(function() {
							...
							function m() {
								...
								b.style.cssText = "-webkit-box-sizing:border-box;-moz-box-sizing:border-box;"
								...
								if (w.getComputedStyle) {
									...
									v.style.cssText = b.style.cssText = "-webkit-box-sizing:content-box;-moz-box-sizing:content-box;"
											+ "box-sizing:content-box;display:block;margin:0;border:0;padding:0";
									v.style.marginRight = v.style.width = "0";
									b.style.width = "1px";
									l = !parseFloat((w
											.getComputedStyle(v, null) || {}).marginRight);
								}
						...
						var Z1 = /alpha\([^)]*\)/i, $1 = /opacity\s*=\s*([^)]*)/, _1 = /^(none|table(?!-c[ea]).+)/, a2 = new RegExp(
								"^(" + d1 + ")(.*)$", "i"), b2 = new RegExp(
								"^([+-])=(" + d1 + ")", "i"), c2 = {
							position : "absolute",
							visibility : "hidden",
						...
						function f2(s, n) {
							...
							var a = n.charAt(0).toUpperCase() + n.slice(1), b = n, i = e2.length;
							while (i--) {
								n = e2[i] + a;
								if (n in s) {
									return n;
						...
						function g2(a, s) {
							...
							for (; m < n; m++) {
								...
								if (s) {
									...
									l = f1(j);
									if (b && b !== "none" || !l) {
										Q._data(j, "olddisplay", l ? b : Q.css(
												j, "display"));
									}
								}
							}
						...
						function h2(a, v, s) {
							var m = a2.exec(v);
							return m ? Math.max(0, m[1] - (s || 0))
									+ (m[2] || "px") : v;
						}
						function i2(a, n, b, j, s) {
							var i = b === (j ? "border" : "content") ? 4
									: n === "width" ? 1 : 0, v = 0;
							for (; i < 4; i += 2) {
								if (b === "margin") {
								...
								if (j) {
									if (b === "content") {
										v -= Q.css(a, "padding" + e1[i], true,
												s);
									}
									if (b !== "margin") {
										v -= Q.css(a, "border" + e1[i]
												+ "Width", true, s);
									}
								} else {
						...
						function j2(a, n, b) {
							var v = true, j = n === "width" ? a.offsetWidth
									: a.offsetHeight, s = V1(a), l = x.boxSizing
									&& Q.css(a, "boxSizing", false, s) === "border-box";
							if (j <= 0 || j == null) {
								j = W1(a, n, s);
								if (j < 0 || j == null) {
									j = a.style[n];
								...
								v = l
										&& (x.boxSizingReliable() || j === a.style[n]);
								j = parseFloat(j) || 0;
							}
							return (j + i2(a, n, b
									|| (l ? "border" : "content"), v, s))
									+ "px";
						}
						Q
								.extend({
									...
									style : function(a, n, v, b) {
										if (!a || a.nodeType === 3
												|| a.nodeType === 8 || !a.style) {
											return;
										}
										var r, t, j, l = Q.camelCase(n), s = a.style;
										n = Q.cssProps[l]
												|| (Q.cssProps[l] = f2(s, l));
									...
									css : function(a, n, b, s) {
										...
										if (b === "" || b) {
											j = parseFloat(v);
											return b === true || Q.isNumeric(j) ? j || 0
													: v;
										}
										return v;
									}
						...
						if (!x.opacity) {
							Q.cssHooks.opacity = {
								...
								set : function(a, v) {
									var s = a.style, b = a.currentStyle, j = Q
											.isNumeric(v) ? "alpha(opacity="
											+ v * 100 + ")" : "", l = b
											&& b.filter || s.filter || "";
									s.zoom = 1;
									if ((v >= 1 || v === "")
									...
									s.filter = Z1.test(l) ? l.replace(Z1, j)
											: l + " " + j;
								}
							};
						}
						Q.cssHooks.marginRight = Y1(x.reliableMarginRight,
								function(a, b) {
									if (b) {
										return Q.swap(a, {
						...
						Q.fn.extend({
							css : function(n, v) {
								return g1(this, function(a, n, v) {
									...
									return v !== undefined ? Q.style(a, n, v)
											: Q.css(a, n);
						...
						k2.prototype = {
							...
							cur : function() {
								...
								return a && a.get ? a.get(this)
										: k2.propHooks._default.get(this);
							},
							run : function(p) {
								var a, b = k2.propHooks[this.prop];
								if (this.options.duration) {
									this.pos = a = Q.easing[this.easing](p,
											this.options.duration * p, 0, 1,
											this.options.duration);
								} else {
									this.pos = a = p;
								}
								this.now = (this.end - this.start) * a
										+ this.start;
						...
						k2.propHooks = {
							_default : {
								get : function(t) {
									var r;
									if (t.elem[t.prop] != null
											&& (!t.elem.style || t.elem.style[t.prop] == null)) {
								...
								set : function(t) {
									if (Q.fx.step[t.prop]) {
										Q.fx.step[t.prop](t);
									} else if (t.elem.style
											&& (t.elem.style[Q.cssProps[t.prop]] != null || Q.cssHooks[t.prop])) {
						...
						Q.fx.step = {};
						var l2, m2, n2 = /^(?:toggle|show|hide)$/, o2 = new RegExp(
								"^(?:([+-])=|)(" + d1 + ")([a-z%]*)$", "i"), p2 = /queueHooks$/, q2 = [ v2 ], r2 = {
							"*" : [ function(p, v) {
								var t = this.createTween(p, v), a = t.cur(), b = o2
										.exec(v), j = b && b[3]
										|| (Q.cssNumber[p] ? "" : "px"), s = (Q.cssNumber[p] || j !== "px"
										&& +a)
										&& o2.exec(Q.css(t.elem, p)), l = 1, m = 20;
								if (s && s[3] !== j) {
									j = j || s[3];
									b = b || [];
									s = +a || 1;
									...
									} while (l !== (l = t.cur() / a) && l !== 1
											&& --m);
								}
								if (b) {
									s = t.start = +s || +a || 0;
									t.unit = j;
									t.end = b[1] ? s + (b[1] + 1) * b[2]
											: +b[2];
								}
								return t;
							} ]
						...
						function u2(v, p, a) {
							var t, b = (r2[p] || []).concat(r2["*"]), j = 0, l = b.length;
							for (; j < l; j++) {
								if ((t = b[j].call(a, p, v))) {
									return t;
								}
						...
						function v2(a, p, b) {
							var j, v, t, l, m, n, r, s, _ = this, r3 = {}, s3 = a.style, t3 = a.nodeType
									&& f1(a), u3 = Q._data(a, "fxshow");
							if (!b.queue) {
							...
							if (a.nodeType === 1
									&& ("height" in p || "width" in p)) {
								b.overflow = [ s3.overflow, s3.overflowX,
										s3.overflowY ];
								r = Q.css(a, "display");
								s = r === "none" ? Q._data(a, "olddisplay")
										|| S1(a.nodeName) : r;
								if (s === "inline"
										&& Q.css(a, "float") === "none") {
									if (!x.inlineBlockNeedsLayout
											|| S1(a.nodeName) === "inline") {
						...
						function x2(a, p, b) {
							var r, s, j = 0, l = q2.length, m = Q.Deferred()
									.always(function() {
										delete t.elem;
									}), t = function() {
								if (s) {
								...
								var _ = l2 || s2(), r3 = Math.max(0,
										n.startTime + n.duration - _), s3 = r3
										/ n.duration || 0, t3 = 1 - s3, j = 0, l = n.tweens.length;
								for (; j < l; j++) {
									n.tweens[j].run(t3);
								}
								...
								createTween : function(_, r3) {
									var s3 = Q.Tween(a, n.opts, _, r3,
											n.opts.specialEasing[_]
													|| n.opts.easing);
									n.tweens.push(s3);
									return s3;
								},
								stop : function(_) {
									var j = 0, l = _ ? n.tweens.length : 0;
									if (s) {
										return this;
									}
									s = true;
							...
							return n.progress(n.opts.progress).done(
									n.opts.done, n.opts.complete).fail(
									n.opts.fail).always(n.opts.always);
						}
						...
						Q.speed = function(s, a, b) {
							...
							j.duration = Q.fx.off ? 0
									: typeof j.duration === "number" ? j.duration
											: j.duration in Q.fx.speeds ? Q.fx.speeds[j.duration]
						...
						Q.fn
								.extend({
									...
									animate : function(p, s, a, b) {
										var j = Q.isEmptyObject(p), l = Q
												.speed(s, a, b), m = function() {
										...
										m.finish = m;
										return j || l.queue === false ? this
												.each(m) : this.queue(l.queue,
												m);
									},
									stop : function(t, a, b) {
										var s = function(j) {
									...
									finish : function(t) {
										...
										return this
												.each(function() {
													var a, b = Q._data(this), j = b[t
															+ "queue"], l = b[t
															+ "queueHooks"], m = Q.timers, n = j ? j.length
															: 0;
													b.finish = true;
													Q.queue(this, t, []);
													if (l && l.stop) {
						...
						Q.each([ "toggle", "show", "hide" ], function(i, n) {
							...
							Q.fn[n] = function(s, b, j) {
								return s == null || typeof s === "boolean" ? a
										.apply(this, arguments) : this.animate(
										t2(n, true), s, b, j);
							};
						});
						Q.each({
									...
									val : function(v) {
										...
										return this
												.each(function(i) {
													...
													a = Q.valHooks[this.type]
															|| Q.valHooks[this.nodeName
																	.toLowerCase()];
													if (!a
															|| !("set" in a)
															|| a.set(this, l,
									...
									valHooks : {
										option : {
											get : function(a) {
												...
												return v != null ? v : Q.trim(Q
														.text(a));
											}
										},
										select : {
											get : function(a) {
												var v, b, j = a.options, l = a.selectedIndex, m = a.type === "select-one"
														|| l < 0, n = m ? null
														: [], p = m ? l + 1
														: j.length, i = l < 0 ? p
														: m ? l : 0;
												for (; i < p; i++) {
													b = j[i];
													if ((b.selected || i === l)
															&& (x.optDisabled ? !b.disabled
																	: b
																			.getAttribute("disabled") === null)
															&& (!b.parentNode.disabled || !Q
																	.nodeName(
																			b.parentNode,
																			"optgroup"))) {
														v = Q(b).val();
											...
											set : function(a, v) {
												var b, j, l = a.options, m = Q
														.makeArray(v), i = l.length;
												while (i--) {
													j = l[i];
													if (Q.inArray(
															Q.valHooks.option
						...
						var z2, A2, B2 = Q.expr.attrHandle, C2 = /^(?:checked|selected)$/i, D2 = x.getSetAttribute, E2 = x.input;
						Q.fn.extend({
							attr : function(n, v) {
								return g1(this, Q.attr, n, v,
										arguments.length > 1);
							},
						...
						Q
								.each(
										Q.expr.match.bool.source.match(/\w+/g),
										function(i, n) {
											var a = B2[n] || Q.find.attr;
											B2[n] = E2 && D2 || !C2.test(n) ? function(
													b, n, j) {
												var r, l;
												if (!j) {
													l = B2[n];
						...
						if (!D2) {
							z2 = {
								set : function(a, v, n) {
									...
									if (!r) {
										a.setAttributeNode((r = a.ownerDocument
												.createAttribute(n)));
									}
									r.value = v += "";
									if (n === "value"
						...
						var F2 = /^(?:input|select|textarea|button|object)$/i, G2 = /^(?:a|area)$/i;
						Q.fn.extend({
							prop : function(n, v) {
								return g1(this, Q.prop, n, v,
										arguments.length > 1);
							},
						...
						Q.each([ "tabIndex", "readOnly", "maxLength",
								"cellSpacing", "cellPadding", "rowSpan",
						...
						Q.fn
								.extend({
									addClass : function(v) {
										var a, b, l, m, j, n, i = 0, p = this.length, r = typeof v === "string"
												&& v;
										if (Q.isFunction(v)) {
											return this
													.each(function(j) {
									...
									removeClass : function(v) {
										var a, b, l, m, j, n, i = 0, p = this.length, r = arguments.length === 0
												|| typeof v === "string" && v;
										if (Q.isFunction(v)) {
											return this
													.each(function(j) {
						...
						Q.fn.extend({
							...
							undelegate : function(s, t, a) {
								return arguments.length === 1 ? this.off(s,
										"**") : this.off(t, s || "**", a);
							}
						});
						var I2 = Q.now();
						...
						Q.parseJSON = function(a) {
							...
							var r, b = null, s = Q.trim(a + "");
							return s
									&& !Q.trim(s.replace(K2, function(t, j, l,
											m) {
										if (r && j) {
											b = 0;
										}
						...
						var L2, M2, N2 = /#.*$/, O2 = /([?&])_=[^&]*/, P2 = /^(.*?):[ \t]*([^\r\n]*)\r?$/mg, Q2 = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, R2 = /^(?:GET|HEAD)$/, S2 = /^\/\//, T2 = /^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/, U2 = {}, V2 = {}, W2 = "*/"
								.concat("*");
						try {
							M2 = location.href;
						} catch (e) {
						...
						function X2(s) {
							return function(a, b) {
								...
								var j, i = 0, l = a.toLowerCase().match(P)
										|| [];
								if (Q.isFunction(b)) {
									while ((j = l[i++])) {
										if (j.charAt(0) === "+") {
						...
						function $2(s, j, r) {
							var a, b, l, t, m = s.contents, n = s.dataTypes;
							while (n[0] === "*") {
								n.shift();
								if (b === undefined) {
									b = s.mimeType
						...
						function _2(s, r, j, a) {
							var b, l, m, t, p, n = {}, v = s.dataTypes.slice();
							if (v[1]) {
						...
						Q
								.extend({
									...
									ajaxSetup : function(t, s) {
										return s ? Z2(Z2(t, Q.ajaxSettings), s)
												: Z2(Q.ajaxSettings, t);
									},
									ajaxPrefilter : X2(U2),
									ajaxTransport : X2(V2),
									ajax : function(a, b) {
										...
										b = b || {};
										var p, i, j, r, t, l, m, n, s = Q
												.ajaxSetup({}, b), v = s.context
												|| s, _ = s.context
												&& (v.nodeType || v.jquery) ? Q(v)
												: Q.event, r3 = Q.Deferred(), s3 = Q
												.Callbacks("once memory"), t3 = s.statusCode
												|| {}, u3 = {}, v3 = {}, w3 = 0, x3 = "canceled", y3 = {
											readyState : 0,
										...
										y3.error = y3.fail;
										s.url = ((a || s.url || M2) + "")
												.replace(N2, "").replace(S2,
														L2[1] + "//");
										s.type = b.method || b.type || s.method
												|| s.type;
										s.dataTypes = Q.trim(s.dataType || "*")
												.toLowerCase().match(P)
												|| [ "" ];
										if (s.crossDomain == null) {
											p = T2.exec(s.url.toLowerCase());
											s.crossDomain = !!(p && (p[1] !== L2[1]
													|| p[2] !== L2[2] || (p[3] || (p[1] === "http:" ? "80"
													: "443")) !== (L2[3] || (L2[1] === "http:" ? "80"
													: "443"))));
										}
										if (s.data && s.processData
												&& typeof s.data !== "string") {
											s.data = Q.param(s.data,
													s.traditional);
										}
										Y2(U2, s, b, y3);
										if (w3 === 2) {
										...
										if (s.data && s.hasContent
												&& s.contentType !== false
												|| b.contentType) {
											y3.setRequestHeader("Content-Type",
													s.contentType);
										}
										y3
												.setRequestHeader(
										...
										if (s.beforeSend
												&& (s.beforeSend.call(v, y3, s) === false || w3 === 2)) {
											return y3.abort();
										}
										x3 = "abort";
										for (i in {
										...
										function z3(A3, B3, C3, D3) {
											...
											t3 = undefined;
											if (l) {
												_.trigger(E3 ? "ajaxSuccess"
														: "ajaxError", [ y3, s,
														E3 ? F3 : G3 ]);
											}
											s3.fireWith(v, [ y3, J3 ]);
											if (l) {
												_.trigger("ajaxComplete", [ y3,
														s ]);
												if (!(--Q.active)) {
						...
						Q.each([ "ajaxStart", "ajaxStop", "ajaxComplete",
						...
						Q.fn
								.extend({
									wrapAll : function(a) {
										...
										if (this[0]) {
											var b = Q(a, this[0].ownerDocument)
													.eq(0).clone(true);
						...
						Q.expr.filters.hidden = function(a) {
							return a.offsetWidth <= 0
									&& a.offsetHeight <= 0
									|| (!x.reliableHiddenOffsets() && ((a.style && a.style.display) || Q
											.css(a, "display")) === "none");
						};
						Q.expr.filters.visible = function(a) {
							return !Q.expr.filters.hidden(a);
						};
						var a3 = /%20/g, b3 = /\[\]$/, c3 = /\r?\n/g, d3 = /^(?:submit|button|image|reset|file)$/i, e3 = /^(?:input|select|textarea|keygen)/i;
						function f3(p, a, t, b) {
							var n;
							if (Q.isArray(a)) {
						...
						Q.param = function(a, t) {
							var p, s = [], b = function(j, v) {
								v = Q.isFunction(v) ? v()
										: (v == null ? "" : v);
								s[s.length] = encodeURIComponent(j) + "="
										+ encodeURIComponent(v);
							};
							if (t === undefined) {
								t = Q.ajaxSettings
										&& Q.ajaxSettings.traditional;
							}
							if (Q.isArray(a)
									|| (a.jquery && !Q.isPlainObject(a))) {
								Q.each(a, function() {
						...
						Q.ajaxSettings.xhr = w.ActiveXObject !== undefined ? function() {
							return !this.isLocal
									&& /^(get|post|head|put|delete|options)$/i
											.test(this.type) && j3() || k3();
						}
								: j3;
						var g3 = 0, h3 = {}, i3 = Q.ajaxSettings.xhr();
						if (w.ActiveXObject) {
						...
						function p3(a) {
							return Q.isWindow(a) ? a
									: a.nodeType === 9 ? a.defaultView
											|| a.parentWindow : false;
						}
						Q.offset = {
							setOffset : function(a, b, i) {
								var j, l, m, n, p, r, s, t = Q.css(a,
										"position"), v = Q(a), _ = {};
								if (t === "static") {
								...
								m = Q.css(a, "top");
								r = Q.css(a, "left");
								s = (t === "absolute" || t === "fixed")
										&& Q.inArray("auto", [ m, r ]) > -1;
								if (s) {
									j = v.position();
									n = j.top;
									l = j.left;
						...
						Q.fn
								.extend({
									offset : function(a) {
										...
										return {
											top : j.top
													+ (b.pageYOffset || o3.scrollTop)
													- (o3.clientTop || 0),
											left : j.left
													+ (b.pageXOffset || o3.scrollLeft)
													- (o3.clientLeft || 0)
										};
									},
									position : function() {
						...
						Q.each({
							...
							Q.fn[m] = function(v) {
								return g1(this, function(a, m, v) {
									...
									if (v === undefined) {
										return b ? (p in b) ? b[p]
												: b.document.documentElement[m]
												: a[m];
									}
									if (b) {
										b.scrollTo(!t ? v : Q(b).scrollLeft(),
												t ? v : Q(b).scrollTop());
									} else {
										a[m] = v;
									}
						...
						Q.each([ "top", "left" ], function(i, p) {
							Q.cssHooks[p] = Y1(x.pixelPosition, function(a, b) {
								if (b) {
									b = W1(a, p);
									return U1.test(b) ? Q(a).position()[p]
											+ "px" : b;
								}
							});
						});
																...
																Q.fn[b] = function(
																	...
																	return g1(
																			...
																			function(
																				...
																				if (Q
																						.isWindow(p)) {
																					return p.document.documentElement["client"
																							+ n];
																				}
																				if (p.nodeType === 9) {
																					r = p.documentElement;
	...
	/*
	 * ! jQuery UI Position 1.10.4 http://jqueryui.com
	 * 
	 * Copyright 2014 jQuery Foundation and other contributors Released under
	...
	(function($, u) {
		$.ui = $.ui || {};
		var c, m = Math.max, a = Math.abs, r = Math.round, b = /left|center|right/, d = /top|center|bottom/, e = /[\+\-]\d+(\.[\d]+)?%?/, f = /^\w+/, g = /%$/, _ = $.fn.position;
		function h(o, w, i) {
			return [ parseFloat(o[0]) * (g.test(o[0]) ? w / 100 : 1),
					parseFloat(o[1]) * (g.test(o[1]) ? i / 100 : 1) ];
		}
		function p(i, k) {
		...
		$.position = {
			scrollbarWidth : function() {
				...
				var w, i, k = $("<div style='display:block;position:absolute;width:50px;height:50px;overflow:hidden;'><div style='height:100px;width:auto;'></div></div>"), l = k
						.children()[0];
				$("body").append(k);
				w = l.offsetWidth;
			...
			getScrollInfo : function(w) {
				var o = w.isWindow || w.isDocument ? "" : w.element
						.css("overflow-x"), i = w.isWindow || w.isDocument ? ""
						: w.element.css("overflow-y"), k = o === "scroll"
						|| (o === "auto" && w.width < w.element[0].scrollWidth), l = i === "scroll"
						|| (i === "auto" && w.height < w.element[0].scrollHeight);
				return {
			...
			getWithinInfo : function(i) {
				var w = $(i || window), k = $.isWindow(w[0]), l = !!w[0]
						&& w[0].nodeType === 9;
				return {
					element : w,
					isWindow : k,
		...
		$.fn.position = function(o) {
			...
			o = $.extend({}, o);
			var k, t, l, n, q, s, v = $(o.of), w = $.position
					.getWithinInfo(o.within), x = $.position.getScrollInfo(w), y = (o.collision || "flip")
					.split(" "), z = {};
			s = j(v);
			...
			q = $.extend({}, n);
			$.each([ "my", "at" ], function() {
				var i = (o[this] || "").split(" "), A, B;
				if (i.length === 1) {
					i = b.test(i[0]) ? i.concat([ "center" ])
							: d.test(i[0]) ? [ "center" ].concat(i) : [
									"center", "center" ];
				}
			...
			return this
					.each(function() {
						var A, B, C = $(this), D = C.outerWidth(), E = C
								.outerHeight(), F = p(this, "marginLeft"), G = p(
								this, "marginTop"), H = D + F
								+ p(this, "marginRight") + x.width, I = E + G
								+ p(this, "marginBottom") + x.height, J = $
								.extend({}, q), K = h(z.my, C.outerWidth(), C
								.outerHeight());
						if (o.my[0] === "right") {
							J.left -= D;
						...
						if (o.using) {
							B = function(i) {
								var L = n.left - J.left, M = L + t - D, N = n.top
										- J.top, O = N + l - E, P = {
									target : {
										element : v,
										left : n.left,
		...
		$.ui.position = {
			fit : {
				left : function(i, k) {
					var w = k.within, l = w.isWindow ? w.scrollLeft
							: w.offset.left, o = w.width, n = i.left
							- k.collisionPosition.marginLeft, q = l - n, s = n
							+ k.collisionWidth - o - l, t;
				...
				top : function(i, k) {
					var w = k.within, l = w.isWindow ? w.scrollTop
							: w.offset.top, o = k.within.height, n = i.top
							- k.collisionPosition.marginTop, q = l - n, s = n
							+ k.collisionHeight - o - l, t;
			...
			flip : {
				left : function(i, k) {
					var w = k.within, l = w.offset.left + w.scrollLeft, o = w.width, n = w.isWindow ? w.scrollLeft
							: w.offset.left, q = i.left
							- k.collisionPosition.marginLeft, s = q - n, t = q
							+ k.collisionWidth - o - n, v = k.my[0] === "left" ? -k.elemWidth
							: k.my[0] === "right" ? k.elemWidth : 0, x = k.at[0] === "left" ? k.targetWidth
							: k.at[0] === "right" ? -k.targetWidth : 0, y = -2
							* k.offset[0], z, A;
					if (s < 0) {
						...
						A = i.left - k.collisionPosition.marginLeft + v + x + y
								- n;
						if (A > 0 || a(A) < t) {
							i.left += v + x + y;
						}
				...
				top : function(i, k) {
					var w = k.within, l = w.offset.top + w.scrollTop, o = w.height, n = w.isWindow ? w.scrollTop
							: w.offset.top, q = i.top
							- k.collisionPosition.marginTop, s = q - n, t = q
							+ k.collisionHeight - o - n, v = k.my[1] === "top", x = v ? -k.elemHeight
							: k.my[1] === "bottom" ? k.elemHeight : 0, y = k.at[1] === "top" ? k.targetHeight
							: k.at[1] === "bottom" ? -k.targetHeight : 0, z = -2
							* k.offset[1], A, B;
					if (s < 0) {
						...
						A = i.top - k.collisionPosition.marginTop + x + y + z
								- n;
		...
		(function() {
			var t, k, l, o, i, n = document.getElementsByTagName("body")[0], q = document
					.createElement("div");
	...
	(function() {
		if (!window.jQuery) {
			throw new Error(
					"SAPUI5 requires jQuery as a prerequisite (>= version 1.7)");
		}
		if (jQuery.sap) {
			return;
		}
		...
		if (!J.inRange("1.7.0", "2.2.0")) {
			b(
					"error",
					"SAPUI5 requires a jQuery version of 1.7 or higher, but lower than 2.2; current version is "
							+ jQuery.fn.jquery);
		}
		if (!jQuery.browser) {
			jQuery.browser = (function(d) {
				var r = /(webkit)[ \/]([\w.]+)/, i = /(opera)(?:.*version)?[ \/]([\w.]+)/, j = /(msie) ([\w.]+)/, l = /(mozilla)(?:.*? rv:([\w.]+))?/, d = d
						.toLowerCase(), m = r.exec(d) || i.exec(d) || j.exec(d)
						|| d.indexOf("compatible") < 0 && l.exec(d) || [], n = {};
				if (m[1]) {
					n[m[1]] = true;
					n.version = m[2] || "0";
					if (n.webkit) {
		...
		var g = (function() {
			var T, U, r, d = /^(.*\/)?download\/configurator[\/\?]/, i = /^(.*\/)?(sap-ui-(core|custom|boot|merged)(-.*)?)\.js([?#]|$)/, j = /^(.*\/)?resources\//;
			jQuery("script[src]").each(function() {
				var s = this.getAttribute("src"), m;
				if ((m = s.match(d)) !== null) {
					T = this;
					U = s;
					r = (m[1] || "") + "resources/";
		...
		(function() {
			...
			var r;
			try {
				r = window.localStorage.getItem("sap-ui-reboot-URL");
				window.localStorage.removeItem("sap-ui-reboot-URL");
			} catch (e) {
			}
			if (r && r !== "undefined") {
				...
				if (U) {
					...
					window["sap-ui-config"]
							...
							&& (window["sap-ui-config"].resourceRoots[""] = undefined);
					document.write(d);
					var R = new Error(
							"This is not a real error. Aborting UI5 bootstrap and rebooting from: "
									+ r);
					R.name = "Restart";
					throw R;
				}
		...
		(function() {
			var d = /sap-ui-debug=(true|x|X)/.test(location.search), i = window["sap-ui-optimized"];
			try {
				d = d || (window.localStorage.getItem("sap-ui-debug") == "X");
			} catch (e) {
			}
			window["sap-ui-debug"] = d;
			if (/-dbg\.js([?#]|$)/.test(g.url)) {
				window["sap-ui-loaddbg"] = true;
				window["sap-ui-debug"] = true;
			}
			if (i && d) {
				var D = g.url
						.replace(/\/(?:sap-ui-cachebuster\/)?([^\/]+)\.js/,
								"/$1-dbg.js");
				window["sap-ui-optimized"] = false;
				window["sap-ui-loaddbg"] = true;
				document.write("<script type=\"text/javascript\" src=\"" + D
						+ "\"></script>");
				var r = new Error(
						"Aborting UI5 bootstrap and restarting from: " + D);
				r.name = "Restart";
				throw r;
			}
		})();
		var C = _["sap-ui-config"] = (function() {
			...
			var s = g.tag, d = _["sap-ui-config"], j = "sap-ui-config.json";
			if (typeof d === "string") {
				b(
						"warning",
						"Loading external bootstrap configuration from \""
								+ d
								+ "\". This is a design time feature and not for productive usage!");
				if (d !== j) {
					b("warning",
							"The external bootstrap configuration file should be named \""
									+ j + "\"!");
				}
				jQuery.ajax({
					url : d,
					...
					error : function(i, T, o) {
						b("error",
								"Loading externalized bootstrap configuration from \""
										+ d + "\" failed! Reason: " + o + "!");
						d = undefined;
					}
				});
			...
			d.resourceroots[''] = d.resourceroots[''] || g.resourceRoot;
			d['xx-loadallmode'] = /(^|\/)(sap-?ui5|[^\/]+-all).js([?#]|$)/
					.test(g.url);
			if (s) {
				...
				jQuery.each(s.attributes, function(i, o) {
					...
					if (m) {
						...
						if (m === 'resourceroots') {
							...
							jQuery.extend(d.themeroots, jQuery
									.parseJSON(o.value));
						} else if (m !== 'config') {
							d[m] = o.value;
						}
		...
		if (C.noconflict === true || C.noconflict === "true"
				|| C.noconflict === "x") {
			jQuery.noConflict();
		}
		jQuery.sap = {};
		...
		jQuery.sap.debug = function(d) {
			...
			function r(U) {
				alert("Usage of debug sources is "
						+ (U ? "on" : "off")
		...
		jQuery.sap.setReboot = function(r) {
			...
			try {
				if (r) {
					window.localStorage.setItem("sap-ui-reboot-URL", r);
					alert("Next time this app is launched (only once), it will load UI5 from:\n"
							+ r + ".\nPlease reload the application page now.");
				} else {
					window.localStorage.removeItem("sap-ui-reboot-URL");
				}
				U = window.localStorage.getItem("sap-ui-reboot-URL");
			} catch (e) {
				jQuery.sap.log
						.warning("Could not access localStorage while setting reboot URL '"
								+ r + "' (are cookies disabled?): " + e.message);
			}
			return U;
		};
		jQuery.sap.statistics = function(d) {
			...
			function i(U) {
				alert("Usage of Gateway statistics "
						+ (U ? "on" : "off")
						+ " now.\nFor the change to take effect, you need to reload the page.");
			}
			if (d === true) {
		...
		(function() {
			var d = 0, j = 1, W = 2, l = 3, D = 4, T = 5, s = (window.top == window) ? ""
					: "[" + window.location.pathname.split('/').slice(-1)[0]
							+ "] ", L = [], M = {
				'' : j
			}, o = null;
			...
			function y(i, m, v, w) {
				if (i <= r(w)) {
					var N = new Date(), A = {
						time : n(N.getHours(), 2) + ":" + n(N.getMinutes(), 2)
								+ ":" + n(N.getSeconds(), 2),
						date : n(N.getFullYear(), 4) + "-"
								+ n(N.getMonth() + 1, 2) + "-"
								+ n(N.getDate(), 2),
						timestamp : N.getTime(),
						level : i,
					...
					if (window.console) {
						var B = A.date + " " + A.time + " " + s + A.message
								+ " - " + A.details + " " + A.component;
						switch (i) {
						case d:
						case j:
							console.error(B);
						...
						case W:
							...
							break;
						case l:
							console.info ? console.info(B) : console.log(B);
							break;
						case D:
							console.debug ? console.debug(B) : console.log(B);
							break;
						case T:
							console.trace ? console.trace(B) : console.log(B);
							break;
						}
					}
					return A;
			...
			function z(i) {
				...
				this.setLevel = function setLevel(m, w) {
					...
					M[w] = m;
					var B = [];
					jQuery.each(jQuery.sap.log.LogLevel, function(A, v) {
						B[v] = A;
					});
					y(l, "Changing log level " + (w ? "for '" + w + "' " : "")
							+ "to " + B[m], "", "jQuery.sap.log");
					return this;
				};
				...
				this.isLoggable = function(m, v) {
					return (m == null ? D : m) <= r(v || i);
				};
			}
			jQuery.sap.log = jQuery.extend(new z(), {
				Level : {
					NONE : d - 1,
					FATAL : d,
					ERROR : j,
				...
				addLogListener : function(o) {
					x().attach(this, o);
					return this;
				},
				removeLogListener : function(o) {
					x().detach(this, o);
					return this;
				}
			});
			...
			jQuery.sap.assert = function(R, m) {
				if (!R) {
					...
					if (window.console && console.assert) {
						console.assert(R, s + i);
					} else {
						jQuery.sap.log.debug("[Assertions] " + i);
					}
				}
			};
			C.loglevel = (function() {
				var m = /(?:\?|&)sap-ui-log(?:L|-l)evel=([^&]*)/
						.exec(window.location.search);
				return m && m[1];
			}())
					|| C.loglevel;
			if (C.loglevel) {
				jQuery.sap.log.setLevel(jQuery.sap.log.Level[C.loglevel
						.toUpperCase()]
						|| parseInt(C.loglevel, 10));
			}
		...
		jQuery.sap.getObject = function getObject(n, N, o) {
			var O = o || _, d = (n || "").split("."), l = d.length, j = isNaN(N) ? 0
					: l - N, i;
			for (i = 0; O && i < l; i++) {
				if (!O[d[i]] && i < j) {
					O[d[i]] = {};
		...
		jQuery.sap.setObject = function(n, v, o) {
			var O = o || _, N = (n || "").split("."), l = N.length, i;
			if (l > 0) {
				for (i = 0; O && i < l - 1; i++) {
					if (!O[N[i]]) {
						O[N[i]] = {};
		...
		function S(n, d, T) {
			...
			this.finishTask = function(m, r) {
				if (!i[m] || i[m].finished) {
					throw new Error(
							"trying to finish non existing or already finished task");
				}
				i[m].finished = true;
				o--;
				if (r === false) {
				...
				if (o === 0) {
					jQuery.sap.log.info("Sync point '" + n
							+ "' finished (tasks:" + i.length + ", open:" + o
							+ ", failures:" + j + ")");
					if (s) {
						clearTimeout(s);
						s = null;
			...
			if (!isNaN(T)) {
				s = setTimeout(function() {
					jQuery.sap.log.info("Sync point '" + n
							+ "' timed out (tasks:" + i.length + ", open:" + o
							+ ", failures:" + j + ")");
					l();
				}, T);
			}
			jQuery.sap.log.info("Sync point '" + n + "' created"
					+ (T ? "(timeout after " + T + " ms)" : ""));
		}
		jQuery.sap.syncPoint = function(n, d, T) {
			return new S(n, d, T);
		};
		var h = (function() {
			var o = jQuery.sap.log
					.getLogger(
							"sap.ui.ModuleSystem",
							(/sap-ui-xx-debug(M|-m)odule(L|-l)oading=(true|x|X)/
									.test(location.search) || C["xx-debugModuleLoading"]) ? jQuery.sap.log.Level.DEBUG
									: jQuery.sap.log.Level.INFO), U = {
				'' : {
					'url' : 'resources/'
				}
			}, r = 0, v = -1, L = 1, w = 2, x = 3, R = 4, y = 5, M = {
			...
			}, B = [], D = "", G = 512 * 1024, H = document.location.href
					.replace(/\?.*|#.*/g, ""), K = "fragment", N = "view", O = {
				js : [ N, K, "controller", "designtime" ],
				xml : [ N, K ],
				json : [ N, K ],
				html : [ N, K ]
			}, Q = new RegExp("(\\.(?:" + O.js.join("|") + "))?\\.js$"), T, W;
			(function() {
				var s = "", d = "";
				jQuery.each(O, function(i, j) {
					s = (s ? s + "|" : "") + i;
					d = (d ? d + "|" : "") + "(?:(?:" + j.join("\\.|")
							+ "\\.)?" + i + ")";
				});
			...
			function X(s) {
				if (/^sap\.ui\.thirdparty\.jquery\.jquery-/.test(s)) {
					return "sap/ui/thirdparty/jquery/jquery-"
							+ s
									.slice("sap.ui.thirdparty.jquery.jquery-".length);
			...
			function Z(s, d) {
				var i = s.split(/\//), l, j, h1, m;
				if (arguments.length === 1 && i.length > 0) {
					m = W.exec(i[i.length - 1]);
					if (m) {
						d = m[0];
			...
			function c1(s, d) {
				...
				h1 = (m.index === 0 ? s + d : d).split('/');
				for (i = 0, j = 0, l = h1.length; i < l; i++) {
					var i1 = h1[i];
					if (b1.test(i1)) {
						if (i1 === '.' || i1 === '') {
							continue;
							...
							if (j === 0) {
								throw new Error(
										"Can't navigate to parent of root (base='"
												+ s + "', name='" + d + "'");
							}
							j--;
						} else {
							throw new Error("illegal path segment '" + i1 + "'");
						}
					} else {
						h1[j++] = i1;
					}
			...
			function e1(s) {
				var m = Q.exec(s), d = A[s], j, l, h1, i1, i;
				if (!m) {
				...
				if (h1.state !== r) {
					...
					if (h1.state === R) {
						...
						throw new Error("found in negative cache: '" + s
								+ "' from " + h1.url + ": " + h1.error);
					} else {
						return this;
					}
				}
				h1.state = L;
				i1 = window["sap-ui-loaddbg"] ? [ "-dbg", "" ] : [ "" ];
				for (i = 0; i < i1.length && h1.state !== w; i++) {
					h1.url = Z(j, i1[i] + l);
					if (o.isLoggable()) {
						o.debug(D + "loading "
								+ (i1[i] ? i1[i] + " version of " : "") + "'"
								+ s + "' from '" + h1.url + "'");
					}
					jQuery.ajax({
						url : h1.url,
						dataType : 'text',
						async : false,
						success : function(j1, k1, l1) {
							h1.state = w;
							h1.data = j1;
						},
						error : function(j1, k1, l1) {
							h1.state = y;
							h1.error = j1 ? j1.status + " - " + j1.statusText
									: k1;
						}
					});
				}
				...
				if (h1.state !== R) {
					throw new Error("failed to load '" + s + "' from " + h1.url
							+ ": " + h1.error);
				}
			}
			function f1(m) {
				var d = M[m], s = A[m], i, j, l;
				if (d && d.state === w && typeof d.data !== "undefined") {
					l = (s === true || (s && s.amd))
					...
					try {
						...
						if (typeof d.data === "function") {
							d.data.call(window);
						} else if (jQuery.isArray(d.data)) {
							sap.ui.define.apply(sap.ui, d.data);
						} else {
							j = d.data;
							if (j
									&& !j
											.match(/\/\/[#@] source(Mapping)?URL=.*$/)) {
								j += "\n//# sourceURL="
										+ URI(d.url).absoluteTo(H);
							}
							if (typeof jQuery.sap.require._hook === "function") {
								j = jQuery.sap.require._hook(j, m);
							}
							if (_.execScript && (!d.data || d.data.length < G)) {
								try {
									d.data && _.execScript(j);
								} catch (e) {
									B.pop();
						...
						d.data = undefined;
						d.content = d.content
								|| jQuery.sap.getObject((s && s.exports)
										|| Y(m));
						if (o.isLoggable()) {
							D = i;
							o.debug(D + "finished executing '" + m + "'");
						}
					} catch (h1) {
						d.state = y;
						d.error = ((h1.toString && h1.toString()) || h1.message)
								+ (h1.line ? "(line " + h1.line + ")" : "");
						d.data = undefined;
						if (window["sap-ui-debug"]
								&& (/sap-ui-xx-show(L|-l)oad(E|-e)rrors=(true|x|X)/
										.test(location.search) || C["xx-showloaderrors"])) {
							o
			...
			function g1(s, d, j) {
				...
				for (i = 0; i < d.length; i++) {
					...
					e1(l + ".js");
					m[i] = M[l + ".js"].content
							|| jQuery.sap.getObject(Y(l + ".js"));
					o.debug(D + "require '" + l + "': done.");
				}
				j(m);
			}
			...
			jQuery.sap.getResourcePath = Z;
			jQuery.sap.registerModulePath = function registerModulePath(m, d) {
				m = m.replace(/\./g, "/");
				d = d || '.';
				jQuery.sap.registerResourcePath(m, d);
			};
			jQuery.sap.registerResourcePath = function registerResourcePath(s,
					d) {
				s = String(s || "");
				if (U[s] && U[s]["final"] == true) {
					o.warning("registerResourcePath with prefix " + s
							+ " already set as final to '" + U[s].url
				...
				if (!d || d.url == null) {
					delete U[s];
					o.info("registerResourcePath ('" + s
							+ "') (registration removed)");
				} else {
					d.url = String(d.url);
					var i = d.url.indexOf("?");
					if (i !== -1) {
						d.url = d.url.substr(0, i);
					}
					var j = d.url.indexOf("#");
					if (j !== -1) {
						d.url = d.url.substr(0, j);
					}
					if (d.url.slice(-1) != '/') {
						d.url += '/';
					}
					U[s] = d;
					o.info("registerResourcePath ('" + s + "', '" + d.url
							+ "')" + ((d['final']) ? " (final)" : ""));
				}
			};
			...
			for ( var n in U) {
				o.info("  " + (n ? "'" + n + "'" : "(default)") + " : "
						+ U[n].url + ((U[n]['final']) ? " (final)" : ""));
			}
			jQuery.sap.declare = function(m, d) {
				var s = m;
				if (typeof (m) === "object") {
					s = m.modName;
					m = X(m.modName) + (m.type ? "." + m.type : "") + ".js";
				} else {
					m = X(m) + ".js";
				}
				d1(m);
			...
			sap.ui.define = function(m, d, i, j) {
				...
				g1(
						...
						function(i1) {
							if (o.isLoggable()) {
								o.debug("define(" + s + "): calling factory "
										+ typeof i);
							}
							if (j) {
								var j1 = s.split('/').slice(0, -1).join('.');
								if (j1) {
									jQuery.sap.getObject(j1, 0);
								}
							}
							if (typeof i === 'function') {
								h1.content = i.apply(window, i1);
							} else {
								h1.content = i;
							}
							if (j) {
								if (h1.content == null) {
									...
									if (o.isLoggable()) {
										o.debug("exporting content of '" + s
												+ "': as global object");
									}
									jQuery.sap.setObject(m, h1.content);
								}
							}
						});
			};
			...
			sap.ui.require = function(d, i) {
				if (typeof d === 'string') {
					var m = d + '.js', j = M[m];
					return j ? (j.content || jQuery.sap.getObject(Y(m)))
							: undefined;
				}
				g1(null, d, function(l) {
					if (typeof i === 'function') {
						setTimeout(function() {
							i.apply(window, l);
						}, 0);
			...
			jQuery.sap.preloadModules = function(s, d, i) {
				...
				jQuery
						.ajax({
							...
							error : function(m, h1, i1) {
								o.error("failed to preload '" + s + "': "
										+ (i1 || h1));
			...
			jQuery.sap.registerPreloadedModules = function(d, i, s) {
				...
				if (o.isLoggable()) {
					o
							.debug(D + "adding preloaded modules from '"
									+ d.url + "'");
				}
				if (d.name) {
					z[d.name] = true;
				}
				jQuery.each(d.modules, function(l, m) {
					l = j ? X(l) + ".js" : l;
					if (!M[l]) {
						M[l] = {
							state : v,
					...
					if (l.match(/\/library\.js$/)) {
						z[Y(l) + "-preload"] = true;
					}
				});
				if (d.dependencies) {
					jQuery.each(d.dependencies, function(l, m) {
						jQuery.sap.preloadModules(m, i, s);
					});
				}
			};
			jQuery.sap.unloadResources = function(s, d, j, l) {
				...
				jQuery.each(m, function(i, h1) {
					var i1 = M[h1];
					if (i1 && l && h1.match(/\.js$/)) {
						jQuery.sap.setObject(Y(h1), undefined);
					}
					if (i1 && (j || i1.state === v)) {
						delete M[h1];
					}
			...
			jQuery.sap.loadResource = function(s, m) {
				...
				i1 = m.async ? new jQuery.Deferred() : null;
				function j1(d, e) {
					if (d == null && m.failOnError) {
						h1 = e || new Error("no data returned for " + s);
						if (m.async) {
							i1.reject(h1);
							jQuery.sap.log.error(h1);
						}
						return null;
					}
					if (m.async) {
				...
				function k1(d) {
					var l1 = jQuery.ajaxSettings.converters["text " + i];
				...
				if (j != null) {
					...
					jQuery
							.ajax({
								...
								dataType : i,
								headers : m.headers,
								success : function(d, l1, m1) {
									j = j1(d);
								},
								error : function(d, l1, m1) {
									h1 = new Error(
											"resource "
													+ s
			...
			jQuery.sap._loadJSResourceAsync = function(s, i) {
				return new Promise(function(d, j) {
					...
					var l = m.url = Z(s);
					m.state = L;
					var h1 = window.document.createElement('SCRIPT');
					h1.src = l;
					h1.setAttribute("data-sap-ui-module", s);
					h1.addEventListener('load',
							function(e) {
								jQuery.sap.log
										.info("Javascript resource loaded: "
												+ s);
								m.state = R;
								d();
							});
					h1.addEventListener('error', function(e) {
						jQuery.sap.log
								.error("failed to load Javascript resource: "
										+ s);
						m.state = y;
						if (i) {
							d();
		...
		var I;
		var p = jQuery.sap._mIEStyleSheets = {};
		jQuery.sap.includeStyleSheet = function includeStyleSheet(U, s, l, d) {
			var j = function(U, s, l, d) {
				...
				if (!!sap.ui.Device.browser.internet_explorer) {
					...
					n = function(v) {
						var R;
						try {
							R = v.target && v.target.sheet
									&& v.target.sheet.rules;
						} catch (w) {
						}
						if (R && R.length > 0) {
							r();
			...
			var m = function(U, s, l, d) {
				if (sap.ui.Device.browser.internet_explorer
						&& sap.ui.Device.browser.version <= 9
						&& document.styleSheets.length >= 28) {
					var r = URI.parse(document.URL).path;
					var A = new URI(U).absoluteTo(r).toString();
					if (s) {
						var n = p[s];
						if (n && n.href === A) {
							return;
					...
					jQuery.sap.log.warning("Stylesheet " + (s ? s + " " : "")
							+ "not added as LINK because of IE limits", U,
					...
					var x = document.getElementById('sap-ui-core-customcss');
					...
					if (jQuery('#sap-ui-core-customcss').length > 0) {
						jQuery('#sap-ui-core-customcss').first().before(
								jQuery(L));
					} else {
						k(L);
					}
			...
			if (o && o.tagName === "LINK" && o.rel === "stylesheet") {
				if (l
						|| d
						|| o.href !== URI(String(U), URI().search(""))
								.toString()) {
					jQuery(o).replaceWith(j(U, s, l, d));
				}
			} else {
				m(U, s, l, d);
			}
						...
						.keydown(
								function(e) {
									if (e.keyCode == 80 && e.shiftKey
										...
										try {
											jQuery.sap
													.require("sap.ui.debug.TechnicalInfo");
										} catch (d) {
											return;
										}
						...
						.keydown(
								function(e) {
									if (e.keyCode == 83 && e.shiftKey
										...
										try {
											jQuery.sap
													.require("sap.ui.core.support.Support");
		...
		var t = function(d, j) {
			if (jQuery.support[d] === undefined) {
				if (q[j] !== undefined) {
					...
					if (j === "boxFlex" || j === "flexOrder"
							|| j === "flexGrow") {
						if (!sap.ui.Device.browser.chrome
								|| sap.ui.Device.browser.version > 28) {
		...
		t("cssTransforms", "transform");
		t("cssTransforms3d", "perspective");
		t("cssTransitions", "transition");
		t("cssAnimations", "animationName");
		if (jQuery.support.cssGradients === undefined) {
			var E = document.createElement('div'), q = E.style;
			try {
				q.backgroundImage = "linear-gradient(left top, red, white)";
				q.backgroundImage = "-moz-linear-gradient(left top, red, white)";
				q.backgroundImage = "-webkit-linear-gradient(left top, red, white)";
				q.backgroundImage = "-ms-linear-gradient(left top, red, white)";
				q.backgroundImage = "-webkit-gradient(linear, left top, right bottom, from(red), to(white))";
			} catch (e) {
			}
			jQuery.support.cssGradients = (q.backgroundImage && q.backgroundImage
					.indexOf("gradient") > -1);
			E = null;
		}
		jQuery.support.flexBoxPrefixed = true;
		t("flexBoxLayout", "boxFlex");
		t("newFlexBoxLayout", "flexGrow");
		if (!jQuery.support.newFlexBoxLayout && q.msFlexOrder !== undefined) {
		...
		if (jQuery.support.flexBoxLayout || jQuery.support.newFlexBoxLayout
				|| jQuery.support.ie10FlexBoxLayout) {
			...
			this.setActive = function(o) {
				...
				if (A) {
					jQuery.ajax = function(i, j) {
						jQuery.sap.measure.start(i.url, "Request for " + i.url);
						var x = d.apply(this, arguments);
						jQuery.sap.measure.end(i.url);
						return x;
					};
				} else if (d) {
					jQuery.ajax = d;
		...
		var F = function(s) {
			...
			if (F.__parent === F.__self || F.__parent == null
					|| this.sMode === F.Mode.ALLOW) {
				this._applyState(true, true);
			} else {
				this._lock();
				if (this.sMode === F.Mode.DENY) {
		...
		F.__self = self;
		F.__top = top;
		F._events = [ "mousedown", "mouseup", "click", "dblclick", "mouseover",
				"mouseout", "touchstart", "touchend", "touchmove",
				"touchcancel", "keydown", "keypress", "keyup" ];
		...
		F.prototype._setCursor = function() {
			if (this._lockDiv) {
				this._lockDiv.style.cursor = this.sStatus == "denied" ? "not-allowed"
						: "wait";
			}
		};
		F.prototype._lock = function() {
			...
			if (this.bBlockEvents) {
				for (var i = 0; i < F._events.length; i++) {
					document.addEventListener(F._events[i], F._lockHandler,
							true);
				}
			}
		...
		F.prototype._unlock = function() {
			if (this.bBlockEvents) {
				for (var i = 0; i < F._events.length; i++) {
					document.removeEventListener(F._events[i], F._lockHandler,
							true);
				}
			}
			if (this.bShowBlockLayer) {
		...
		F.prototype._callback = function(s) {
		...
		F.prototype._check = function(d) {
			...
			var T = false;
			if (this.bAllowSameOrigin && this.sParentOrigin
					&& F.__window.document.URL.indexOf(this.sParentOrigin) == 0) {
				T = true;
			} else if (this.mSettings.whitelist
					&& this.mSettings.whitelist.length != 0) {
				...
				for (var i = 0; i < this.mSettings.whitelist.length; i++) {
					...
					if (m != -1
							&& H.substring(m) == this.mSettings.whitelist[i]) {
						T = true;
						break;
					}
				}
			...
			if (T) {
				...
				var l = this.mSettings.whitelistService + '?parentOrigin='
						+ encodeURIComponent(this.sParentOrigin);
				x.onreadystatechange = function() {
					if (x.readyState == 4) {
						j._handleXmlHttpResponse(x, d);
					}
				};
				x.open('GET', l, true);
		...
		F.prototype._handleXmlHttpResponse = function(x, d) {
			if (x.status === 200) {
				var T = false;
				...
				jQuery.sap.log
						.warning("The configured whitelist service is not available: "
								+ x.status);
				this._callback(false);
			}
		};
		F.prototype._notifyChildFrames = function() {
			for (var i = 0; i < this.aFPChilds.length; i++) {
				this.aFPChilds[i].postMessage(
						'SAPFrameProtection*parent-unlocked', '*');
			}
		};
		F.prototype._sendRequireMessage = function() {
			F.__parent.postMessage('SAPFrameProtection*require-origin', '*');
		...
		F.prototype._handlePostMessage = function(o) {
			var s = o.source, d = o.data;
			if (s === F.__self || s == null || typeof d !== "string"
					|| d.indexOf("SAPFrameProtection*") === -1) {
				return;
			}
			if (s === F.__parent) {
			...
			} else if (s.parent === F.__self
					&& d == "SAPFrameProtection*require-origin"
					&& this.bUnlocked) {
	...
	sap.ui
			.predefine(
					...
					function(q) {
						"use strict";
						if (typeof window.jQuery.sap.act === "object"
								|| typeof window.jQuery.sap.act === "function") {
							return q;
						}
						var _ = {}, a = true, b = null, c = 10000, d = !!window.addEventListener, e = [], f = false, g = null;
						function h() {
							b = null;
							if (f) {
								j();
						...
						if (d) {
							var E = [ "resize", "orientationchange",
									...
									"touchcancel", "paste", "cut", "keydown",
									"keyup", "DOMMouseScroll", "mousewheel" ];
	...
	sap.ui
			.predefine(
					...
					function(q, D) {
						...
						q.sap.domById = !!D.browser.internet_explorer
								&& D.browser.version < 8 ? d
								: function domById(i, w) {
									return i ? (w || window).document
											.getElementById(i) : null;
								};
						...
						q.sap.focus = function focus(o) {
							...
							try {
								...
								var i = (o && o.id) ? " (ID: '" + o.id + "')"
										: "";
								q.sap.log
										.warning("Error when trying to focus a DOM element"
												+ i + ": " + e.message);
								return false;
							}
							return true;
						...
						q.fn.cursorPos = function cursorPos(P) {
							var l = arguments.length, t, L, T, s;
							T = this.prop("tagName");
							s = this.prop("type");
							if (this.length === 1
									&& ((T == "INPUT" && (s == "text"
											|| s == "password" || s == "search")) || T == "TEXTAREA")) {
								var o = this.get(0);
								if (l > 0) {
						...
						q.fn.getSelectedText = function() {
							...
							try {
								if (typeof o.selectionStart === "number") {
									return o.value.substring(o.selectionStart,
											o.selectionEnd);
								}
						...
						q.fn.outerHTML = function outerHTML() {
							...
							if (o && o.outerHTML) {
								...
								var e = this[0] ? this[0].ownerDocument
										: document;
								var h = e.createElement("div");
								h.appendChild(o.cloneNode(true));
								return h.innerHTML;
							}
						};
						...
						q.fn.rectContains = function rectContains(P, i) {
							var r = this.rect();
							if (r) {
								return P >= r.left && P <= r.left + r.width
										&& i >= r.top && i <= r.top + r.height;
							}
							return false;
						};
						...
						q.fn.firstFocusableDomRef = function firstFocusableDomRef() {
							...
							if (!C || q(C).is(':hidden')
									|| q(C).filter(e).length == 1) {
								return null;
							}
							var o = C.firstChild, h = null;
							while (o) {
						...
						q.fn.lastFocusableDomRef = function lastFocusableDomRef() {
							...
							var o = C.lastChild, h = null;
							while (o) {
								if (o.nodeType == 1 && q(o).is(':visible')) {
									if (o.childNodes) {
										h = q(o).lastFocusableDomRef();
										if (h) {
											return h;
										}
									}
							...
							if (o) {
								if (P === undefined) {
									if (!!D.browser.internet_explorer
											|| !!D.browser.edge) {
										return o.scrollWidth - o.scrollLeft
												- o.clientWidth;
						...
						/*
						 * The following methods are taken from jQuery UI core
						 * but modified.
						 * 
						 ...
						 */
						q.support.selectstart = "onselectstart" in document
								.createElement("div");
						q.fn.extend({
							disableSelection : function() {
								return this.on(
										(q.support.selectstart ? "selectstart"
												: "mousedown")
												+ ".ui-disableSelection",
										function(e) {
											e.preventDefault();
						...
						/*
						 * ! The following functions are taken from jQuery UI
						 * 1.8.17 but modified
						 * 
						 * Copyright 2011, AUTHORS.txt
						 * (http://jqueryui.com/about) Dual licensed under the
						...
						function f(e, i) {
							...
							if (n === "area") {
								var m = e.parentNode, h = m.name, j;
								if (!e.href || !h
										|| m.nodeName.toLowerCase() !== "map") {
									return false;
								}
								j = q("img[usemap=#" + h + "]")[0];
								return !!j && v(j);
							...
							return (/input|select|textarea|button|object/
									.test(n) ? !e.disabled : n == "a" ? e.href
									|| i : i)
									&& v(e);
						}
						if (!q.expr[":"].focusable) {
							/*
							 * ! The following function is taken from jQuery UI
							 * 1.8.17
							 * 
							 * Copyright 2011, AUTHORS.txt
							 ...
							 * http://docs.jquery.com/UI
							 * 
							 * But since visible is modified, focusable is
							 * different too the jQuery UI version too.
							 */
							q.extend(q.expr[":"], {
						...
						q.fn.parentByAttribute = function parentByAttribute(A,
								V) {
							if (this.length > 0) {
								if (V) {
									return this.first().parents(
											"[" + A + "='" + V + "']").get(0);
								} else {
									return this.first().parents("[" + A + "]")
											.get(0);
								}
							}
						};
						...
						q.sap.scrollbarSize = function(C, F) {
							...
							var A = q("<DIV/>").css("visibility", "hidden")
									.css("height", "0").css("width", "0").css(
											"overflow", "hidden");
							if (C) {
								A.addClass(C);
							}
						...
						q.sap.syncStyleClass = function(s, S, e) {
							...
							var h = !!S.closest("." + s).length;
							if (e instanceof q) {
								e.toggleClass(s, h);
							} else if (C && e instanceof C) {
								e.toggleStyleClass(s, h);
							} else {
							}
							return e;
						};
						...
						function c(A, V) {
							var s = this.attr(A) || "", e = s.split(" "), i = e
									.indexOf(V);
							if (i == -1) {
								return this;
							}
						...
						function p(o, n) {
							if (o.childElementCount != n.childElementCount
									|| o.tagName != n.tagName) {
							...
							for (var i = 0, e = N.length; i < e; i++) {
								var A = N[i].name, h = o.getAttribute(A), j = n
										.getAttribute(A);
								if (h === null || h !== j) {
									o.setAttribute(A, j);
								}
							...
							if (!k && !o.hasChildNodes()) {
								return true;
							}
							if (!n.childElementCount) {
								if (!k) {
									o.textContent = "";
								} else if (k == 1 && n.firstChild.nodeType == 3) {
							...
							for (var i = 0, r = 0, e = k; i < e; i++) {
								var l = o.childNodes[i], m = n.childNodes[i - r];
								if (m.nodeType == 1) {
									if (!p(l, m)) {
										r = r + 1;
									}
								} else {
									l.nodeValue = m.nodeValue;
								}
							}
							return true;
						}
	...
	sap.ui
			.predefine(
					...
					function(q) {
						...
						var r = /[\x00-\x2b\x2f\x3a-\x40\x5b-\x5e\x60\x7b-\xff\u2028\u2029]/g, a = /[\x00-\x08\x0b\x0c\x0e-\x1f\x7f-\x9f]/, H = {
							"<" : "&lt;",
							">" : "&gt;",
							"&" : "&amp;",
							"\"" : "&quot;"
						...
						var b = /[\x00-\x2b\x2d\x2f\x3a-\x40\x5b-\x5e\x60\x7b-\xff\u2028\u2029]/g, j = {};
						var J = function(g) {
							var E = j[g];
							if (!E) {
						...
						var c = /[\x00-\x2c\x2f\x3a-\x40\x5b-\x5e\x60\x7b-\uffff]/g, u = {};
						var U = function(g) {
							var E = u[g];
							if (!E) {
								var i = g.charCodeAt(0);
						...
						q.sap.validateUrl = function(g) {
							...
							var p = k[1], l = k[2], P = k[3], m = k[4], Q = k[5], n = k[6];
							var o = /[\x00-\x24\x26-\x29\x2b\x2c\x2f\x3a-\x40\x5b-\x5e\x60\x7b-\x7d\x7f-\uffff]/;
							var t = /[\x00-\x24\x26-\x29\x2b\x2c\x3a-\x3e\x5b-\x5e\x60\x7b-\x7d\x7f-\uffff]/;
							var v = /[a-z0-9!#$%&'*+\/=?^_`{|}~-]+(?:\.[a-z0-9!#$%&'*+\/=?^_`{|}~-]+)*@(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9])?/;
							if (p) {
								p = p.toUpperCase();
								if (w.length <= 0) {
							...
							if (Q) {
								...
								for (var i = 0; i < y.length; i++) {
									var z = y[i].search("=");
									if (z != -1) {
										var A = y[i].substring(0, z);
										var B = y[i].substring(z + 1);
										var D = o.test(A);
										var E = o.test(B);
										if (D || E) {
											return false;
							...
							if (w.length > 0) {
								...
								for (var i = 0; i < w.length; i++) {
									if (!p || !w[i].protocol
										...
										if (l && w[i].host
												&& /^\*/.test(w[i].host)) {
											var G = w[i].host.slice(1).replace(
													/[-[\]{}()*+?.,\\^$|#\s]/g,
													"\\$&");
											var I = RegExp(G + "$");
											if (I.test(l)) {
						...
						function e(g, o) {
							...
							var t = o.tagPolicy
									|| window.html.makeTagPolicy(o.uriRewriter,
											o.tokenPolicy);
					...
					function(q, D) {
						...
						if (D.browser.webkit
							...
							(function() {
								...
								m = [ "mousedown", "mouseover", "mouseup",
										"mouseout", "click" ];
								var A = function(C, E) {
									if (!H) {
										return;
									}
									var M = E.type == "touchend" ? E.changedTouches[0]
											: E.touches[0];
									var F = e.createEvent('MouseEvent');
									F.initMouseEvent(C, true, true, window,
											E.detail, M.screenX, M.screenY,
											M.clientX, M.clientY, E.ctrlKey,
								...
								a = function(E) {
									...
									if (H) {
										C = E.touches[0];
										if (Math.abs(C.clientX - S) > 10
												|| Math.abs(C.clientY - z) > 10) {
											j = true;
										}
										if (j) {
											A("mousemove", E);
						...
						q.sap.ControlEvents = [ "click", "dblclick",
								"contextmenu", "focusin", "focusout",
								"keydown", "keypress", "keyup", "mousedown",
								"mouseout", "mouseover", "mouseup", "select",
								"selectstart", "dragstart", "dragenter",
								"dragover", "dragleave", "dragend", "drop",
								"paste", "cut", "input" ];
						if (D.support.touch) {
							q.sap.ControlEvents.push("touchstart", "touchend",
						...
						q.sap.PseudoEvents = {
							sapdown : {
								...
								aTypes : [ "keydown" ],
								fnCheck : function(e) {
									return e.keyCode == q.sap.KeyCodes.ARROW_DOWN
											&& !k(e);
								}
							},
							sapdownmodifiers : {
							...
							sapshow : {
								...
								aTypes : [ "keydown" ],
								fnCheck : function(e) {
									return (e.keyCode == q.sap.KeyCodes.F4 && !k(e))
											|| (e.keyCode == q.sap.KeyCodes.ARROW_DOWN && h(
													e, false, true, false));
								}
							},
							sapup : {
								...
								aTypes : [ "keydown" ],
								fnCheck : function(e) {
									return e.keyCode == q.sap.KeyCodes.ARROW_UP
											&& !k(e);
								}
							},
							sapupmodifiers : {
							...
							sapleft : {
								...
								aTypes : [ "keydown" ],
								fnCheck : function(e) {
									return e.keyCode == q.sap.KeyCodes.ARROW_LEFT
											&& !k(e);
								}
							},
							sapleftmodifiers : {
							...
							sapright : {
								...
								aTypes : [ "keydown" ],
								fnCheck : function(e) {
									return e.keyCode == q.sap.KeyCodes.ARROW_RIGHT
											&& !k(e);
								}
							},
							saprightmodifiers : {
							...
							saphome : {
								...
								aTypes : [ "keydown" ],
								fnCheck : function(e) {
									return e.keyCode == q.sap.KeyCodes.HOME
											&& !k(e);
								}
							},
							saphomemodifiers : {
							...
							sapend : {
								...
								aTypes : [ "keydown" ],
								fnCheck : function(e) {
									return e.keyCode == q.sap.KeyCodes.END
											&& !k(e);
								}
							},
							sapendmodifiers : {
							...
							sappageup : {
								...
								aTypes : [ "keydown" ],
								fnCheck : function(e) {
									return e.keyCode == q.sap.KeyCodes.PAGE_UP
											&& !k(e);
								}
							},
							sappageupmodifiers : {
							...
							sappagedown : {
								...
								aTypes : [ "keydown" ],
								fnCheck : function(e) {
									return e.keyCode == q.sap.KeyCodes.PAGE_DOWN
											&& !k(e);
								}
							},
							...
							sapselect : {
								...
								aTypes : [ "keydown" ],
								fnCheck : function(e) {
									return (e.keyCode == q.sap.KeyCodes.ENTER || e.keyCode == q.sap.KeyCodes.SPACE)
											&& !k(e);
								}
							},
							sapselectmodifiers : {
							...
							sapspace : {
								...
								aTypes : [ "keydown" ],
								fnCheck : function(e) {
									return e.keyCode == q.sap.KeyCodes.SPACE
											&& !k(e);
								}
							},
							sapspacemodifiers : {
							...
							sapenter : {
								...
								aTypes : [ "keydown" ],
								fnCheck : function(e) {
									return e.keyCode == q.sap.KeyCodes.ENTER
											&& !k(e);
								}
							},
							sapentermodifiers : {
							...
							sapbackspace : {
								...
								aTypes : [ "keydown" ],
								fnCheck : function(e) {
									return e.keyCode == q.sap.KeyCodes.BACKSPACE
											&& !k(e);
								}
							},
							...
							sapdelete : {
								...
								aTypes : [ "keydown" ],
								fnCheck : function(e) {
									return e.keyCode == q.sap.KeyCodes.DELETE
											&& !k(e);
								}
							},
							sapdeletemodifiers : {
							...
							sapexpand : {
								...
								aTypes : [ "keydown" ],
								fnCheck : function(e) {
									return e.keyCode == q.sap.KeyCodes.NUMPAD_PLUS
											&& !k(e);
								}
							},
							sapexpandmodifiers : {
							...
							sapcollapse : {
								...
								aTypes : [ "keydown" ],
								fnCheck : function(e) {
									return e.keyCode == q.sap.KeyCodes.NUMPAD_MINUS
											&& !k(e);
								}
							},
							...
							sapcollapseall : {
								...
								aTypes : [ "keydown" ],
								fnCheck : function(e) {
									return e.keyCode == q.sap.KeyCodes.NUMPAD_ASTERISK
											&& !k(e);
								}
							},
							sapescape : {
								...
								aTypes : [ "keydown" ],
								fnCheck : function(e) {
									return e.keyCode == q.sap.KeyCodes.ESCAPE
											&& !k(e);
								}
							},
							saptabnext : {
								...
								aTypes : [ "keydown" ],
								fnCheck : function(e) {
									return e.keyCode == q.sap.KeyCodes.TAB
											&& !k(e);
								}
							},
							saptabprevious : {
							...
							sapskipforward : {
								...
								aTypes : [ "keydown" ],
								fnCheck : function(e) {
									return e.keyCode == q.sap.KeyCodes.F6
											&& !k(e);
								}
							},
							sapskipback : {
							...
							sapdecrease : {
								...
								aTypes : [ "keydown" ],
								fnCheck : function(e) {
									var R = sap.ui.getCore().getConfiguration()
											.getRTL();
									var i = R ? q.sap.KeyCodes.ARROW_RIGHT
											: q.sap.KeyCodes.ARROW_LEFT;
							...
							sapincrease : {
								...
								fnCheck : function(e) {
									var R = sap.ui.getCore().getConfiguration()
											.getRTL();
									var N = R ? q.sap.KeyCodes.ARROW_LEFT
											: q.sap.KeyCodes.ARROW_RIGHT;
							...
							sapdelayeddoubleclick : {
								...
								fnCheck : function(e) {
									...
									var j = e.timeStamp;
									var z = i
											.data("sapdelayeddoubleclick_lastClickTimestamp");
									var A = z || 0;
									i
											.data(
													"sapdelayeddoubleclick_lastClickTimestamp",
													j);
									var B = j - A;
									return (B >= 300 && B <= 1300);
								}
						...
						var P = [ "sapdown", "sapdownmodifiers", "sapshow",
								"sapup", "sapupmodifiers", "saphide",
								"sapleft", "sapleftmodifiers", "sapright",
								"saprightmodifiers", "saphome",
								"saphomemodifiers", "saptop", "sapend",
								"sapendmodifiers", "sapbottom", "sappageup",
								"sappageupmodifiers", "sappagedown",
								"sappagedownmodifiers", "sapselect",
								"sapselectmodifiers", "sapspace",
								"sapspacemodifiers", "sapenter",
								"sapentermodifiers", "sapexpand",
								"sapbackspace", "sapbackspacemodifiers",
								"sapdelete", "sapdeletemodifiers",
								"sapexpandmodifiers", "sapcollapse",
								"sapcollapsemodifiers", "sapcollapseall",
								"sapescape", "saptabnext", "saptabprevious",
								"sapskipforward", "sapskipback", "sapprevious",
								"sappreviousmodifiers", "sapnext",
								"sapnextmodifiers", "sapdecrease", "sapminus",
								"sapdecreasemodifiers", "sapincrease",
								"sapplus", "sapincreasemodifiers",
								"sapdelayeddoubleclick" ];
						(function initTouchEventSupport() {
							...
							if (D.support.touch) {
								...
								q.event.props.push("touches", "targetTouches",
										"changedTouches");
							}
							...
							var M = function(J, K) {
								...
								if (!(J.type != "mouseout" || (J.type === "mouseout" && q.sap
										.checkMouseEnterOrLeave(J, K.domRef)))) {
									var N = true;
								...
								if (K.eventName === "touchstart"
										|| $.data("__touch_in_progress")) {
									$.data("__touch_in_progress", "X");
									var W = q.fn.control ? q(J.target).control(
											0) : null;
									if (W) {
										$.data("__touchstart_control", W
												.getId());
									}
									if (J.type === "mouseout") {
							...
							function z() {
								var J = window["sap-ui-config"] || {}, K = J.libs
										|| "";
								function N(Q) {
								...
								return D.support.touch || N("xx-test-mobile")
										|| N("xx-fakeOS") || K.match(/sap.m\b/);
							}
							if (z()) {
								q.sap
										.require("sap.ui.thirdparty.jquery-mobile-custom");
								if (D.support.touch && !D.support.pointer) {
									var F = false, B = q.vmouse.moveDistanceThreshold, S, C, O, E, L;
									var G = function(J, K, N) {
										var Q = q.event.fix(J.originalEvent
												|| J);
										...
										Q.button = (D.browser.msie
												&& D.browser.version <= 8 ? 1
												: 0);
										return Q;
									};
									var T = function(J, K) {
										...
										var Q = G(J, K, J.touches[0]);
										q.sap.delayedCall(0, this,
												function() {
													Q.setMark(
															"handledByUIArea",
															false);
													K.eventHandle.handler.call(
															K.domRef, Q);
												});
									};
									var H = function(J, K) {
										...
										function U() {
											return G(
													J,
													K,
													K.eventName === "mouseup" ? J.changedTouches[0]
															: J.touches[0]);
										}
										if (J.type === "touchstart") {
											...
											O = Math
													.round(V.pageX
															- q(J.target)
																	.offset().left);
											E = Math.round(V.pageY
													- q(J.target).offset().top);
											N = U();
											q.sap
													.delayedCall(
															0,
									...
									j("mouseup", [ "touchend", "touchcancel" ],
											H);
								}
								A.push("swipe", "tap", "swipeleft",
										"swiperight", "scrollstart",
										"scrollstop");
								e
										.push({
											sName : "swipebegin",
											aTypes : [ "swipeleft",
													"swiperight" ],
											fnCheck : function(J) {
												var R = sap.ui.getCore()
														.getConfiguration()
														.getRTL();
												return (R && J.type === "swiperight")
														|| (!R && J.type === "swipeleft");
											}
										});
								e
							...
							if (q.sap.Version(q.fn.jquery).compareTo("1.9.1") < 0) {
								q.sap.ControlEvents = q.sap.ControlEvents
										.concat(A);
							} else {
								q.sap.ControlEvents = A
										.concat(q.sap.ControlEvents);
							}
							for (var i = 0; i < e.length; i++) {
						...
						var g = f();
						function h(e, C, A, S) {
							return e.shiftKey == S && e.altKey == A
									&& l(e) == C;
						}
						function k(e) {
						...
						q.Event.prototype.getPseudoTypes = function() {
							...
							if (q.inArray(this.type, g) != -1) {
								...
								for (var i = 0; i < z; i++) {
									...
									if (A.aTypes
											&& q.inArray(this.type, A.aTypes) > -1
											&& A.fnCheck && A.fnCheck(this)) {
										e.push(A.sName);
									}
								}
							}
						...
						q.sap.bindAnyEvent = function bindAnyEvent(C) {
							if (C) {
								q(document).bind(q.sap.ControlEvents.join(" "),
										C);
							}
						};
						q.sap.unbindAnyEvent = function unbindAnyEvent(C) {
							if (C) {
								q(document).unbind(
										q.sap.ControlEvents.join(" "), C);
							}
						};
						q.sap.checkMouseEnterOrLeave = function checkMouseEnterOrLeave(
								E, i) {
						...
						q.sap.isSpecialKey = function(e) {
							var K = q.sap.KeyCodes, i = e.which, S = n(e)
									|| p(e) || (i >= 33 && i <= 36)
									|| (i >= 44 && i <= 46)
									|| (i >= 112 && i <= 123)
									|| (i === K.BREAK) || (i === K.BACKSPACE)
									|| (i === K.TAB) || (i === K.ENTER)
									|| (i === K.ESCAPE)
									|| (i === K.SCROLL_LOCK);
							switch (e.type) {
							...
							case "keyup":
								return S;
							case "keypress":
								return (i === 0 || i === K.BACKSPACE
										|| i === K.ESCAPE || i === K.ENTER) || false;
							default:
								return false;
							}
						};
						function n(e) {
							var K = q.sap.KeyCodes, i = e.which;
							return (i === K.SHIFT) || (i === K.CONTROL)
									|| (i === K.ALT) || (i === K.CAPS_LOCK)
									|| (i === K.NUM_LOCK);
						}
						function p(e) {
							var K = e.which, A = (K >= 37 && K <= 40);
							switch (e.type) {
							case "keydown":
							case "keyup":
								return A;
						...
						function r(R) {
							var G = q(R).closest(
									'[data-sap-ui-customfastnavgroup="true"]');
							return G[0];
						}
						function t(R) {
							var G = r(R);
						...
						function u(R, S, N) {
							var $ = q(R), A, T;
							if (N) {
								A = q.merge($.find("*"), q.merge($.nextAll(), $
										.parents().nextAll()));
								T = A.find(':sapTabbable').addBack(
										':sapTabbable');
							} else {
								A = q.merge($.prevAll(), $.parents().prevAll());
								T = q
										.merge($.parents(':sapTabbable'), A
												.find(':sapTabbable').addBack(
														':sapTabbable'));
							}
							var T = q.unique(T);
						...
						function y(S, e, F) {
							...
							var j = t(S), A = v(q(e).find(':sapTabbable')
									.addBack(':sapTabbable'), e), $ = A.first(), T = v(
									u(S, e, F), e), G, z;
							if (F) {
							...
							if (z && z.length) {
								var B = z[0], E = null, C = r(B);
								if (C && C.id) {
									var H = sap.ui.getCore().byId(C.id);
									if (H) {
										E = q
												.Event("BeforeFastNavigationFocus");
										E.target = B;
										E.source = S;
										E.forward = F;
										H._handleEvent(E);
						...
						q.sap.handleF6GroupNavigation = function(e, S) {
							if (e.type != "keydown"
									|| e.keyCode != q.sap.KeyCodes.F6
									|| e
											.isMarked("sapui5_handledF6GroupNavigation")
									|| e.isMarked() || e.isDefaultPrevented()) {
								return;
							}
							...
							var T = S && S.target ? S.target
									: document.activeElement, i = null;
							if (S && S.scope) {
						...
						q.sap.isMouseEventDelayed = (D.browser.mobile && !((D.os.ios
								&& D.os.version >= 8 && D.browser.safari) || (D.browser.chrome
	...
	sap.ui
			.predefine(
					'jquery.sap.mobile',
					[ 'jquery.sap.global', 'sap/ui/Device', 'jquery.sap.dom',
							'jquery.sap.events' ],
					function(q, D) {
						"use strict";
						(function($) {
							...
							if ((D.browser.webkit || (D.browser.msie && D.browser.version >= 10))
								...
								var a = r
										&& r[1]
										|| q.sap.byId("sap-ui-bootstrap").attr(
												"data-sap-ui-xx-fakeOS");
								if (a) {
									...
									if (u
										...
										D
												._update($.sap.simulateMobileOnDesktop);
									}
								}
							}
							$.os = $.extend({
							...
							$.device.is = $.extend({
								...
								android_tablet : D.system.tablet
										&& D.os.android,
							...
							if (D.os.windows_phone) {
								...
								t
										.appendChild(document
												.createTextNode('@-ms-viewport{width:device-width;}'));
								document.head.appendChild(t);
							}
							var b = false;
							$.sap.initMobile = function(o) {
								...
								if (!b) {
									...
									if (D.os.ios
											&& o.preventPhoneNumberDetection) {
										c
												.append($('<meta name="format-detection" content="telephone=no">'));
									} else if (D.browser.msie) {
										c
												.append($('<meta http-equiv="cleartype" content="on">'));
										c
												.append($('<meta name="msapplication-tap-highlight" content="no">'));
									}
									var i = D.os.ios && D.os.version >= 7
											&& D.os.version < 8
											&& D.browser.name === "sf";
									if (o.viewport) {
										var m;
									...
									if (o.mobileWebAppCapable === "default") {
										...
										$.sap
												.setMobileWebAppCapable(o.mobileWebAppCapable);
									}
									if (D.os.ios) {
										c
												.append($('<meta name="apple-mobile-web-app-status-bar-style" content="'
														+ o.statusBar + '">'));
									}
									if (o.preventScroll
										...
										$(window)
												.bind(
														"touchmove",
														function sapInitMobileTouchMoveHandle(
																e) {
															if (!e.isMarked()) {
																e
																		.preventDefault();
								...
								if (o && o.homeIcon) {
									...
									I.precomposed = o.homeIconPrecomposed
											|| I.precomposed;
							...
							$.sap.setIcons = function(i) {
								if (!i || (typeof i !== "object")) {
									$.sap.log
											.warning("Call to jQuery.sap.setIcons() has been ignored because there were no icons given or the argument was not an object.");
									return;
								}
								var c = $("head"), p = i.precomposed ? "-precomposed"
										: "", g = function(h) {
									return i[h] || i['tablet@2']
											|| i['phone@2'] || i['phone']
											|| i['tablet'];
								}, s = {
									"phone" : "",
								...
								for ( var e in s) {
									...
									if (i[e]) {
										var f = s[e];
										c
												.append($('<link rel="apple-touch-icon'
														+ p
														+ '" '
														+ (f ? 'sizes="' + f
																+ '"' : "")
							...
							$.sap.setMobileWebAppCapable = function(v) {
								...
								var h = $("head"), p = [ "", "apple" ], n = "mobile-web-app-capable", c = v ? "yes"
										: "no", i, N, w;
	...
	sap.ui
			.predefine(
					...
					[ 'jquery.sap.global', 'jquery.sap.sjax' ],
					function(q) {
						"use strict";
						var P = function() {
							this.mProperties = {};
							...
							for (i = 0; i < l.length; i++) {
								...
								while ((m = a.exec(L)) !== null) {
									...
									if (m[1]) {
										...
										v += String.fromCharCode(parseInt(m[1]
												.slice(2), 16));
									} else if (m[2]) {
										v += E[m[2]] || m[2].slice(1);
									} else if (m[3]) {
							...
							if (A) {
								return new window.Promise(function(c, d) {
									...
									R.then(function(v) {
										...
										d(v instanceof Error ? v : new Error(
	...
	sap.ui
			.predefine(
					...
					[ 'jquery.sap.global', 'jquery.sap.properties',
							'jquery.sap.strings' ],
					function(q) {
						"use strict";
						...
						function d() {
							...
							if (window.sap && sap.ui && sap.ui.getCore) {
								L = sap.ui.getCore().getConfiguration()
										.getLanguage();
								L = n(L);
							}
							return L || "en";
						...
						var B = function(u, L, i, A) {
							...
							this.oUrlInfo = s(u);
							if (!this.oUrlInfo
									|| q.inArray(this.oUrlInfo.ext, v) < 0) {
								throw new Error(
										"resource URL '"
												+ u
						...
						B.prototype._enhance = function(C) {
							if (C && C instanceof B) {
								...
								q.sap.log
										.error("Custom ResourceBundle is either undefined or not an instanceof jQuery.sap.util.ResourceBundle. Therefore this custom ResourceBundle will be ignored!");
							}
						};
			...
			.predefine(
					...
					function(q) {
						...
						var U = function(u) {
							...
							if (Q.indexOf("?") >= 0) {
								...
								for (var i = 0; i < p.length; i++) {
									...
									v = a.length > 1 ? decodeURIComponent(a[1]
											.replace(/\+/g, ' ')) : "";
									if (n) {
						...
						U.prototype.get = function(n, a) {
							var v = Object.prototype.hasOwnProperty.call(
									this.mParams, n) ? this.mParams[n] : [];
						...
						q.sap.equal = function(a, b, m, c, d) {
							...
							if (typeof a == "object" && typeof b == "object") {
								...
								if (a.nodeName && b.nodeName && a.namespaceURI
										&& b.namespaceURI) {
							...
							for ( var n in o) {
								...
								: (function() {
									var D = [ "toString", "valueOf",
											"toLocaleString", "hasOwnProperty",
											"isPrototypeOf",
											"propertyIsEnumerable",
											"constructor" ], a = D.length, o = Object.prototype, h = o.hasOwnProperty;
									return function(O, c) {
										var n, i;
										for (n in O) {
											if (c(n, O[n]) === false) {
							...
							if (n.length == 0) {
								...
								for (var i = 0; i < n.length; i++) {
									if (!N[i] || N[i].row > b) {
										...
										b = N[i].row + 1;
										for (var j = N[i].row + 1; j < o.length
												&& (!O[j] || O[j].row < i); j++) {
											d.push({
												index : i + 1,
												type : 'delete'
						...
						q.sap._createJSTokenizer = function() {
							...
							return {
								...
								setIndex : function(i) {
									if (i < a - 1) {
										throw new Error("Must not set index "
												+ i + " before previous index "
												+ (a - 1));
									}
									a = i;
									n();
						...
						q.sap.extend = function() {
							var s, c, a, n, o, b, t = arguments[0] || {}, i = 1, l = arguments.length, d = false;
							if (typeof t === "boolean") {
								d = t;
								t = arguments[i] || {};
								i++;
	...
	sap.ui
			.predefine(
					...
					function(q) {
						...
						q.sap.endsWithIgnoreCase = function endsWithIgnoreCase(
								s, e) {
							if (typeof (e) != "string" || e == "") {
								return false;
							}
						...
						q.sap.startsWithIgnoreCase = function startsWithIgnoreCase(
								s, S) {
							if (typeof (S) != "string" || S == "") {
								return false;
							}
						...
						q.sap.formatMessage = function formatMessage(p, v) {
							...
							return p.replace(c, function($, d, e, f, o) {
								...
								throw new Error(
										"formatMessage: pattern syntax error at pos. "
												+ o);
							});
						};
						var c = /('')|'([^']+(?:''[^']*)*)(?:'|$)|\{([0-9]+(?:\s*,[^{}]*)?)\}|[{}]/g;
	...
	sap.ui
			.predefine(
					'sap/ui/Global',
					[ 'jquery.sap.global', 'jquery.sap.dom' ],
					function(q) {
						"use strict";
						if (window.OpenAjax && window.OpenAjax.hub) {
							OpenAjax.hub.registerLibrary("sap",
									"http://www.sap.com/", "0.1", {});
						}
						if (typeof window.sap !== "object"
								&& typeof window.sap !== "function") {
							window.sap = {};
						}
						if (typeof window.sap.ui !== "object") {
							window.sap.ui = {};
						...
						sap.ui.lazyRequire = function(c, m, M) {
							var f = c.replace(/\//gi, "\."), l = f
									.lastIndexOf("."), p = f.substr(0, l), C = f
									.substr(l + 1), P = q.sap.getObject(p, 0), o = P[C], a = (m || "new")
									.split(" "), b = q.inArray("new", a);
							M = M || f;
							if (!o) {
								if (b >= 0) {
									o = function() {
										q.sap.log.debug("lazy stub for '" + f
												+ "' (constructor) called.");
										q.sap.require(M);
										var r = P[C];
										if (r._sapUiLazyLoader) {
											throw new Error(
													"lazyRequire: stub '"
															+ f
															+ "'has not been replaced by module '"
															+ M + "'");
										}
														...
														if (r[s]._sapUiLazyLoader) {
															throw new Error(
																	"lazyRequire: stub '"
																			...
																			+ "."
																			+ s
																			+ "' has not been replaced by loaded module '"
																			+ M
																			+ "'");
														}
														return r[s].apply(r,
						...
						sap.ui.localResources = function(n) {
							q.sap.registerModulePath(n, "./"
									+ n.replace(/\./g, "/"));
						};
						return sap.ui;
					}, true);
	sap.ui.predefine('sap/ui/base/BindingParser', [ 'jquery.sap.global',
			'./ExpressionParser', 'sap/ui/model/BindingMode',
			'jquery.sap.script' ], function(q, E, B) {
		"use strict";
		var a = {
		...
		function d(F, R) {
			function e() {
				var i, n = F.length, k = new Array(n);
				for (i = 0; i < n; i += 1) {
					k[i] = F[i].apply(this, arguments);
				}
				if (R) {
			...
			e.textFragments = R && R.textFragments
		...
		function h(o, s) {
			try {
				...
				q.sap.log.error("Cannot merge parts: " + e.message, s,
						"sap.ui.base.BindingParser");
			}
		}
		function j(e, i, s) {
			var p = q.sap.parseJS, P, k;
			function l(o, u) {
				if (typeof o[u] === "string") {
					var v, N = o[u];
					if (q.sap.startsWith(o[u], ".")) {
						v = q.sap.getObject(o[u].slice(1), undefined,
								e.oContext);
						o[u] = e.bStaticContext ? v : q.proxy(v, e.oContext);
					} else {
						o[u] = q.sap.getObject(o[u]);
					}
			...
			function m(o, u) {
				...
				if (typeof o[u] === "string") {
					if (q.sap.startsWith(o[u], ".")) {
						F = q.sap.getObject(o[u].slice(1), undefined,
								e.oContext);
					} else {
						F = q.sap.getObject(o[u]);
					}
					if (typeof F === "function") {
						o[u] = new F(o.formatOptions, o.constraints);
					} else {
						o[u] = F;
					}
			...
			function t(o, u, v) {
				...
				if (q.isArray(o[u])) {
					q.each(o[u], function(I, O) {
						t(o[u], I, u);
					});
				} else {
					if (u === "filters" || v === "filters") {
						F = q.sap.getObject("sap.ui.model.Filter");
					} else if (u === "sorter" || v === "sorter") {
						F = q.sap.getObject("sap.ui.model.Sorter");
						l(o[u], "group");
					}
					if (F) {
						o[u] = new F(o[u]);
			...
			k = i.indexOf('}', s);
			if (k < s) {
				throw new SyntaxError("no closing braces found in '" + i
						+ "' after pos:" + s);
			}
			return {
				result : g(i.slice(s + 1, k)),
				at : k + 1
			};
		}
		...
		a.complexParser = function(s, C, u, t, S) {
			...
			function k(I, l, n) {
				var v = E.parse(j.bind(null, e), s, l);
				if (I.charAt(v.at) !== "}") {
					throw new SyntaxError("Expected '}' and instead saw '"
							+ I.charAt(v.at) + "' in expression binding " + I
							+ " at position " + v.at);
				}
				v.at += 1;
				if (v.result) {
					v.result.parts.forEach(function(P) {
						P.mode = n;
					});
				} else {
					F[F.length - 1] = String(v.constant);
					U = true;
				}
				return v;
			}
			...
			while ((m = b.exec(s)) !== null) {
				...
				if (m[1]) {
					...
					F.push(o.parts.length);
					if (s.indexOf(":=", m.index) === m.index + 1) {
						i = k(s, m.index + 3, B.OneTime);
					} else if (s.charAt(m.index + 1) === "=") {
						i = k(s, m.index + 2, B.OneWay);
					} else {
						i = j(e, s, m.index);
					}
					if (i.result) {
						o.parts.push(i.result);
						M = M || "parts" in i.result;
					}
					b.lastIndex = i.at;
				}
				p = b.lastIndex;
			...
			if (o.parts.length > 0) {
				...
				if (e.aFunctionsNotFound) {
					o.functionsNotFound = e.aFunctionsNotFound;
				}
				return o;
			} else if (u && U) {
				return F.join('');
			...
			o.parts.forEach(function(e) {
				...
				if (e && typeof e === "object") {
					if (e.parts) {
						...
						if (e.formatter) {
							k = function() {
								return e.formatter.apply(this,
										Array.prototype.slice.call(arguments,
												s, i));
							};
						} else if (i - s > 1) {
							k = function() {
								return Array.prototype.slice.call(arguments, s,
										i).join(" ");
							};
						} else {
							k = l;
	...
	sap.ui.predefine('sap/ui/base/DataType', [ 'jquery.sap.global' ], function(
			q) {
		"use strict";
		var D = function() {
			throw new Error();
		...
		(function() {
			...
			function b(T, e) {
				...
				for ( var n in e) {
					...
					if (typeof s !== "string") {
						throw new Error("Value " + s + " for enum type " + T
								+ " is not a string");
					}
					if (!V.hasOwnProperty(s) || n == s) {
						V[s] = n;
					}
				}
			...
			D.getType = function(T) {
				...
				if (!o) {
					if (T.indexOf("[]") > 0) {
						var C = T.slice(0, -2), d = this.getType(C);
						o = d && a(d);
						if (o) {
							t[T] = o;
						}
	...
	sap.ui.predefine('sap/ui/base/EventProvider', [ 'jquery.sap.global',
			'./Event', './Object', './ObjectPool' ], function(q, E, B, O) {
		"use strict";
		...
		a.prototype.fireEvent = function(e, p, A, b) {
			...
			var c = this.mEventRegistry[e], P = false, o, d, I;
			if (b || (c && q.isArray(c))) {
				c = c ? c.slice() : [];
	...
	sap.ui
			.predefine(
					...
					function(q, U) {
						"use strict";
						// License granted by Douglas Crockford to SAP, Apache
						// License 2.0
						// (http://www.apache.org/licenses/LICENSE-2.0)
						var u = f.bind(null, undefined), d = {
							"Array" : Array,
							"Boolean" : Boolean,
							"Date" : Date,
							...
							"odata" : {
								"compare" : function() {
									var O;
									q.sap
											.require("sap.ui.model.odata.ODataUtils");
									O = sap.ui
											.require("sap/ui/model/odata/ODataUtils");
								...
								"fillUriTemplate" : function() {
									if (!U.expand) {
										q.sap
												.require("sap.ui.thirdparty.URITemplate");
									}
									return U.expand.apply(U, arguments)
											.toString();
								},
								"uriEncode" : function() {
									var O;
							...
							"IDENTIFIER" : {
								led : k,
								nud : function(T, o) {
									if (!(T.value in o.globals)) {
										q.sap.log
												.warning(
														"Unsupported global identifier '"
																+ T.value
																+ "' in expression parser input '"
																+ o.input + "'",
														undefined,
														"sap.ui.base.ExpressionParser");
									}
									return f.bind(null, o.globals[T.value]);
								}
							},
							"CONSTANT" : {
								led : k,
							...
							"." : {
								lbp : 18,
								led : function(T, o, L) {
									return D.bind(null, L, o
											.advance("IDENTIFIER").value);
								},
								nud : k
							},
							"(" : {
								...
								led : function(T, o, L) {
									...
									o.advance(")");
									return F.bind(null, L, e);
								},
								nud : function(T, o) {
									var v = o.expression(0);
									o.advance(")");
									return v;
								}
							},
							"[" : {
								lbp : 18,
								led : function(T, o, L) {
									var n = o.expression(0);
									o.advance("]");
									return P.bind(null, L, n);
								},
								nud : function(T, o) {
									var e = [], i = true;
									while (o.current().id !== "]") {
							...
							"!" : {
								...
								led : k,
								nud : function(T, o) {
									return g.bind(null, o.expression(this.lbp),
											function(x) {
												return !x;
											});
								}
							...
							"?" : {
								...
								led : function(T, o, L) {
									var e, i;
									i = o.expression(this.lbp - 1);
									o.advance(":");
									e = o.expression(this.lbp - 1);
									return C.bind(null, L, i, e);
								},
								nud : k
							},
							")" : {
							...
							"{" : {
								...
								nud : function(T, o) {
									...
									while (o.current().id !== "}") {
										...
										if (o.current()
												&& o.current().id === "CONSTANT"
												&& typeof o.current().value === "string") {
											K = o.advance().value;
										} else {
											K = o.advance("IDENTIFIER").value;
										}
										o.advance(":");
										v = o.expression(0);
										i[K] = v;
						...
						function h(i, e, o, L) {
							s[i] = {
								lbp : e,
								led : function(T, n, v) {
									var w = L ? this.lbp - 1 : this.lbp;
									return I.bind(null, v, n.expression(w), o,
											L);
								},
								nud : k
							};
						...
						function l(R, i, S) {
							var n = [], t = [], T = q.sap._createJSTokenizer();
							function o() {
								var v, w, x, y, z;
								T.white();
								v = T.getCh();
							...
							function v(E) {
								...
								if (E) {
									if (!T) {
										...
										j("Expected " + E + " but instead saw "
												+ i.slice(T.start, T.end), i,
												T.start + 1);
									}
								}
								n += 1;
						...
						return {
							parse : function(R, i, S, G) {
								...
								if (!T.parts.length) {
									return {
										constant : o.formatter(),
										at : o.at || T.at
									};
								}
								function e() {
									return o.formatter(arguments);
								}
								e.textFragments = true;
								return {
									result : {
										formatter : e,
										parts : T.parts
				...
				var I = function(o, m) {
					...
					function c(o, M) {
						return function() {
							...
							return (t instanceof sap.ui.base.Object) ? t
									.getInterface() : t;
						};
					}
					if (!m) {
	...
	sap.ui
			.predefine(
					...
					[ 'jquery.sap.global', './BindingParser', './DataType',
							'./EventProvider', './ManagedObjectMetadata',
							'../model/BindingMode',
							'../model/CompositeBinding', '../model/Context',
							'../model/FormatException', '../model/ListBinding',
							'../model/Model', '../model/ParseException',
							'../model/TreeBinding', '../model/Type',
							'../model/ValidateException', 'jquery.sap.act',
							'jquery.sap.script', 'jquery.sap.strings' ],
					function(q, B, D, E, M, b, C, c, F, L, d, P, T, f, V) {
						"use strict";
						var g = E
								.extend(
										"sap.ui.base.ManagedObject",
										{
											...
											constructor : function(i, s, S) {
												...
												if (!i) {
													...
													var p = g._fnIdPreprocessor;
													i = (p ? p.call(this, i)
															: i);
													var t = D
															.getType("sap.ui.core.ID");
													if (!t.isValid(i)) {
														throw new Error(
																"\""
																		+ i
						...
						g.create = function(v, k) {
							if (!v || v instanceof g || typeof v !== "object"
									|| v instanceof String) {
								return v;
							}
							function a(t) {
							...
							var e = a(v.Type) || a(k && k.type);
							if (typeof e === "function") {
								return new e(v);
							}
							var m = "Don't know how to create a ManagedObject from "
									+ v + " (" + (typeof v) + ")";
							q.sap.log.fatal(m);
							throw new Error(m);
						};
						g._fnIdPreprocessor = null;
						g._fnSettingsPreprocessor = null;
						g.runWithPreprocessors = function(a, p) {
							var o = {
						...
						g.prototype.applySettings = function(s, S) {
							if (!s || q.isEmptyObject(s)) {
								return this;
							}
							var t = this, m = this.getMetadata(), v = m
									.getJSONKeys(), a = g.create, p = g._fnSettingsPreprocessor, k, o, K;
							function e(O) {
							...
							if (s.models) {
								if (typeof s.models !== "object") {
									throw new Error(
											"models must be a simple object");
								}
								if (s.models instanceof d) {
									this.setModel(s.models);
								} else {
									for (k in s.models) {
										this.setModel(s.models[k],
							...
							if (s.bindingContexts) {
								if (typeof s.bindingContexts !== "object") {
									throw new Error(
											"bindingContexts must be a simple object");
								}
								if (s.bindingContexts instanceof c) {
							...
							if (s.objectBindings) {
								if (typeof s.objectBindings !== "string"
										&& typeof s.objectBindings !== "object") {
									throw new Error(
											"binding must be a string or simple object");
								}
								if (typeof s.objectBindings === "string"
										|| s.objectBindings.path) {
							...
							for (k in s) {
								...
								if ((K = v[k]) !== undefined) {
									...
									switch (K._iKind) {
									case 0:
										j = this.extractBindingInfo(o, S);
										if (j && typeof j === "object") {
											this.bindProperty(k, j);
										} else {
											this[K._sMutator](j || o);
										}
										break;
									case 1:
										j = K.altTypes
												&& this
														.extractBindingInfo(o,
																S);
										if (j && typeof j === "object") {
											this.bindProperty(k, j);
										} else {
											if (q.isArray(o)) {
												if (o.length > 1) {
													q.sap.log
															.error("Tried to add an array of controls to a single aggregation");
												}
												o = o[0];
											}
											this[K._sMutator](a(j || o, K));
										}
										break;
									case 2:
										j = this.extractBindingInfo(o, S);
										if (j && typeof j === "object") {
											this.bindAggregation(k, j);
										} else {
											o = j || o;
											if (o) {
												e(q.isArray(o) ? o : [ o ]);
						...
						g.prototype.setProperty = function(p, v, s) {
						...
						g.prototype.getProperty = function(p) {
							var v = this.mProperties[p], o = this.getMetadata()
									.getProperty(p), t;
							if (!o) {
								throw new Error("Property \"" + p
										+ "\" does not exist in " + this);
							}
							t = D.getType(o.type);
							if (t instanceof D && t.isArrayType()
									&& q.isArray(v)) {
								v = v.slice(0);
							}
						...
						g.prototype.validateProperty = function(p, v) {
							var o = this.getMetadata().getProperty(p), t;
							if (!o) {
								throw new Error("Property \"" + p
										+ "\" does not exist in " + this);
							}
							...
							if (v === null || v === undefined) {
								...
								if (t.getName() == "string") {
									...
									throw new Error("\"" + v + "\" is of type "
											+ typeof v + ", expected "
											+ t.getName() + " for property \""
											+ p + "\" of " + this);
								}
							}
							if (t && t.normalize
									&& typeof t.normalize === "function") {
								v = t.normalize(v);
							}
							return v;
						};
						g.prototype.getOriginInfo = function(p) {
						...
						g.prototype.setAssociation = function(a, i, s) {
							if (i instanceof g) {
								i = i.getId();
						...
						g.prototype.addAssociation = function(a, i, s) {
							if (i instanceof g) {
								i = i.getId();
						...
						g.prototype.removeAssociation = function(a, o, s) {
							var I = this.mAssociations[a];
							var e = null;
							if (!I) {
								return null;
							...
							if (typeof (o) == "number") {
								if (o < 0 || o >= I.length) {
									q.sap.log
											.warning("ManagedObject.removeAssociation called with invalid index: "
													+ a + ", " + o);
								} else {
									e = I[o];
									I.splice(o, 1);
						...
						g.prototype.removeAllAssociation = function(a, s) {
							var i = this.mAssociations[a];
							if (!i) {
								return [];
							}
						...
						g.prototype.validateAggregation = function(a, o, m) {
							var e = this.getMetadata(), A = e
									.getManagedAggregation(a), j, t, i, k;
							if (!A) {
								throw new Error("Aggregation \"" + a
										+ "\" does not exist in " + this);
							}
							if (A.multiple !== m) {
								throw new Error(
										"Aggregation '"
												...
												+ "' of "
												+ this
												+ " used with wrong cardinality (declared as "
												+ (A.multiple ? "0..n" : "0..1")
												+ ")");
							}
							if (!A.multiple && !o) {
							...
							if (o && o.getMetadata
									&& o.getMetadata().isInstanceOf(A.type)) {
								return o;
							}
							j = A.altTypes;
							if (j && j.length) {
							...
							k = "\"" + o + "\" is not valid for aggregation \""
									+ a + "\" of " + this;
						...
						g.prototype.setAggregation = function(a, o, s) {
						...
						g.prototype.getAggregation = function(a, o) {
						...
						g.prototype.indexOfAggregation = function(a, o) {
							var e = this.mAggregations[a];
							if (e) {
						...
						g.prototype.insertAggregation = function(a, o, I, s) {
							if (!o) {
								return this;
							}
							o = this.validateAggregation(a, o, true);
							var e = this.mAggregations[a]
									|| (this.mAggregations[a] = []);
							var i;
							if (I < 0) {
								i = 0;
							} else if (I > e.length) {
							...
							if (i !== I) {
								q.sap.log
										.warning("ManagedObject.insertAggregation: index '"
												+ I
												+ "' out of range [0,"
												+ e.length
												+ "], forced to "
						...
						g.prototype.addAggregation = function(a, o, s) {
							if (!o) {
								return this;
							}
							o = this.validateAggregation(a, o, true);
						...
						g.prototype.removeAggregation = function(a, o, s) {
							var e = this.mAggregations[a], j = null, i;
							if (!e) {
								return null;
							}
							if (s) {
							...
							if (typeof (o) == "number") {
								if (o < 0 || o >= e.length) {
									q.sap.log
											.warning("ManagedObject.removeAggregation called with invalid index: "
													+ a + ", " + o);
								} else {
									j = e[o];
									e.splice(o, 1);
						...
						g.prototype.removeAllAggregation = function(a, s) {
							var e = this.mAggregations[a];
							if (!e) {
								return [];
							}
						...
						g.prototype.destroyAggregation = function(a, s) {
							var e = this.mAggregations[a], i, j;
							if (!e) {
								return this;
							}
							if (s) {
						...
						g.prototype.isInvalidateSuppressed = function() {
							var i = this.iSuppressInvalidate > 0;
							if (this.oParent && this.oParent instanceof g) {
								i = i || this.oParent.isInvalidateSuppressed();
							}
							return i;
						};
						g.prototype._removeChild = function(o, a, s) {
							if (!a) {
								q.sap.log
										.error(
						...
						g.prototype.setParent = function(p, a, s) {
							if (!p) {
								this.oParent = null;
						...
						g.prototype.destroy = function(s) {
							var t = this;
							if (s) {
								this.iSuppressInvalidate++;
							}
							...
							if (this.oParent && this.sParentAggregationName) {
								this.oParent._removeChild(this,
										this.sParentAggregationName, s);
							}
							delete this.oParent;
							...
							q.each(this.mBoundObjects, function(n, o) {
						...
						g.prototype.isBinding = function(v, k) {
							return typeof this.extractBindingInfo(v) === "object";
						};
						g.prototype.extractBindingInfo = function(v, s) {
							if (v && typeof v === "object") {
								if (v.ui5object) {
									delete v.ui5object;
								} else if (v.path != undefined || v.parts) {
									if (v.template) {
										v.template = g.create(v.template);
									}
									return v;
								}
							}
							if (typeof v === "string") {
								return g.bindingParser(v, s, true);
							}
						};
						g.prototype.getBindingInfo = function(n) {
							return this.mBindingInfos[n];
						};
						g.prototype.bindObject = function(p, m) {
							var a = {}, s, S;
							if (typeof p == "object") {
								var o = p;
								p = o.path;
							...
							if (this.mBoundObjects[s]) {
								this.unbindObject(s, true);
							}
							this.mBoundObjects[s] = a;
							if (this.getModel(s)) {
								this._bindObject(s, a);
							}
							return this;
						};
						g.prototype._bindObject = function(m, o) {
							var a, e, i, t = this;
							var j = function(k) {
								if (a.getBoundContext() === t
										.getBindingContext(m)) {
									t.setElementBindingContext(null, m);
								}
								t.setElementBindingContext(a.getBoundContext(),
										m);
							};
							i = this.getModel(m);
							e = this.getBindingContext(m);
							a = i.bindContext(o.sBindingPath, e,
									o.mBindingParameters);
							a.attachChange(j);
							o.binding = a;
							o.fChangeHandler = j;
						...
						g.prototype.bindContext = function(p) {
							return this.bindObject(p);
						};
						g.prototype.unbindContext = function(m) {
							return this.unbindObject(m);
						};
						g.prototype.unbindObject = function(m, _) {
						...
						g.prototype.bindProperty = function(n, o) {
							var p, a, m, e, t, s, A = true, j = this, k = this
									.getMetadata().getPropertyLikeSetting(n);
							if (!k) {
								throw new Error("Property \"" + n
										+ "\" does not exist in " + this);
							}
							if (typeof o == "string") {
								p = arguments[1];
							...
							q.each(o.parts, function(i, l) {
								...
								s = l.path.indexOf(">");
								if (s > 0) {
									l.model = l.path.substr(0, s);
									l.path = l.path.substr(s + 1);
								}
								if (o.formatter && l.mode != b.OneWay
										&& l.mode != b.OneTime) {
									l.mode = b.OneWay;
								}
								if (!j.getModel(l.model)) {
									A = false;
								}
							});
							if (this.isBound(n)) {
						...
						g.prototype._bindProperty = function(n, o) {
							var m, a, e, j, s, k = b.TwoWay, t, l, p = this
									.getMetadata().getPropertyLikeSetting(n), I = p._iKind === 0 ? p.type
									: p.altTypes[0], r = this, u = [], v = function(
									i) {
								r.updateProperty(n);
								var x = e.getDataState();
								if (x) {
									var y = x.getControlMessages();
									if (y && y.length > 0) {
										var z = sap.ui.getCore()
												.getMessageManager();
										x.setControlMessages([]);
										if (y) {
											z.removeMessages(y);
										}
									}
									x.setInvalidValue(null);
								}
								if (e.getBindingMode() === b.OneTime) {
									e.detachChange(v);
									e.detachEvents(o.events);
									e.destroy();
								}
							}, w = function() {
								var i = e.getDataState();
								if (!i) {
									return;
								}
								if (r.refreshDataState) {
									if (!j) {
										this.oDataStateTimer = q.sap
												.delayedCall(0, this,
														function() {
															r.refreshDataState(
																	n, i);
							...
							q.each(o.parts, function(i, x) {
								a = r.getBindingContext(x.model);
								m = r.getModel(x.model);
								t = x.type;
								if (typeof t == "string") {
									l = q.sap.getObject(t);
									t = new l(x.formatOptions, x.constraints);
								}
								e = m.bindProperty(x.path, a, o.parameters);
								e.setType(t, I);
								e.setFormatter(x.formatter);
								s = x.mode || m.getDefaultBindingMode();
								e.setBindingMode(s);
								if (s != b.TwoWay) {
									k = b.OneWay;
								}
							...
							if (u.length > 1
									|| (o.formatter && o.formatter.textFragments)) {
								t = o.type;
								if (typeof t == "string") {
									l = q.sap.getObject(t);
									t = new l(o.formatOptions, o.constraints);
								}
								e = new C(u, o.useRawValues);
								e.setType(t, I);
								e.setBindingMode(o.mode || k);
							} else {
								e = u[0];
							}
							e.attachChange(v);
							if (this.refreshDataState) {
								e.attachDataStateChange(w);
							}
							e.setFormatter(q.proxy(o.formatter, this));
							o.binding = e;
							o.modelChangeHandler = v;
							o.dataStateChangeHandler = w;
							e.attachEvents(o.events);
							e.initialize();
						};
						g.prototype.unbindProperty = function(n, s) {
							var o = this.mBindingInfos[n], p = this
									.getMetadata().getPropertyLikeSetting(n);
							if (o) {
								if (o.binding) {
									o.binding
											.detachChange(o.modelChangeHandler);
									if (this.refreshDataState) {
										o.binding
												.detachDataStateChange(o.dataStateChangeHandler);
									}
									o.binding.detachEvents(o.events);
									o.binding.destroy();
								}
						...
						g.prototype.updateProperty = function(n) {
							var o = this.mBindingInfos[n], a = o.binding, p = this
									.getMetadata().getPropertyLikeSetting(n);
						...
						g.prototype.updateModelProperty = function(n, v, o) {
							if (this.isBound(n)) {
								var a = this.mBindingInfos[n], e = a.binding;
								if (a.skipModelUpdate) {
									return;
								}
								if (e && e.getBindingMode() == b.TwoWay) {
									try {
										a.skipPropertyUpdate = true;
										e.setExternalValue(v);
										a.skipPropertyUpdate = false;
										var i = e.getExternalValue();
										if (v != i) {
						...
						var h = 1;
						g.prototype.bindAggregation = function(n, o) {
							var p, t, s, a, m = this.getMetadata(), A = m
									.getAggregation(n);
							if (!A) {
								throw new Error("Aggregation \"" + n
										+ "\" does not exist in " + this);
							}
							if (!A.multiple) {
								q.sap.log
										.error("Binding of single aggregation \""
												+ n
												+ "\" of "
												+ this
												+ " is not supported!");
							...
							if (!(o.template || o.factory)) {
								if (A._doesNotRequireFactory) {
									o.factory = function() {
										throw new Error(
												"dummy factory called unexpectedly ");
									};
								} else {
									throw new Error(
											"Missing template or factory function for aggregation "
													+ n + " of " + this + " !");
								}
							}
							if (o.template) {
								if (o.template._sapui_candidateForDestroy) {
									q.sap.log
											.warning("A template was reused in a binding, but was already marked as candidate for destroy. You better should declare such a usage with templateShareable:true in the binding configuration.");
									delete o.template._sapui_candidateForDestroy;
								}
								if (o.templateShareable === undefined) {
									o.templateShareable = h;
								}
						...
						g.prototype._bindAggregation = function(n, o) {
							var t = this, a, m = function(j) {
								var u = "update" + n.substr(0, 1).toUpperCase()
										+ n.substr(1);
								if (t[u]) {
									var s = j && j.getParameter("reason");
									if (s) {
										t[u](s);
									} else {
										t[u]();
								...
								var r = "refresh"
										...
										+ n.substr(1);
								if (t[r]) {
									t[r](j.getParameter("reason"));
								} else {
									m(j);
								}
							};
							var i = this.getModel(o.model);
							if (this.isTreeBinding(n)) {
								a = i.bindTree(o.path, this
										.getBindingContext(o.model), o.filters,
										o.parameters, o.sorter);
							} else {
								a = i.bindList(o.path, this
										.getBindingContext(o.model), o.sorter,
										o.filters, o.parameters);
							}
							...
							o.modelRefreshHandler = e;
							a.attachChange(m);
							a.attachRefresh(e);
							a.attachEvents(o.events);
							a.initialize();
						};
						g.prototype.unbindAggregation = function(n, s) {
							var o = this.mBindingInfos[n], a = this
									.getMetadata().getAggregation(n);
							if (o) {
								if (o.binding) {
									o.binding
											.detachChange(o.modelChangeHandler);
									o.binding
											.detachRefresh(o.modelRefreshHandler);
									o.binding.detachEvents(o.events);
									o.binding.destroy();
								}
								if (o.template) {
									if (!o.templateShareable
											&& o.template.destroy) {
										o.template.destroy();
									}
									if (o.templateShareable === h) {
										o.template._sapui_candidateForDestroy = true;
									}
								}
								delete this.mBindingInfos[n];
								if (!s) {
						...
						g.prototype.updateAggregation = function(n) {
							var o = this.mBindingInfos[n], a = o.binding, e = o.factory, A = this
									.getMetadata().getAggregation(n), G, j, k, s = A._sMutator
									+ "Group", t = this;
							function u(p, k, r, v) {
								var w = p[A._sGetter]() || [], x, y;
								if (w.length > k.length) {
									for (var i = k.length; i < w.length; i++) {
										p[A._sRemoveMutator](w[i]);
										w[i].destroy();
									}
								}
								for (var i = 0; i < k.length; i++) {
							...
							function m(i, p) {
								u(i, p, null, function(r, v) {
									m(v, a.getNodeContexts(r));
								});
							}
							if (!o.template) {
								this[A._sDestructor]();
							...
							if (a instanceof L) {
								...
								a.bWasGrouped = j;
								k = a.getContexts(o.startIndex, o.length);
								u(this, k, j ? l : null);
							} else if (a instanceof T) {
								m(this, a.getRootContexts());
							}
						};
						g.prototype.refreshAggregation = function(n) {
							var o = this.mBindingInfos[n], a = o.binding;
							a.getContexts(o.startIndex, o.length);
						};
						g.prototype.propagateMessages = function(n, m) {
							q.sap.log.warning("Message for " + this
									+ ", Property " + n);
						};
						g.prototype.isTreeBinding = function(n) {
							return false;
						};
						g.prototype.updateBindings = function(u, m) {
							var t = this;
							function a(o) {
								var p = o.parts, i;
								if (p && p.length > 1) {
									...
									return (u || o.model == m)
											&& !o.binding.updateRequired(t
													.getModel(o.model));
								} else {
									return (u || p[0].model == m)
											&& !o.binding.updateRequired(t
													.getModel(p[0].model));
								}
								return false;
						...
						g.prototype.isBound = function(n) {
							return (n in this.mBindingInfos);
						};
						g.prototype.getObjectBinding = function(m) {
							return this.mBoundObjects[m]
									&& this.mBoundObjects[m].binding;
						};
						g.prototype.getEventingParent = function() {
							return this.oParent;
						};
						g.prototype.getBinding = function(n) {
							return this.mBindingInfos[n]
									&& this.mBindingInfos[n].binding;
						};
						g.prototype.getBindingPath = function(n) {
							var i = this.mBindingInfos[n];
							return i
									&& (i.path || (i.parts && i.parts[0] && i.parts[0].path));
						};
						g.prototype.setBindingContext = function(o, m) {
							var O = this.oBindingContexts[m];
							if (O !== o) {
								this.oBindingContexts[m] = o;
								this.updateBindingContext(false, true, m);
								this.propagateProperties(m);
							}
							return this;
						};
						g.prototype.setElementBindingContext = function(o, m) {
							var O = this.mElementBindingContexts[m];
							if (O !== o) {
								this.mElementBindingContexts[m] = o;
								this.updateBindingContext(true, true, m);
								this.propagateProperties(m);
							}
							return this;
						};
						g.prototype.updateBindingContext = function(s, S, a, u) {
							var m, o = {}, e, j, k, t = this;
							if (u) {
								for (e in this.oModels) {
									if (this.oModels.hasOwnProperty(e)) {
										o[e] = e;
									}
								}
								for (e in this.oPropagatedProperties.oModels) {
									if (this.oPropagatedProperties.oModels
											.hasOwnProperty(e)) {
										o[e] = e;
									}
								}
							...
							for (e in o) {
								if (o.hasOwnProperty(e)) {
									...
									m = this.getModel(e);
									k = this.mBoundObjects[e];
									if (m && k && k.sBindingPath && !s) {
										if (!k.binding) {
											this._bindObject(e, k);
										} else {
											j = this._getBindingContext(e);
											if (j !== k.binding.getContext()) {
												k.binding.setContext(j);
											}
										}
										continue;
									}
													...
													function(n, l) {
														...
														if (r && r.length > 1) {
															...
															if (l.model == e) {
																p
																		.setContext(t
																				.getBindingContext(l.model));
															}
														} else {
															if (r[0].model == e) {
																p
																		.setContext(t
																				.getBindingContext(r[0].model));
															}
														}
													});
									if (!S) {
										var j = this.getBindingContext(e);
										for ( var n in this.mAggregations) {
											var A = this.mAggregations[n];
											if (A instanceof g) {
												A.oPropagatedProperties.oBindingContexts[e] = j;
												A.updateBindingContext(false,
														false, e);
											} else if (A instanceof Array) {
												for (var i = 0; i < A.length; i++) {
													A[i].oPropagatedProperties.oBindingContexts[e] = j;
													A[i].updateBindingContext(
															false, false, e);
												}
											}
										}
						...
						g.prototype.propagateProperties = function(n) {
							var p = this._getPropertiesToPropagate(), u = n === true, N = u ? undefined
									: n, a, A, i;
							for (a in this.mAggregations) {
								...
								if (A instanceof g) {
									this._propagateProperties(n, A, p, u, N);
								} else if (A instanceof Array) {
									for (i = 0; i < A.length; i++) {
										if (A[i] instanceof g) {
											this._propagateProperties(n, A[i],
													p, u, N);
										}
									}
								}
						...
						g.prototype._propagateProperties = function(n, o, p, u,
								N) {
							if (!p) {
						...
						g.prototype._getPropertiesToPropagate = function() {
							var n = q.isEmptyObject(this.oModels), N = q
									.isEmptyObject(this.oBindingContexts), a = q
									.isEmptyObject(this.mElementBindingContexts);
							function m(e, o, i, j) {
								return e ? o : q.extend({}, o, i, j);
							}
							if (N && n && a) {
								...
								return {
									oModels : m(n,
											this.oPropagatedProperties.oModels,
											this.oModels),
									oBindingContexts : m(
											(N && a),
											this.oPropagatedProperties.oBindingContexts,
											this.oBindingContexts,
											this.mElementBindingContexts)
								};
							}
						};
						g.prototype.getModel = function(n) {
							return this.oModels[n]
									|| this.oPropagatedProperties.oModels[n];
						};
						g.prototype.hasModel = function() {
							return !(q.isEmptyObject(this.oModels) && q
									.isEmptyObject(this.oPropagatedProperties.oModels));
						};
						g.prototype.clone = function(I, l, o) {
							var a = true, e = true;
							if (o) {
								a = !!o.cloneChildren;
								e = !!o.cloneBindings;
							...
							if (!l && a) {
								l = q.map(this.findAggregatedObjects(true),
										function(O) {
											return O.getId();
										});
							}
							var m = this.getMetadata(), j = m._oClass, s = this
									.getId()
									+ "-" + I, S = {}, p = this.mProperties, k, n, r, t = g.bindingParser.escape;
							for (k in p) {
							...
							if (a) {
								...
								for (n in this.mAssociations) {
									var u = this.mAssociations[n];
									if (q.isArray(u)) {
										u = u.slice(0);
										for (var i = 0; i < u.length; i++) {
											if (q.inArray(u[i], l) >= 0) {
												u[i] += "-" + I;
											}
										}
									} else if (q.inArray(u, l) >= 0) {
										u += "-" + I;
									}
									S[n] = u;
								}
							...
							r = new j(s, S);
							for (n in this.mBoundObjects) {
								r.mBoundObjects[n] = q.extend({},
										this.mBoundObjects[n]);
							}
							for (n in this.mEventRegistry) {
								r.mEventRegistry[n] = this.mEventRegistry[n]
										.slice();
							}
							if (e) {
								for (n in this.mBindingInfos) {
									var v = this.mBindingInfos[n];
									var w = q.extend({}, v);
									if (!v.templateShareable && v.template
											&& v.template.clone) {
										w.template = v.template.clone(I, l);
										delete w.factory;
									} else if (v.templateShareable === h) {
										v.templateShareable = w.templateShareable = true;
										q.sap.log
												.error("A shared template must be marked with templateShareable:true in the binding info");
									}
									delete w.binding;
									if (v.factory || v.template) {
										r.bindAggregation(n, w);
									} else {
										r.bindProperty(n, w);
									}
								}
						...
						g._handleLocalizationChange = function(p) {
							var i;
							if (p === 1) {
						...
						g.prototype.findAggregatedObjects = function(r, e) {
							var A = [];
	...
	sap.ui
			.predefine(
					...
					[ 'jquery.sap.global', './DataType', './Metadata' ],
					function(q, D, M) {
						"use strict";
						var b = function(C, o) {
						...
						function e(f, n) {
							return function() {
								q.sap.log
										.warning("Usage of deprecated feature: "
												+ n);
						...
						function P(C, n, i) {
							...
							this.defaultValue = i.defaultValue !== null ? i.defaultValue
									: null;
						...
						P.prototype.getType = function() {
							return this._oType
									|| (this._oType = D.getType(this.type));
						};
						...
						function A(C, n, i) {
							...
							this.multiple = typeof i.multiple === 'boolean' ? i.multiple
									: true;
							this.singularName = this.multiple ? i.singularName
									|| g(n) : undefined;
							this.bindable = !!i.bindable;
							this.deprecated = i.deprecated || false;
							...
							this._iKind = this.multiple ? K.MULTIPLE_AGGREGATION
									: K.SINGLE_AGGREGATION;
							var N = c(n);
							this._sGetter = 'get' + N;
							if (this.multiple) {
						...
						function l(C, n, i) {
							...
							this._iKind = this.multiple ? K.MULTIPLE_ASSOCIATION
									: K.SINGLE_ASSOCIATION;
							var N = c(n);
							this._sGetter = 'get' + N;
							if (this.multiple) {
								var a = c(this.singularName);
						...
						E.prototype.generate = function(a) {
							var t = this, n = t.name, i = t.allowPreventDefault, m = t.enableEventBubbling;
						...
						b.prototype.applySettings = function(C) {
							...
							this._mSpecialSettings = n(s.specialSettings,
									this.metaFactorySpecialSetting);
							this._mProperties = n(s.properties,
									this.metaFactoryProperty);
							var i = n(s.aggregations,
									this.metaFactoryAggregation);
							this._mAggregations = f(i, true);
							this._mPrivateAggregations = f(i, false);
							this._sDefaultAggregation = s.defaultAggregation
									|| null;
							this._mAssociations = n(s.associations,
									this.metaFactoryAssociation);
						...
						b.prototype.afterApplySettings = function() {
							...
							if (p && p instanceof b) {
								this._mAllEvents = q.extend({}, p._mAllEvents,
										this._mEvents);
								this._mAllProperties = q.extend({},
										p._mAllProperties, this._mProperties);
								this._mAllPrivateAggregations = q.extend({},
										p._mAllPrivateAggregations,
										this._mPrivateAggregations);
								this._mAllAggregations = q.extend({},
										p._mAllAggregations,
										this._mAggregations);
								this._mAllAssociations = q.extend({},
										p._mAllAssociations,
										this._mAssociations);
								this._sDefaultAggregation = this._sDefaultAggregation
										|| p._sDefaultAggregation;
								this._mAllSpecialSettings = q.extend({},
										p._mAllSpecialSettings,
										this._mSpecialSettings);
							} else {
						...
						b.prototype.getManagedAggregation = function(a) {
							...
							var o = a ? this._mAllAggregations[a]
									|| this._mAllPrivateAggregations[a]
									: undefined;
						...
						b.prototype.getPropertyLikeSetting = function(n) {
							...
							return (typeof p === 'object' && p.altTypes && p.altTypes.length > 0) ? p
									: undefined;
						};
						...
						b.prototype.getPropertyDefaults = function() {
							var d = this._mDefaults, t;
							if (d) {
								return d;
							}
							if (this.getParent() instanceof b) {
								d = q.sap.newObject(this.getParent()
										.getPropertyDefaults());
							} else {
								d = {};
							}
						...
						b.prototype.createPropertyBag = function() {
							if (!this._fnPropertyBagFactory) {
								this._fnPropertyBagFactory = q.sap.factory(this
										.getPropertyDefaults());
							}
						...
						b.prototype._enrichChildInfos = function() {
							q.sap.log
									.error("obsolete call to ManagedObjectMetadata._enrichChildInfos. This private method will be deleted soon");
						};
						...
						b.prototype.generateAccessors = function() {
							var p = this.getClass().prototype, a = this
									.getName()
									+ ".", m = this._aPublicMethods, n;
							function d(f, i, o) {
								if (!p[f]) {
									p[f] = (o && o.deprecated) ? e(i, a
											+ o.name) : i;
								}
								m.push(f);
							}
						...
						var u = {};
						function w(i) {
							i = sap.ui.getCore().getConfiguration()
									.getUIDPrefix()
									+ i;
							u[i] = u[i] || 0;
							return (i + u[i]++);
						...
						b.isGeneratedId = function(i) {
							var p = q.sap.escapeRegExp(sap.ui.getCore()
									.getConfiguration().getUIDPrefix());
	...
	sap.ui
			.predefine(
					...
					[ 'jquery.sap.global', 'jquery.sap.script' ],
					function(q) {
						"use strict";
						var M = function(c, C) {
							...
							if (typeof C.constructor !== "function") {
								throw Error("constructor for class "
										+ c
						...
						M.prototype.applySettings = function(c) {
							var t = this, s = c.metadata, p;
							if (s.baseType) {
								var P = q.sap.getObject(s.baseType);
								if (typeof P !== "function") {
									q.sap.log.fatal("base class '" + s.baseType
											+ "' does not exist");
								}
								if (P.getMetadata) {
							...
							this._sStereotype = s.stereotype
									|| (this._oParent ? this._oParent._sStereotype
											: "object");
						...
						M.prototype.afterApplySettings = function() {
							if (this._oParent) {
								this._aAllPublicMethods = this._oParent._aAllPublicMethods
										.concat(this._aPublicMethods);
								this._bInterfacesUnique = false;
							} else {
						...
						M.prototype.addPublicMethods = function(m) {
							...
							Array.prototype.push.apply(this._aAllPublicMethods,
									n);
							this._bInterfacesUnique = false;
						};
						M.createClass = function(b, c, C, F) {
							...
							if (b) {
								if (!f) {
									if (C.metadata.deprecated) {
										f = function() {
											q.sap.log
													.warning("Usage of deprecated class: "
															+ c);
							...
							q.sap.setObject(c, f);
							var m = new F(c, C);
							f.getMetadata = f.prototype.getMetadata = q.sap
									.getter(m);
	...
	sap.ui
			.predefine(
					'sap/ui/base/Object',
					[ 'jquery.sap.global', './Interface', './Metadata' ],
					function(q, I, M) {
						"use strict";
						var B = M
								.createClass(
						...
						B.prototype.getInterface = function() {
							var i = new I(this, this.getMetadata()
									.getAllPublicMethods());
						...
						B.defineClass = function(c, s, F) {
							var m = new (F || M)(c, s);
							var C = m.getClass();
							C.getMetadata = C.prototype.getMetadata = q.sap
									.getter(m);
							if (!m.isFinal()) {
							...
							q.sap.log.debug("defined class '"
									+ c
									+ "'"
									+ (m.getParent() ? " as subclass of "
											+ m.getParent().getName() : ""));
							return m;
						};
						return B;
	...
	sap.ui.predefine('sap/ui/base/ObjectPool', [ './Object' ], function(B) {
		...
		O.prototype.borrowObject = function() {
			var o = this.aFreeObjects.length == 0 ? new this.oObjectClass()
	...
	sap.ui
			.predefine(
					...
					function(q, D) {
						...
						B.getHTML = function(s) {
							var S = "sapUiLocalBusyIndicatorSizeMedium";
							if (s == "Big") {
								S = "sapUiLocalBusyIndicatorSizeBig";
							}
							var t = '<div class="sapUiLocalBusyIndicator '
									+ S
									+ '" aria-role="progressbar" aria-valuemin="0" aria-valuemax="100" role="progressbar" alt="" tabindex="0">'
						...
						B.addHTML = function($, b, s) {
							...
							var c = a
									.children(".sapUiLocalBusyIndicatorAnimation");
							var w = c[0].offsetWidth;
							if ($[0].offsetWidth < w) {
								c
										.removeClass("sapUiLocalBusyIndicatorAnimStandard");
								c.addClass("sapUiLocalBusyIndicatorAnimSmall");
							}
							$.attr('aria-busy', true);
							return a;
						};
						B.animateIE9 = {
							start : function(b) {
								if (b && D.browser.msie
									...
									var d = b
											.find(".sapUiLocalBusyIndicatorAnimation > div");
	...
	sap.ui
			.predefine(
					...
					function(q, M, C, a, U) {
						...
						var c = M.extend("sap.ui.core.Component", {
						...
						c.activateCustomizing = function(s) {
						};
						c.deactivateCustomizing = function(s) {
						};
						c.getOwnerIdFor = function(o) {
							var O = (o instanceof M) && o._sOwnerId;
							return O || undefined;
						};
						c.getOwnerComponentFor = function(o) {
							var O = c.getOwnerIdFor(o);
							return O && sap.ui.component(O);
						};
						c.prototype.runAsOwner = function(f) {
							var o = M._sOwnerId;
							try {
								M._sOwnerId = this.getId();
								return f.call();
							} finally {
								M._sOwnerId = o;
							}
						};
						c.prototype.getInterface = function() {
							return this;
						};
						c.prototype._initCompositeSupport = function(s) {
							...
							if (this.onWindowError) {
								this._fnWindowErrorHandler = q.proxy(
										function(e) {
											var E = e.originalEvent;
											this.onWindowError(E.message,
													E.filename, E.lineno);
										}, this);
								q(window).bind("error",
										this._fnWindowErrorHandler);
							}
							if (this.onWindowBeforeUnload) {
								this._fnWindowBeforeUnloadHandler = q.proxy(
										this.onWindowBeforeUnload, this);
								q(window).bind("beforeunload",
										this._fnWindowBeforeUnloadHandler);
							}
							if (this.onWindowUnload) {
								this._fnWindowUnloadHandler = q.proxy(
										this.onWindowUnload, this);
								q(window).bind("unload",
										this._fnWindowUnloadHandler);
							}
						};
						c.prototype.destroy = function() {
							if (typeof this._mManifestModels === 'object') {
								for ( var s in this._mManifestModels) {
									this._mManifestModels[s].destroy();
								}
								this._mManifestModels = null;
							}
							if (this._fnWindowErrorHandler) {
								q(window).unbind("error",
										this._fnWindowErrorHandler);
								delete this._fnWindowErrorHandler;
							}
							if (this._fnWindowBeforeUnloadHandler) {
								q(window).unbind("beforeunload",
										this._fnWindowBeforeUnloadHandler);
								delete this._fnWindowBeforeUnloadHandler;
							}
							if (this._fnWindowUnloadHandler) {
								q(window).unbind("unload",
										this._fnWindowUnloadHandler);
						...
						c.prototype.getComponentData = function() {
							return this.oComponentData;
						};
						c.prototype.getEventBus = function() {
							if (!this._oEventBus) {
						...
						c.prototype.initComponentModels = function() {
							var o = this.getMetadata();
							var A = o.getManifestEntry("sap.app", true);
							var u = o.getManifestEntry("sap.ui5", true);
							var d = {
								models : u["models"],
							...
							var e = o;
							while (e && e instanceof C) {
								var f = e.getManifestEntry("sap.app")["dataSources"];
								m(d.dataSources, d.origin.dataSources, f, e);
								var g = e.getManifestEntry("sap.ui5")["models"];
								m(d.models, d.origin.models, g, e);
								e = e.getParent();
							}
							var h = q.sap.getUriParameters();
							for ( var s in d.models) {
								var j = d.models[s];
								var I = false;
								if (typeof j === 'string') {
									j = {
								...
								if (j.dataSource) {
									...
									if (typeof D === 'object') {
										...
										if (D.type === 'OData' && D.settings
												&& D.settings.annotations) {
											var k = D.settings.annotations;
											for (var i = 0; i < k.length; i++) {
												var l = d.dataSources[k[i]];
												if (!l) {
													q.sap.log
															.error(
																	"Component Manifest: ODataAnnotation \""
																			+ k[i]
																			+ "\" for dataSource \""
																			+ j.dataSource
																			+ "\" could not be found in manifest",
																	"[\"sap.app\"][\"dataSources\"][\""
																			+ k[i]
																			+ "\"]",
																	this);
												...
												if (l.type !== 'ODataAnnotation') {
													q.sap.log
															.error(
																	"Component Manifest: dataSource \""
																			+ k[i]
																			+ "\" was expected to have type \"ODataAnnotation\" but was \""
																			+ l.type
																			+ "\"",
																	"[\"sap.app\"][\"dataSources\"][\""
																			+ k[i]
												...
												if (!l.uri) {
													q.sap.log.error(
															"Component Manifest: Missing \"uri\" for ODataAnnotation \""
																	+ k[i]
																	+ "\"",
															"[\"sap.app\"][\"dataSources\"][\""
																	+ k[i]
												...
												var n = d.origin.dataSources[k[i]]
														._resolveUri(
																new U(l.uri))
														.toString();
								...
								if (!j.type) {
									q.sap.log.error(
											"Component Manifest: Missing \"type\" for model \""
													+ s + "\"",
											"[\"sap.ui5\"][\"models\"][\"" + s
													+ "\"]", this);
									continue;
								...
								try {
									q.sap.require(j.type);
								} catch (E) {
									q.sap.log
											.error(
													"Component Manifest: Class \""
															+ j.type
															+ "\" for model \""
															+ s
															+ "\" could not be loaded. "
								...
								if (j.type === 'sap.ui.model.odata.ODataModel'
										&& (!j.settings || j.settings.json === undefined)) {
									j.settings = j.settings || {};
									j.settings.json = true;
								}
								if (j.uri) {
									var r = new U(j.uri);
									var t = (I) ? d.origin.dataSources[j.dataSource]
											: d.origin.models[s];
									r = t._resolveUri(r);
									if (j.dataSource) {
										b(h, r);
								...
								var v = this.getComponentData();
								var S = v && v.startupParameters
										&& v.startupParameters["sap-system"];
								if (!S) {
									S = h.get("sap-system");
								}
								var w = false;
										...
										&& q
												.inArray(
														...
														[
																...
																"sap.ui.model.odata.v2.ODataModel" ]) != -1) {
									w = true;
									q.sap
											.require("sap.ui.model.odata.ODataUtils");
									O = sap.ui
								...
								if (j.uri) {
									if (w) {
										j.preOriginBaseUri = j.uri.split("?")[0];
										j.uri = O.setOrigin(j.uri, {
											alias : S
										});
									...
									if (j.uriSettingName !== undefined) {
										j.settings = j.settings || {};
										if (!j.settings[j.uriSettingName]) {
											j.settings[j.uriSettingName] = j.uri;
										}
									} else if (j.settings) {
										j.settings = [ j.uri, j.settings ];
									} else {
										j.settings = [ j.uri ];
									}
								} else {
									if (w && j.uriSettingName !== undefined
											&& j.settings
											&& j.settings[j.uriSettingName]) {
										j.preOriginBaseUri = j.settings[j.uriSettingName]
												.split("?")[0];
										j.settings[j.uriSettingName] = O
												.setOrigin(
														j.settings[j.uriSettingName],
														{
															alias : S
														});
										j.postOriginUri = j.settings[j.uriSettingName]
												.split("?")[0];
									}
								}
								if (w && j.settings && j.settings.annotationURI) {
									var x = [].concat(j.settings.annotationURI);
									var y = [];
									...
									j.settings.annotationURI = y;
								}
								if (j.settings && !q.isArray(j.settings)) {
									j.settings = [ j.settings ];
								}
								var z = [ null ].concat(j.settings || []);
								var F = p.bind.apply(p, z);
								var B = new F();
								this._mManifestModels[s] = B;
								this.setModel(B, s || undefined);
							}
						};
						sap.ui.component = function(v) {
							if (!v) {
								throw new Error(
										"sap.ui.component cannot be called without parameter!");
							}
							if (typeof v === 'string') {
								return sap.ui.getCore().getComponent(v);
							}
							function d(o) {
								var n = v.name, i = v.id, f = v.componentData, s = n
										+ '.Component', S = v.settings;
								var I = new o(q.extend({}, S, {
									id : i,
									componentData : f
								}));
								q.sap.log.info("Component instance Id = "
										+ I.getId());
								var h = I.getMetadata().handleValidation() !== undefined
										|| v.handleValidation;
								if (h) {
									if (I.getMetadata().handleValidation() !== undefined) {
										h = I.getMetadata().handleValidation();
									} else {
							...
							var e = sap.ui.component.load(v, true);
							if (v.async) {
								return e.then(d);
							} else {
								return d(e);
						...
						sap.ui.component.load = function(o, f) {
							var n = o.name, u = o.url, d = /^(sync|async)$/
									.test(sap.ui.getCore().getConfiguration()
											.getComponentPreload());
							if (!n) {
								throw new Error(
										"The name of the component is undefined.");
							}
							if (u) {
							...
							function g() {
								var s = n + '.Component';
								q.sap.require(s);
								var e = q.sap.getObject(s);
								if (!e) {
									var i = "The specified component controller '"
							...
							function r(O) {
								if (typeof O === 'object') {
									if (O.url) {
										q.sap.registerModulePath(O.name, O.url);
									}
									return O.name;
								}
								return O;
							...
							function p(s, A) {
								var i = s + '.Component', P;
								if (d && !q.sap.isDeclared(i, true)) {
									if (A) {
										P = q.sap.getResourceName(i,
												'-preload.js');
										return q.sap._loadJSResourceAsync(P,
												true);
									}
									try {
										P = i + '-preload';
										...
										q.sap.log
												.warning("couldn't preload component from "
														+ P
														+ ": "
														+ ((e && e.message) || e));
									}
							...
							if (o.async) {
								var h = o.asyncHints || {}, j = [], k = function(
										P) {
									if (P) {
										j.push(P);
									}
								...
								if (h.preloadBundles) {
									q.each(h.preloadBundles, function(i, B) {
										k(q.sap
												._loadJSResourceAsync(r(B),
														true));
									});
								}
								if (h.libs) {
									k(sap.ui.getCore().loadLibraries(
											h.libs.map(r)));
								}
								k(p(n, true));
								if (h.components) {
									q.each(h.components, function(i, v) {
										k(p(r(v), true));
									});
								}
								return Promise
										...
										.then(
												function(v) {
													q.sap.log
															.debug("Component.load: all promises fulfilled, then "
																	+ v);
													return h.preloadOnly ? true
															: g();
												});
							}
							p(n);
	...
	sap.ui
			.predefine(
					...
					[ 'jquery.sap.global', 'sap/ui/base/ManagedObjectMetadata',
							'sap/ui/thirdparty/URI', 'jquery.sap.resources' ],
					function(q, M, U) {
						"use strict";
						function p(o, c) {
							for ( var k in o) {
						...
						function g(v) {
							...
							return V.getSuffix() ? q.sap.Version(V.getMajor()
									+ "." + V.getMinor() + "." + V.getPatch())
									: V;
						}
						var r = /\{\{([^\}\}]+)\}\}/g;
						var C = function(c, o) {
						...
						C.prototype.applySettings = function(c) {
							var s = c.metadata;
							var n = this.getName(), P = n
									.replace(/\.\w+?$/, "");
							if (s._src) {
								if (s._src == "component.json") {
									q.sap.log
											.warning("Usage of declaration \"metadata: 'component.json'\" is deprecated (component "
													+ n
													+ "). Use \"metadata: 'json'\" instead.");
								} else if (s._src != "json") {
									throw new Error(
											"Invalid metadata declaration for component "
													+ n
													+ ": \""
													+ s._src
													+ "\"! Use \"metadata: 'json'\" to load metadata from component.json.");
								}
								var R = P.replace(/\./g, "/")
										+ "/component.json";
								q.sap.log
										.info("The metadata of the component "
												+ n + " is loaded from file "
												+ R + ".");
								try {
									var o = q.sap.loadResource(R, {
										dataType : "json"
									});
									q.extend(s, o);
								} catch (e) {
									q.sap.log
											.error("Failed to load component metadata from \""
													+ R
													+ "\" (component "
													+ n
													+ ")! Reason: " + e);
							...
							if (m) {
								...
								if (typeof m === "string" && m === "json") {
									var R = P.replace(/\./g, "/")
											+ "/manifest.json";
									q.sap.log
											.info("The manifest of the component "
													+ n
													+ " is loaded from file "
													+ R + ".");
									try {
										...
										q.sap.log
												.error("Failed to load component manifest from \""
														+ R
														+ "\" (component "
														+ n + ")! Reason: " + e);
										m = {};
							...
							m["sap.ui5"] = m["sap.ui5"] || {};
							var i = /^sap\.ui\.core\.(UI)?Component$/.test(n);
							if (!i) {
						...
						C.prototype.init = function() {
							if (!this._bInitialized) {
								...
								var m = this.getManifestEntry("sap.ui5");
								var s = m["dependencies"]
										&& m["dependencies"]["minUI5Version"];
								if (s
										&& q.sap.log
												.isLoggable(q.sap.log.LogLevel.WARNING)
										&& sap.ui.getCore().getConfiguration()
												.getDebug()) {
									try {
										var v = sap.ui.getVersionInfo();
										var o = g(s);
										var V = g(v && v.version);
										if (o.compareTo(V) > 0) {
											q.sap.log
										...
										q.sap.log
												.warning("The validation of the version for Component \""
														+ this
																.getComponentName()
														+ "\" failed! Reasion: "
														+ e);
						...
						C.prototype.onInitComponent = function() {
							var u = this.getManifestEntry("sap.ui5", true), e = u
									&& u["extends"] && u["extends"].extensions;
							if (this._iInstanceCount === 0
									&& !q.isEmptyObject(e)) {
								q.sap
										.require("sap.ui.core.CustomizingConfiguration");
								var a = sap.ui
										.require('sap/ui/core/CustomizingConfiguration');
						...
						C.prototype.onExitComponent = function() {
							this._iInstanceCount = Math.max(
									this._iInstanceCount - 1, 0);
							var u = this.getManifestEntry("sap.ui5", true), e = u
									&& u["extends"] && u["extends"].extensions;
							if (this._iInstanceCount === 0
									&& !q.isEmptyObject(e)) {
								...
								if (a) {
									a
											.deactivateForComponent(this._sComponentName);
								}
							}
						};
						...
						C.prototype.getManifest = function() {
							...
							return q.extend(true, {}, this._getManifest());
						};
						C.prototype._getManifest = function() {
							var P = this._oStaticInfo["processed-manifest"];
							if (!P) {
								var R = this.getRawManifest();
								P = this._oStaticInfo["processed-manifest"] = this
										._processManifestEntries(R);
							}
							return P;
						};
						C.prototype.getRawManifest = function() {
							return q.extend(true, {}, this._getRawManifest());
						};
						C.prototype._getRawManifest = function() {
							return this._oStaticInfo["manifest"];
						};
						C.prototype._processManifestEntries = function(m) {
							if (!this.isAbstract()
									&& this._oStaticInfo.__metadataVersion === 2) {
								var t = this;
								var c = (m["sap.app"] && m["sap.app"]["i18n"])
										|| "i18n/i18n.properties";
								var R;
								p(m, function(o, k, v) {
									o[k] = v.replace(r, function(s, a) {
										if (!R) {
											R = q.sap.resources({
												url : t._resolveUri(new U(c))
														.toString()
											});
										}
										return R.getText(a);
						...
						C.prototype.getManifestEntry = function(k, m) {
							if (!k || k.indexOf(".") <= 0) {
								q.sap.log
										.warning("Manifest entries with keys without namespace prefix can not be read via getManifestEntry. Key: "
												+ k
												+ ", Component: "
												+ this.getName());
								return null;
							}
							var P, o = this.getManifest(), d = o && o[k] || {};
							if (!q.isPlainObject(d)) {
								q.sap.log
										.warning("Custom Manifest entry with key '"
												+ k
							...
							if (m && (P = this.getParent()) instanceof C) {
								return q.extend(true, {}, P.getManifestEntry(k,
										m), d);
							}
						...
						C.prototype.getCustomEntry = function(k, m) {
							if (!k || k.indexOf(".") <= 0) {
								q.sap.log
										.warning("Component Metadata entries with keys without namespace prefix can not be read via getCustomEntry. Key: "
												+ k
												+ ", Component: "
												+ this.getName());
								return null;
							...
							if (!q.isPlainObject(d)) {
								q.sap.log
										.warning("Custom Component Metadata entry with key '"
												+ k
												+ "' must be an object. Component: "
												+ this.getName());
								return null;
							...
							if (m && (P = this.getParent()) instanceof C) {
								return q.extend(true, {}, P
										.getCustomEntry(k, m), d);
							}
							return q.extend(true, {}, d);
						};
						...
						C.prototype.getDependencies = function() {
							if (!this._oLegacyDependencies) {
								var u = this.getManifestEntry("sap.ui5"), d = u
										&& u.dependencies, s = d
										&& d.minUI5Version || null, l = d
										&& d.libs || {}, c = d && d.components
										|| {};
								var L = {
									ui5version : s,
									libs : [],
						...
						C.prototype.getIncludes = function() {
							if (!this._aLegacyIncludes) {
								var I = [], u = this
										.getManifestEntry("sap.ui5"), R = u
										&& u.resources || {}, c = R && R.css
										|| [], j = R && R.js || [];
								for (var i = 0, l = c.length; i < l; i++) {
									if (c[i] && c[i].uri) {
										I.push(c[i].uri);
								...
								this._aLegacyIncludes = (I.length > 0) ? I
										: null;
							}
							return this._aLegacyIncludes;
						};
						C.prototype.getUI5Version = function() {
							var u = this.getManifestEntry("sap.ui5");
							return u && u.dependencies
									&& u.dependencies.minUI5Version;
						};
						...
						C.prototype.getVersion = function() {
							var a = this.getManifestEntry("sap.app");
							return a && a.applicationVersion
									&& a.applicationVersion.version;
						};
						C.prototype.getConfig = function(k, d) {
							var u = this.getManifestEntry("sap.ui5", !d), c = u
									&& u.config;
							return q.extend(true, {}, c && k ? c[k] : c);
						};
						C.prototype.getCustomizing = function(d) {
							var u = this.getManifestEntry("sap.ui5", !d), e = q
									.extend(true, {}, u && u["extends"]
											&& u["extends"].extensions);
							return e;
						};
						...
						C.prototype.handleValidation = function() {
							var u = this.getManifestEntry("sap.ui5");
							return u && u.handleValidation;
						};
						C.prototype.getServices = function() {
							q.sap.log
									.warning("Usage of sap.ui.core.ComponentMetadata.protoype.getServices is deprecated!");
						...
						C.prototype._loadIncludes = function() {
							...
							if (a) {
								for (var j = 0; j < a.length; j++) {
									var b = a[j];
									if (b.uri) {
										var s = this._resolveUri(new U(b.uri))
												.toString();
										q.sap.log.info("Component \""
												+ this.getName()
												+ "\" is loading CSS: \"" + s
												+ "\"");
										q.sap.includeStyleSheet(s, b.id);
									}
								}
							}
						};
						C.prototype._loadDependencies = function() {
							var t = this, d = this.getDependencies();
							if (d) {
								var L = d.libs;
								if (L) {
									for (var i = 0, l = L.length; i < l; i++) {
						...
						C.prototype._convertLegacyMetadata = function(s, b) {
							var c = function(a, w) {
								var o = {};
								if (a) {
									for (var i = 0, l = a.length; i < l; i++) {
						...
						C.prototype._resolveUri = function(u) {
							return C._resolveUriRelativeTo(u, new U(q.sap
									.getModulePath(this.getComponentName())
									+ "/"));
						};
						C._resolveUriRelativeTo = function(u, b) {
							if (u.is("absolute")
									|| (u.path() && u.path()[0] === "/")) {
								return u;
							}
						...
						C.prototype._defineResourceRoots = function() {
							var u = this.getManifestEntry("sap.ui5");
							var R = u["resourceRoots"];
							if (!R) {
								return;
							}
							for ( var s in R) {
								...
								if (o.is("absolute")
									...
									q.sap.log
											.error(
													"Resource root for \""
															+ s
															+ "\" is absolute and therefore won't be registered! \""
															+ a + "\"", this
															.getComponentName());
									continue;
								}
								a = this._resolveUri(o).toString();
								q.sap.registerModulePath(s, a);
							}
						};
						return C;
					}, true);
	sap.ui
			.predefine(
					...
					[ 'jquery.sap.global', '../Device', '../Global',
							'../base/Object', './Locale',
							'sap/ui/thirdparty/URI', 'jquery.sap.script' ],
					function(q, D, G, B, L, U) {
						"use strict";
						var C, a;
						var b = B
								.extend(
										"sap.ui.core.Configuration",
										{
											constructor : function(o) {
												...
												this.oFormatSettings = new b.FormatSettings(
														this);
												var l = this;
												function s(N, V) {
												...
												function _(e) {
													...
													v = q.sap
															.Version(v
																	.toLowerCase() === "edge" ? G.version
																	: v);
													return q.sap.Version(v
															.getMajor(), v
															.getMinor());
												}
												...
												if (!l.ignoreUrlParams) {
													...
													var x = q.sap
															.getUriParameters();
													if (x.mParams['sap-locale']
															|| x.mParams['sap-language']) {
														var V = x
																.get('sap-locale')
																|| M[x
																		.get(
																...
																|| x
																		.get('sap-language');
														if (V === "") {
															l['language'] = j['language'].defaultValue;
														} else {
															s('language', V);
														}
													}
												...
												if (I >= 0) {
													...
													if (y) {
														...
														l.theme = (r.theme && r.theme !== T) ? r.theme
																: "base";
														I = -1;
													}
												}
												l.theme = this._normalizeTheme(
														l.theme, y);
												...
												if (l["bindingSyntax"] === "default") {
													l["bindingSyntax"] = (l
															.getCompatibilityVersion(
																	"sapCoreBindingSyntax")
															.compareTo("1.26") < 0) ? "simple"
															: "complex";
												}
												if (!l["frameOptions"]
														|| (l["frameOptions"] !== 'allow'
																&& l["frameOptions"] !== 'deny' && l["frameOptions"] !== 'trusted')) {
													l["frameOptions"] = 'allow';
												}
												var E = l['preloadLibCss'];
												if (E.length > 0) {
													E.appManaged = E[0].slice(
															0, 1) === "!";
													if (E.appManaged) {
														E[0] = E[0].slice(1);
													}
											...
											getVersion : function() {
												...
												this._version = new q.sap.Version(
														G.version);
												return this._version;
											},
											...
											setLanguage : function(l) {
												g(typeof l === "string" && l,
														"sLanguage must be a BCP47 language tag or Java Locale id or null");
												var o = this.getRTL(), m;
												if (l != this.language) {
													m = this._collect();
											...
											getCalendarType : function() {
												var n;
												if (!C) {
													G.getCore().loadLibrary(
															'sap.ui.core');
													C = sap.ui
															.require("sap/ui/core/library").CalendarType;
												}
												if (!a) {
													q.sap
															.require("sap.ui.core.LocaleData");
													a = sap.ui
															.require("sap/ui/core/LocaleData");
												}
												if (this.calendarType) {
													for (n in C) {
														if (n.toLowerCase() === this.calendarType
																.toLowerCase()) {
															this.calendarType = n;
													...
													q.sap.log
															.warning("Parameter 'calendarType' is set to "
																	+ this.calendarType
																	+ " which isn't a valid value and therefore ignored. The calendar type is determined from format setting and current locale");
												}
												var l = this.oFormatSettings
														.getLegacyDateFormat();
												if (l === "A" || l === "B") {
													return C.Islamic;
												}
											...
											setFormatLocale : function(F) {
												g(
														F === null
																|| typeof F === "string"
																&& F,
														"sFormatLocale must be a BCP47 language tag or Java Locale id or null");
												var m;
											...
											getRTL : function() {
												return this.rtl === null ? this.derivedRTL
														: this.rtl;
											},
											setRTL : function(r) {
												g(
											...
											getComponentPreload : function() {
												return this['xx-componentPreload']
														|| this.preload;
											},
								...
								.extend(
										"sap.ui.core.Configuration.FormatSettings",
										{
											...
											getFormatLocale : function() {
												...
												return new L(
														this.oConfiguration.formatLocale
																|| e(this));
											},
											_set : function(k, v) {
											...
											getNumberSymbol : function(t) {
												return this.mSettings["symbols-latn-"
														+ t];
											},
											setNumberSymbol : function(t, s) {
												g(t == "decimal"
														...
														|| t == "plusSign"
														|| t == "minusSign",
														"sType must be decimal, group, plusSign or minusSign");
												this._set("symbols-latn-" + t,
														s);
												return this;
											},
											setFirstDayOfWeek : function(v) {
												g(typeof v == "number"
														&& v >= 0 && v <= 6,
														"iValue must be an integer value between 0 and 6");
												this._set("weekData-firstDay",
														v);
												return this;
											},
											_setDayPeriods : function(w, t) {
												this._set("dayPeriods-format-"
														+ w, t);
												return this;
											},
											getLegacyDateFormat : function() {
												return this.sLegacyDateFormat
														|| undefined;
											},
											setLegacyDateFormat : function(F) {
												...
												g(
														!F
																|| c
																		.hasOwnProperty(F),
														"sFormatId must be one of ['1','2','3','4','5','6','7','8','9','A','B','C'] or empty");
												if (c[F].ignore) {
													q.sap.log
															.warning("The ABAP date format '"
																	+ F
																	+ "' ("
																	+ c[F].pattern
																	+ ") is not supported yet. Falling back to locale specific date formats.");
													F = "";
												}
												var m = this.oConfiguration
														._collect();
												this.sLegacyDateFormat = m.legacyDateFormat = F;
												this.setDatePattern("short",
														c[F].pattern);
												this.setDatePattern("medium",
														c[F].pattern);
												this.oConfiguration
														._endCollect();
												return this;
											...
											getLegacyNumberFormat : function() {
												return this.sLegacyNumberFormat
														|| undefined;
											},
											setLegacyNumberFormat : function(F) {
												F = F ? F.toUpperCase() : "";
												g(!F || f.hasOwnProperty(F),
														"sFormatId must be one of [' ','X','Y'] or empty");
												var m = this.oConfiguration
														._collect();
												this.sLegacyNumberFormat = m.legacyNumberFormat = F;
												this.setNumberSymbol("group",
														f[F].groupingSeparator);
												this.setNumberSymbol("decimal",
														f[F].decimalSeparator);
												this.oConfiguration
														._endCollect();
												return this;
											},
	...
	sap.ui
			.predefine(
					'sap/ui/core/Control',
					[ 'jquery.sap.global', './CustomStyleClassSupport',
							'./Element', './UIArea', './ResizeHandler',
							'./BusyIndicatorUtils' ],
					function(q, C, E, U, R, B) {
						"use strict";
						var a = E
								.extend(
										"sap.ui.core.Control",
										{
											...
											constructor : function(i, s) {
												...
												if (this._sapUiCoreLocalBusy_initBusyIndicator) {
													this
															._sapUiCoreLocalBusy_initBusyIndicator();
												}
											},
											renderer : null
										});
						a.prototype.clone = function() {
							...
							if (this.aBindParameters) {
								for (var i = 0, l = this.aBindParameters.length; i < l; i++) {
									...
									c.attachBrowserEvent(p.sEventType,
											p.fnHandler,
											p.oListener !== this ? p.oListener
													: undefined);
								}
							}
						...
						a.prototype.invalidate = function(o) {
							...
							if (this.bOutput && (u = this.getUIArea())) {
								...
								var p = this.getParent();
								if (p
										&& (this.bOutput || !(this.getVisible && this
												.getVisible() === false))) {
									p.invalidate(this);
								}
							}
						...
						a.prototype.placeAt = function(r, p) {
							...
							if (c.isInitialized()) {
								...
								if (!i) {
									var b = o.getMetadata().getAggregation(
											"content");
									var d = true;
									if (b) {
										if (!b.multiple
												|| b.type != "sap.ui.core.Control") {
											d = false;
										}
									} else {
										if (!o.addContent || !o.insertContent
												|| !o.removeAllContent) {
											d = false;
										}
									}
									if (!d) {
										q.sap.log
												.warning("placeAt cannot be processed because container "
														+ o
														+ " does not have an aggregation 'content'.");
										return this;
									}
								}
								if (typeof p === "number") {
									...
									default:
										q.sap.log
												.warning("Position "
														+ p
														+ " is not supported for function placeAt.");
									}
								}
							} else {
								var t = this;
						...
						a.prototype.destroy = function(s) {
							...
							if (!this.getVisible()) {
								var p = document
										.getElementById(sap.ui.core.RenderManager
												.createInvisiblePlaceholderId(this));
								if (p && p.parentNode) {
						...
						(function() {
							var p = "focusin focusout keydown keypress keyup mousedown touchstart mouseup touchend click", b = {
								onAfterRendering : function() {
									if (this.getBusy()
										...
										this._busyIndicatorDelayedCallId = q.sap
												.delayedCall(
														this
								...
								if (this._busyIndicatorDelayedCallId) {
									q.sap
											.clearDelayedCall(this._busyIndicatorDelayedCallId);
									delete this._busyIndicatorDelayedCallId;
								}
								if (!$ || $.length === 0) {
									q.sap.log
											.warning("BusyIndicator could not be rendered. The outer control instance is not valid anymore.");
									return;
								}
								var t = $.get(0) && $.get(0).tagName;
								if (t && q.inArray(t.toLowerCase(), f) >= 0) {
									q.sap.log
											.warning("BusyIndicator cannot be placed in elements with tag '"
													+ t + "'.");
									return;
								}
								...
								this._$BusyIndicator = B.addHTML($, this
										.getId()
										+ "-busyIndicator");
								...
								if (c) {
									...
									if (this._busyTabIndices) {
										q.each(this._busyTabIndices, function(
												i, o) {
											if (o.tabindex) {
												o.ref.attr('tabindex',
														o.tabindex);
								...
								q.sap.log
										.debug("Local Busy Indicator Event Suppressed: "
												+ e.type);
								e.preventDefault();
								e.stopImmediatePropagation();
							};
							...
							a.prototype.getControlsByFieldGroupId = function(f) {
								return this.findAggregatedObjects(true,
										function(e) {
											if (e instanceof a) {
	...
	sap.ui
			.predefine(
					'sap/ui/core/Core',
					[ 'jquery.sap.global', 'sap/ui/Device', 'sap/ui/Global',
							'sap/ui/base/DataType',
							'sap/ui/base/EventProvider', 'sap/ui/base/Object',
							'./Component', './Configuration', './Control',
							'./Element', './ElementMetadata', './FocusHandler',
							'./RenderManager', './ResizeHandler',
							'./ThemeCheck', './UIArea',
							'./message/MessageManager', 'jquery.sap.act',
							'jquery.sap.dom', 'jquery.sap.events',
							'jquery.sap.mobile', 'jquery.sap.properties',
							'jquery.sap.resources', 'jquery.sap.script' ],
					function(q, D, G, a, E, B, C, c, d, e, g, F, R, h, T, U, M) {
						"use strict";
						var L = {};
						var _;
						var k = B
								.extend(
										"sap.ui.core.Core",
										{
											constructor : function() {
												...
												var t = this, l = q.sap.log, b = "sap.ui.core.Core";
												B.call(this);
												_ = new E();
												...
												l
														.info("Creating Core",
																null, b);
												this.oConfiguration = new c(
														this);
												var f = this.oConfiguration["frameOptionsConfig"]
														|| {};
												f.mode = this.oConfiguration["frameOptions"];
												f.whitelistService = this.oConfiguration["whitelistService"];
												this.oFrameOptions = new q.sap.FrameOptions(
														f);
												...
												if (i != 0) {
													...
													m
															.unshift("sap.ui.core.library");
												}
												if (this.oConfiguration["xx-lesssupport"]
														&& q
																.inArray(
																		"sap.ui.core.plugin.LessSupport",
																		m) == -1) {
													l
															.info("Including LessSupport into declared modules");
													m
															.push("sap.ui.core.plugin.LessSupport");
												}
												...
												this._setupLang($);
												this._setupWeinre();
												sap.ui.getCore = q.sap
														.getter(this
																.getInterface());
												this.oRenderManager = new R();
												var s = q.sap.syncPoint(
														"UI5 Document Ready",
														function(O, K) {
															t.handleLoad();
														});
												var j = s
														.startTask("document.ready");
												var n = s
														.startTask("preload and boot");
												q(function() {
													l
															.trace("document is ready");
													s.finishTask(j);
												});
												var o = q.sap
														.syncPoint(
																"UI5 Core Preloads and Bootstrap Script",
																function(O, K) {
																	l
																			.trace("Core loaded: open="
																					+ O
																					+ ", failures="
																					+ K);
																	t._boot();
												...
												var u = o
														.startTask("create sp2 tasks task");
												if (this.oConfiguration["versionedLibCss"]) {
													var v = o
															.startTask("load version info");
													var w = function(V) {
														if (V) {
															l
																	.trace("Loaded \"sap-ui-version.json\".");
														} else {
															l
																	.error("Could not load \"sap-ui-version.json\".");
														}
														o.finishTask(v);
													};
													var A = p === "async";
														...
														x
																.then(
																		...
																		function(
																				K) {
																			l
																					.error("Unexpected error when loading \"sap-ui-version.json\": "
																							+ K);
																			o
																					.finishTask(v);
																		});
												...
												var J = this.oConfiguration
														.getAppCacheBuster();
												if (J && J.length > 0) {
													q.sap
															.require("sap.ui.core.AppCacheBuster");
											...
											metadata : {
												publicMethods : [
														...
														"attachLibraryChanged",
														"detachLibraryChanged",
														"isStaticAreaRef",
														"createComponent",
														"getRootComponent",
														"getApplication",
						...
						k.prototype._grantFriendAccess = function() {
							var t = this;
							g.prototype.register = function(m) {
								t.registerElementClass(m);
							};
							e.prototype.register = function() {
								t.registerElement(this);
							};
							e.prototype.deregister = function() {
								t.deregisterElement(this);
							};
							e._updateFocusInfo = function(o) {
								if (t.oFocusHandler) {
									t.oFocusHandler.updateControlFocusInfo(o);
								}
							};
							...
							C.prototype.deregister = function() {
								...
								for ( var b in t.mElements) {
									...
									if (o._sapui_candidateForDestroy
											...
											&& !o.getParent()) {
										q.sap.log
												.debug("destroying dangling template "
														+ o
														+ " when destroying the owner component");
										o.destroy();
									}
								}
						...
						k.prototype._setupThemes = function() {
							var l = q.sap.log, b = "sap.ui.core.Core";
							...
							if (o) {
								if (o.themeroots) {
									for ( var t in o.themeroots) {
										...
										if (typeof f === "string") {
											this.setThemeRoot(t, f);
										} else {
											for ( var i in f) {
												if (i.length > 0) {
													this.setThemeRoot(t, [ i ],
															f[i]);
												} else {
													this.setThemeRoot(t, f[i]);
												}
											}
										}
									}
						...
						k.prototype._setupOS = function($) {
							$ = $ || q("html");
							$.attr("data-sap-ui-os", D.os.name
									+ D.os.versionStr);
							var o = null;
							switch (D.os.name) {
							case D.os.OS.IOS:
						...
						k.prototype._setupLang = function($) {
							$ = $ || q("html");
							var u = function() {
						...
						k.prototype._setupWeinre = function() {
							...
							if (this.oConfiguration.getWeinreId()) {
								l.info("Starting WEINRE Remote Web Inspector");
								var w = "<script src=\"";
								w += this.oConfiguration.getWeinreServer();
								w += "/target/target-script-min.js#";
								w += q.sap.encodeURL(this.oConfiguration
										.getWeinreId());
								w += "\"></script>";
								document.write(w);
							}
						...
						k.prototype._polyfillFlexbox = function() {
							var u = new q.sap.Version(this.oConfiguration
									.getCompatibilityVersion("flexBoxPolyfill"));
							if (u.compareTo("1.16") >= 0) {
								q.support.useFlexBoxPolyfill = false;
							} else if (!q.support.flexBoxLayout
									&& !q.support.newFlexBoxLayout
						...
						k.prototype._boot = function() {
							this.lock();
							var b = this.oConfiguration['preloadLibCss'];
							if (b && b.length > 0 && !b.appManaged) {
								this.includeLibraryTheme("sap-ui-merged",
										undefined, "?l=" + b.join(","));
							}
							var t = this;
						...
						k.prototype.applyTheme = function(t, s) {
							t = this.oConfiguration._normalizeTheme(t, s);
							if (s) {
								this.setThemeRoot(t, s);
							}
							if (t && this.sTheme != t) {
								var b = this.sTheme;
								...
								q(document.documentElement).removeClass(
										"sapUiTheme-" + b).addClass(
										"sapUiTheme-" + t);
								if (this.oThemeCheck) {
									this.oThemeCheck.fireThemeChangedEvent(
											false, true);
								}
							}
						};
						k.prototype._updateThemeUrls = function(t) {
							var b = this, s = this.oConfiguration.getRTL() ? "-RTL"
									: "";
							q("link[id^=sap-ui-theme-]")
									.each(
											function() {
												var l = this.id.slice(13), f = this.href
														.slice(this.href
																.lastIndexOf("/") + 1), i = "library", H, p, $ = q(this);
												if ((p = l.indexOf("-[")) > 0) {
													i += l.slice(p + 2, -1);
													l = l.slice(0, p);
												}
												...
												if (H != this.href) {
													this.href = H;
													$
															.removeAttr("sap-ui-ready");
												}
											});
						};
						k.prototype._getThemePath = function(l, t) {
							if (this._mThemeRoots) {
								var p = this._mThemeRoots[t + " " + l]
										|| this._mThemeRoots[t];
								if (p) {
									p = p + l.replace(/\./g, "/") + "/themes/"
											+ t + "/";
						...
						k.prototype.setThemeRoot = function(t, l, s) {
							...
							if (l) {
								for (var i = 0; i < l.length; i++) {
									var b = l[i];
									this._mThemeRoots[t + " " + b] = s;
								}
							} else {
								this._mThemeRoots[t] = s;
							}
							return this;
						};
						k.prototype.init = function() {
							...
							var l = q.sap.log, b = "sap.ui.core.Core.init()";
							this.boot();
							l.info("Initializing", null, b);
							this.oFocusHandler = new F(document.body, this);
							this.oRenderManager
									._setFocusHandler(this.oFocusHandler);
						...
						k.prototype._setupRootComponent = function() {
							var l = q.sap.log, b = "sap.ui.core.Core.init()", o = this.oConfiguration;
							var s = o.getRootComponent();
							if (s) {
								l.info("Loading Root Component: " + s, null, b);
								var f = sap.ui.component({
									name : s
								});
								...
								if (i && f instanceof sap.ui.core.UIComponent) {
									...
									if (j) {
										l.info(
												"Creating ComponentContainer for Root Component: "
														+ s, null, b);
										var m = new sap.ui.core.ComponentContainer(
												{
													component : f,
													propagateModel : true
												});
								...
								if (A) {
									l
											.warning("The configuration 'application' is deprecated. Please use the configuration 'component' instead! Please migrate from sap.ui.app.Application to sap.ui.core.Component.");
									l
											.info("Loading Application: " + A,
													null, b);
									q.sap.require(A);
						...
						k.prototype._setBodyAccessibilityRole = function() {
							var o = this.oConfiguration;
							var $ = q("body");
							if (o.getAccessibility() && o.getAutoAriaBodyRole()
									&& !$.attr("role")) {
						...
						k.prototype._executeInitListeners = function() {
							...
							if (j && j.length > 0) {
								...
								q.each(j, function(i, f) {
									f();
								});
							}
						};
						k.prototype.handleLoad = function() {
							this.bDomReady = true;
							var w = this.isLocked();
							if (!w) {
								this.lock();
						...
						k.prototype.loadLibrary = function(l, u) {
							if (!L[l]) {
								var m = l + ".library", A;
								if (u) {
									q.sap.registerModulePath(l, u);
								}
								if (this.oConfiguration['xx-loadAllMode']
										&& !q.sap.isDeclared(m)) {
									A = m + "-all";
									q.sap.log
											.debug("load all-in-one file " + A);
									q.sap.require(A);
								} else if (this.oConfiguration.preload === 'sync'
										|| this.oConfiguration.preload === 'async') {
									q.sap.preloadModules(m + "-preload", false);
								}
								q.sap.require(m);
								if (!L[l]) {
									q.sap.log.warning("library " + l
											+ " didn't initialize itself");
									this.initLibrary(l);
								}
								if (this.oThemeCheck && this.isInitialized()) {
									this.oThemeCheck
											.fireThemeChangedEvent(true);
								}
							}
							return this.mLibraries[l];
						};
						k.prototype.loadLibraries = function(l, o) {
							o = q.extend({
								async : true
							}, o);
							var t = this, p = this.oConfiguration.preload === 'sync'
									|| this.oConfiguration.preload === 'async', A = o.async;
							function b(s) {
								if (p) {
									q.each(l, function(i, j) {
										q.sap.preloadModules(j
												+ ".library-preload", !!s, s);
									});
								}
							}
							function f() {
								q.each(l, function(i, s) {
									q.sap.require(s + ".library");
								});
								if (t.oThemeCheck && t.isInitialized()) {
									t.oThemeCheck.fireThemeChangedEvent(true);
								}
							}
							if (A && p) {
								return new Promise(function(i, j) {
									var s = q.sap.syncPoint("Load Libraries",
											function(O, n) {
												if (!n) {
													f();
													i();
						...
						k.prototype.initLibrary = function(l) {
							var b = typeof l === "string", o = b ? {
								name : l
							} : l, s = o.name, f = q.sap.log, m = "sap.ui.core.Core.initLibrary()";
							if (b) {
								f
										.warning("[Deprecated] library "
												+ s
												+ " uses old fashioned initLibrary() call (rebuild with newest generator)");
							}
							if (!s || L[s]) {
								return;
							}
									...
									if (v !== undefined) {
										if (q.isArray(j[K])) {
											if (j[K].length === 0) {
												...
												j[K] = q.sap.unique(j[K]
														.concat(v));
											}
										} else if (j[K] === undefined) {
											j[K] = v;
										} else {
											q.sap.log
													.warning("library info setting ignored: "
															+ K + "=" + v);
										}
									}
								}
							...
							q.sap.getObject(s, 0);
							this.mLibraries[s] = o = n(this.mLibraries[s] || {
								name : s,
								dependencies : [],
								types : [],
								interfaces : [],
							...
							function p() {
								...
								var K = P.getKeys(), w = /(.+)\.(type|interface|control|element)$/, x;
							...
							for (var i = 0; i < o.dependencies.length; i++) {
								...
								f
										.debug("resolve Dependencies to " + t,
												null, m);
								if (!L[t]) {
									f
											.warning(
													"Dependency from "
															...
															+ " to "
															+ t
															+ " has not been resolved by library itself",
													null, m);
									this.loadLibrary(t);
								}
							}
							...
							for (var i = 0; i < o.types.length; i++) {
								if (!/^(any|boolean|float|int|string|object|void)$/
										.test(o.types[i])) {
									q.sap.declare(o.types[i]);
								}
							}
							var u = o.controls.concat(o.elements);
							for (var i = 0; i < u.length; i++) {
								sap.ui.lazyRequire(u[i],
										"new extend getMetadata");
							}
							if (!o.noLibraryCSS
									&& q
											.inArray(
													s,
													this.oConfiguration['preloadLibCss']) < 0) {
								var Q;
								if (this.oConfiguration["versionedLibCss"]) {
									Q = "?version=" + o.version;
									if (sap.ui.versioninfo) {
										Q += "&sap-ui-dist-version="
												+ sap.ui.versioninfo.version;
									}
								}
							...
							if (!q.sap.isDeclared(s + ".library")) {
								f.warning("Library Module " + s + ".library"
										+ " not loaded automatically", null, m);
								q.sap.require(s + ".library");
							}
						...
						k.prototype.includeLibraryTheme = function(l, v, Q) {
							if ((l != "sap.ui.legacy")
								...
								if (l && l.indexOf(":") == -1) {
									...
									b = l.substring(l.indexOf(":") + 1) + v;
									l = l.substring(0, l.indexOf(":"));
								}
								var i = this._getThemePath(l, this.sTheme) + b
										+ ".css" + (Q ? Q : "");
								q.sap.log
										.info("Including "
												+ i
												+ " -  sap.ui.core.Core.includeLibraryTheme()");
								q.sap.includeStyleSheet(i, "sap-ui-theme-" + f);
								var P = sap.ui
										.require("sap/ui/core/theming/Parameters");
								if (P) {
									P._addLibraryTheme(f, i);
								}
							}
						};
						...
						k.prototype.getLibraryResourceBundle = function(l, s) {
							l = l || "sap.ui.core";
							s = s || this.getConfiguration().getLanguage();
							var K = l + "/" + s;
							if (!this.mResourceBundles[K]) {
								var u = sap.ui.resource(l,
										'messagebundle.properties');
								this.mResourceBundles[K] = q.sap.resources({
									url : u,
									locale : s
								});
							}
						...
						k.prototype.createUIArea = function(o) {
								...
								if (i == S) {
									...
									if (!o) {
										throw new Error(
												"DOM element with ID '"
														+ i
														+ "' not found in page, but application tries to insert content.");
									}
								}
							}
							...
							var I = o.id;
							if (!this.mUIAreas[I]) {
								this.mUIAreas[I] = new U(this, o);
								q
										.each(
												this.oModels,
												function(n, m) {
													t.mUIAreas[I].oPropagatedProperties.oModels[n] = m;
												});
								this.mUIAreas[I].propagateProperties(true);
							} else {
								this.mUIAreas[I].setRootNode(o);
							}
						...
						k.prototype.addInvalidatedUIArea = function(u) {
							if (!this._sRerenderTimer) {
								r
										.debug("Registering timer for delayed re-rendering");
								this._sRerenderTimer = q.sap.delayedCall(0,
										this, "renderPendingUIUpdates");
							}
						};
						k.MAX_RENDERING_ITERATIONS = 20;
						k.prototype.renderPendingUIUpdates = function() {
							r.debug("Render pending UI updates: start");
							q.sap.measure.start("renderPendingUIUpdates",
									"Render pending UI updates in all UIAreas");
							var u = false, l = k.MAX_RENDERING_ITERATIONS > 0, i = 0;
							this._bRendering = true;
							do {
								if (l) {
									i++;
									if (i > k.MAX_RENDERING_ITERATIONS) {
										this._bRendering = false;
										throw new Error(
												"Rendering has been re-started too many times ("
														+ i
														+ "). Add URL parameter sap-ui-xx-debugRendering=true for a detailed analysis.");
									}
									if (i > 1) {
										r
												.debug("Render pending UI updates: iteration "
														+ i);
									}
								}
								if (this._sRerenderTimer) {
									q.sap
											.clearDelayedCall(this._sRerenderTimer);
						...
						k.prototype.attachUIUpdated = function(f, l) {
							_.attachEvent(k.M_EVENTS.UIUpdated, f, l);
						};
						k.prototype.detachUIUpdated = function(f, l) {
							_.detachEvent(k.M_EVENTS.UIUpdated, f, l);
						};
						k.prototype.fireUIUpdated = function(p) {
							_.fireEvent(k.M_EVENTS.UIUpdated, p);
						};
						k.prototype.attachThemeChanged = function(f, l) {
							_.attachEvent(k.M_EVENTS.ThemeChanged, f, l);
						};
						k.prototype.detachThemeChanged = function(f, l) {
							_.detachEvent(k.M_EVENTS.ThemeChanged, f, l);
						};
						k.prototype.fireThemeChanged = function(p) {
						...
						k.prototype.attachLocalizationChanged = function(f, l) {
							_.attachEvent(k.M_EVENTS.LocalizationChanged, f, l);
						};
						k.prototype.detachLocalizationChanged = function(f, l) {
							_.detachEvent(k.M_EVENTS.LocalizationChanged, f, l);
						};
						k.prototype.fireLocalizationChanged = function(m) {
							var s = k.M_EVENTS.LocalizationChanged, b = q
									.Event(s, {
										changes : m
									}), A = sap.ui.base.ManagedObject._handleLocalizationChange, f = [];
							q.each(m, function(i, v) {
								f.push(i);
							});
							q.sap.log.info("localization settings changed: "
									+ f.join(","), null, "sap.ui.core.Core");
							...
							n.call(this, 2);
							if (m.rtl != undefined) {
								q(document.documentElement).attr("dir",
										m.rtl ? "rtl" : "ltr");
								...
								q.sap.log
										.info("RTL mode " + m.rtl ? "activated"
												: "deactivated");
							}
							q.each(this.mElements, function(i, o) {
								this._handleEvent(b);
							});
							_.fireEvent(s, {
								changes : m
						...
						k.prototype.attachLibraryChanged = function(f, l) {
							_.attachEvent(k.M_EVENTS.LibraryChanged, f, l);
						};
						k.prototype.detachLibraryChanged = function(f, l) {
							_.detachEvent(k.M_EVENTS.LibraryChanged, f, l);
						};
						k.prototype.fireLibraryChanged = function(p) {
							_.fireEvent(k.M_EVENTS.LibraryChanged, p);
						};
						k.prototype.applyChanges = function() {
							this.renderPendingUIUpdates();
						};
						k.prototype.registerElementClass = function(m) {
							var n = m.getName(), l = m.getLibraryName() || "", o = this.mLibraries[l], s = d.prototype
									.isPrototypeOf(m.getClass().prototype) ? 'controls'
									: 'elements';
							if (!o) {
								q.sap.getObject(l, 0);
								o = this.mLibraries[l] = {
							...
							if (q.inArray(n, o[s]) < 0) {
								o[s].push(n);
								q.sap.log.debug("Class " + m.getName()
						...
						k.prototype.registerElement = function(o) {
							var b = this.byId(o.getId());
							if (b && b !== o) {
								if (b._sapui_candidateForDestroy) {
									q.sap.log
											.debug("destroying dangling template "
													+ b
							...
							if (b && b !== o) {
								if (this.oConfiguration.getNoDuplicateIds()) {
									...
									q.sap.log
											.warning("adding element with duplicate id '"
													+ o.getId() + "'");
								}
							}
							this.mElements[o.getId()] = o;
						};
						k.prototype.deregisterElement = function(o) {
							delete this.mElements[o.getId()];
						};
						k.prototype.registerObject = function(o) {
							var i = o.getId(), t = o.getMetadata()
									.getStereotype(), b = this.getObject(t, i);
							if (b && b !== o) {
								q.sap.log.error("adding object \"" + t
										+ "\" with duplicate id '" + i + "'");
								throw new Error("Error: adding object \"" + t
										+ "\" with duplicate id '" + i + "'");
							}
							this.mObjects[t][i] = o;
						};
						...
						k.prototype.getObject = function(t, i) {
							return i == null ? undefined : this.mObjects[t]
									&& this.mObjects[t][i];
						};
						k.prototype.getComponent = function(i) {
							return this.getObject("component", i);
						};
						k.prototype.getTemplate = function(i) {
							q.sap.require("sap.ui.core.tmpl.Template");
						...
						k.prototype.getStaticAreaRef = function() {
							...
							if (!s) {
								...
								var l = this.getConfiguration().getRTL() ? "right"
										: "left";
								s = q("<DIV/>", A).css({
									"height" : "0",
									"width" : "0",
						...
						k.prototype.attachIntervalTimer = function(f, l) {
							if (!this.oTimedTrigger) {
								q.sap.require("sap.ui.core.IntervalTrigger");
								this.oTimedTrigger = new sap.ui.core.IntervalTrigger(
										k._I_INTERVAL);
							}
						...
						k.prototype.detachIntervalTimer = function(f, l) {
							if (this.oTimedTrigger) {
								this.oTimedTrigger.removeListener(f, l);
							}
						};
						k.prototype.attachControlEvent = function(f, l) {
							_.attachEvent(k.M_EVENTS.ControlEvent, f, l);
						};
						k.prototype.detachControlEvent = function(f, l) {
							_.detachEvent(k.M_EVENTS.ControlEvent, f, l);
						};
						k.prototype.fireControlEvent = function(p) {
							_.fireEvent(k.M_EVENTS.ControlEvent, p);
						};
						...
						k.prototype.getApplication = function() {
							return sap.ui.getApplication
									&& sap.ui.getApplication();
						};
						...
						k.prototype.setModel = function(m, n) {
							if (!m && this.oModels[n]) {
								delete this.oModels[n];
								q.each(this.mUIAreas, function(i, u) {
						...
						k.prototype.byFieldGroupId = function(f) {
							...
							for ( var n in this.mElements) {
								...
								if (o instanceof d && o.checkFieldGroupIds(f)) {
									b.push(o);
								}
							}
							return b;
						...
						k.prototype.detachValidationError = function(f, l) {
							_.detachEvent(k.M_EVENTS.ValidationError, f, l);
							return this;
						};
						...
						k.prototype.detachParseError = function(f, l) {
							_.detachEvent(k.M_EVENTS.ParseError, f, l);
							return this;
						};
						...
						k.prototype.detachFormatError = function(f, l) {
							_.detachEvent(k.M_EVENTS.FormatError, f, l);
							return this;
						};
						k.prototype.attachValidationSuccess = function(o, f, l) {
							...
							_
									.attachEvent(k.M_EVENTS.ValidationSuccess,
											o, f, l);
							return this;
						};
						k.prototype.detachValidationSuccess = function(f, l) {
							_.detachEvent(k.M_EVENTS.ValidationSuccess, f, l);
							return this;
						};
						k.prototype.fireParseError = function(A) {
							_.fireEvent(k.M_EVENTS.ParseError, A);
							return this;
						};
						k.prototype.fireValidationError = function(A) {
							_.fireEvent(k.M_EVENTS.ValidationError, A);
							return this;
						};
						k.prototype.fireFormatError = function(A) {
							_.fireEvent(k.M_EVENTS.FormatError, A);
							return this;
						};
						k.prototype.fireValidationSuccess = function(A) {
							_.fireEvent(k.M_EVENTS.ValidationSuccess, A);
							return this;
						};
						...
						var C = function() {
							...
							this.clone = function() {
								...
								if (this.aCustomStyleClasses) {
									c.aCustomStyleClasses = this.aCustomStyleClasses
											.slice();
								}
								return c;
							};
							...
							this.removeStyleClass = function(s, S) {
								if (s && this.aCustomStyleClasses) {
									for (var i = this.aCustomStyleClasses.length - 1; i >= 0; i--) {
										if (this.aCustomStyleClasses[i] == s) {
											this.aCustomStyleClasses.splice(i,
													1);
											var r = this.getDomRef();
											if (r) {
												q(r).removeClass(s);
							...
							this.toggleStyleClass = function(s, a) {
								if (s && typeof s === "string") {
									if (a === true) {
										...
										this.hasStyleClass(s) ? this
												.removeStyleClass(s) : this
												.addStyleClass(s);
									} else {
										q.sap.log
												.warning(this.toString()
														+ "- toggleStyleClass(): bAdd should be a boolean or undefined, but is '"
														+ a + "'");
									}
								}
								return this;
	...
	sap.ui
			.predefine(
					'sap/ui/core/Element',
					[ 'jquery.sap.global', '../base/Object',
							'../base/ManagedObject', './ElementMetadata',
							'jquery.sap.strings' ],
					function(q, B, M, E) {
						"use strict";
						var a = M.extend("sap.ui.core.Element", {
							metadata : {
								stereotype : "element",
								"abstract" : true,
								publicMethods : [ "getId", "getMetadata",
										"getTooltip_AsString",
										"getTooltip_Text", "getModel",
										"setModel", "hasModel", "bindElement",
										"unbindElement", "getElementBinding",
										"prop", "getLayoutData",
										"setLayoutData" ],
								library : "sap.ui.core",
								aggregations : {
						...
						a.prototype._handleEvent = function(e) {
							var h = "on" + e.type;
							this._callEventHandles(this.aBeforeDelegates
									.slice(0), h, e, true);
							this._callEventHandles([ this ], h, e);
							this._callEventHandles(this.aDelegates.slice(0), h,
									e, true);
						};
						...
						a.create = function(d, k) {
							if (!d || d instanceof a || typeof d !== "object"
									|| d instanceof String) {
								return d;
							}
							function g(t) {
							...
							var m = "Don't know how to create an Element from "
									+ d + " (" + (typeof d) + ")";
							q.sap.log.fatal(m);
							throw new Error(m);
						};
						...
						a.prototype.getDomRef = function(s) {
							return q.sap.domById(s ? this.getId() + "-" + s
									: this.getId());
						};
						...
						a.prototype.insertDependent = function(c, i) {
							return this.insertAggregation("dependents", c, i,
									true);
						};
						...
						a.prototype.removeDependent = function(c) {
							return this
									.removeAggregation("dependents", c, true);
						};
						a.prototype.removeAllDependents = function() {
							return this
									.removeAllAggregation("dependents", true);
						};
						...
						a.prototype.getUIArea = function() {
							return this.oParent ? this.oParent.getUIArea()
									: null;
						};
						a.prototype.destroy = function(s) {
						...
						a.prototype.fireEvent = function(e, p) {
							...
							return M.prototype.fireEvent.apply(this, A);
						};
						a.prototype.addDelegate = function(d, c, t, C) {
							...
							(c ? this.aBeforeDelegates : this.aDelegates)
									.push({
										oDelegate : d,
										bClone : !!C,
										vThis : ((t === this) ? true : t)
						...
						(function() {
							...
							var s = function(e, k, v, w) {
								if (v === null) {
									...
									if (b == 1) {
										...
										e.removeAggregation("customData", d,
												true);
										d.destroy();
									}
								} else {
							...
							a.prototype.data = function() {
								...
								if (b == 0) {
									var d = this.getAggregation("customData"), r = {};
									if (d) {
										for (var i = 0; i < d.length; i++) {
									...
									if (c === null) {
										...
										throw new Error(
												"When data() is called with one argument, this argument must be a string, an object or null, but is "
														+ (typeof c)
														+ ":"
														+ c
														+ " (on UI Element with ID '"
														+ this.getId() + "')");
									}
								} else if (b == 2) {
									...
									throw new Error(
											"data() may only be called with 0-3 arguments (on UI Element with ID '"
													+ this.getId() + "')");
								}
							};
						})();
						a.prototype.clone = function(I, l) {
							...
							for (var i = 0; i < this.aBeforeDelegates.length; i++) {
								if (this.aBeforeDelegates[i].bClone) {
									c.aBeforeDelegates
											.push(this.aBeforeDelegates[i]);
								}
							}
							return c;
						};
						a.prototype.findElements = function(r) {
							var c = M.prototype.findAggregatedObjects.call(
									this, r);
							return c;
						};
	...
	sap.ui.predefine('sap/ui/core/ElementMetadata', [ 'jquery.sap.global',
			'sap/ui/base/ManagedObjectMetadata' ], function(q, M) {
		"use strict";
		var E = function(c, C) {
			M.apply(this, arguments);
		};
		...
		E.prototype.applySettings = function(c) {
			...
			var r = c.hasOwnProperty("renderer") ? (c.renderer || "")
					: undefined;
			delete c.renderer;
			M.prototype.applySettings.call(this, c);
			...
			if (typeof s["designTime"] === "boolean") {
				this._bHasDesignTime = s["designTime"];
		...
		E.prototype.getDesignTime = function() {
			if (!this._oDesignTime && this._bHasDesignTime) {
				q.sap.require({
					modName : this.getElementName(),
					type : "designtime"
				});
				this._oDesignTime = q.sap.getObject(this.getElementName()
						+ ".designtime");
			}
		...
		E.prototype.loadDesignTime = function() {
			...
			return new Promise(function(r, R) {
				if (!t._oDesignTime && t._bHasDesignTime) {
					var m = q.sap.getResourceName(t.getElementName(),
							".designtime");
					sap.ui.require([ m ], function(d) {
						t._oDesignTime = d;
						r(d);
					});
				} else {
	...
	sap.ui
			.predefine(
					...
					[ 'jquery.sap.global', '../Device', '../base/Object',
							'jquery.sap.script' ],
					function(q, D, B) {
						"use strict";
						var F = B
								.extend(
										"sap.ui.core.FocusHandler",
										{
											constructor : function(r, c) {
												...
												this.fEventHandler = q.proxy(
														this.onEvent, this);
												this.fDestroyHandler = q.proxy(
														this.destroy, this);
												if (r.addEventListener
														&& !!!D.browser.internet_explorer) {
						...
						F.prototype.updateControlFocusInfo = function(c) {
							if (c
									&& this.oLastFocusedControlInfo
									&& this.oLastFocusedControlInfo.control === c) {
								var C = c.getId();
								this.oLastFocusedControlInfo = this
										.getControlFocusInfo(C);
								q.sap.log.debug("Update focus info of control "
										+ C, null, "sap.ui.core.FocusHandler");
							}
						};
						F.prototype.restoreFocus = function(c) {
							...
							var C = this.oCore.byId(i.id);
							if (C && i.info
									&& C.getMetadata().getName() == i.type
									&& C.getFocusDomRef() != i.focusref
									&& (c || C !== i.control)) {
								q.sap.log.debug("Apply focus info of control "
										+ i.id, null,
										"sap.ui.core.FocusHandler");
								i.control = C;
						...
						F.prototype.onEvent = function(b) {
							var e = q.event.fix(b);
							q.sap.log.debug("Event " + e.type
									+ " reached Focus Handler (target: "
									+ e.target + (e.target ? e.target.id : "")
									+ ")", null, "sap.ui.core.FocusHandler");
							var a = (e.type == "focus" || e.type == "focusin" || e.type == "activate") ? "focus"
									: "blur";
						...
						F.prototype.onfocusEvent = function(c) {
							...
							if (C) {
								this.oLastFocusedControlInfo = this
										.getControlFocusInfo(c);
								q.sap.log.debug("Store focus info of control "
										+ c, null, "sap.ui.core.FocusHandler");
							}
							this.oCurrent = c;
							if (!this.oLast) {
	...
	sap.ui
			.predefine(
					...
					[ 'jquery.sap.global', '../base/ManagedObject' ],
					function(q, M) {
						"use strict";
						var C = {};
						function t(i, I) {
						...
						function r(l, d) {
							...
							if (n) {
								l.__sLabeledControl = n;
							} else {
								delete l.__sLabeledControl;
							}
							var a;
							if (o) {
								a = C[o];
								if (a) {
									a = q.grep(a, function(b) {
										return b != s;
									});
									if (a.length) {
										C[o] = a;
						...
						L.isRequired = function(e) {
							function a(E) {
								return !!(E
										&& E.getMetadata().getProperty(
												"required") && E.getRequired());
							}
							if (a(e)) {
								return true;
							}
							var l = L.getReferencingLabels(e), o;
							for (var i = 0; i < l.length; i++) {
								o = sap.ui.getCore().byId(l[i]);
								if (a(o)) {
									return true;
								}
							}
						...
						L.enrich = function(o) {
							...
							o.setLabelFor = function(i) {
								var a = this.__orig_setLabelFor.apply(this,
										arguments);
								r(this);
								return a;
							};
							...
							o.setRequired = function(i) {
								var a = this.__orig_setRequired.apply(this,
										arguments);
								...
								.extend(
										"sap.ui.core.Locale",
										{
											constructor : function(l) {
												...
												this.sVariant = (r[4] && r[4]
														.slice(1))
														|| null;
												this.sExtension = r[5] || null;
												this.sPrivateUse = r[6] || null;
												if (this.sLanguage) {
													this.sLanguage = this.sLanguage
															.toLowerCase();
												}
												if (this.sScript) {
											...
											getVariantSubtags : function() {
												return this.sVariant ? this.sVariant
														.split('-')
														: [];
											},
											...
											getExtensionSubtags : function() {
												return this.sExtension ? this.sExtension
														.slice(2).split('-')
														: [];
											},
											...
											getPrivateUseSubtags : function() {
												return this.sPrivateUse ? this.sPrivateUse
														.slice(2).split('-')
														: [];
											},
											...
											getSAPLogonLanguage : function() {
												...
												l = M[l] || l;
												if (l === "zh") {
													if (this.sScript === "Hant"
															|| (!this.sScript && this.sRegion === "TW")) {
														l = "zf";
													}
												}
												if (this.sPrivateUse
														&& (m = /-(saptrc|sappsd)(?:-|$)/i
																.exec(this.sPrivateUse))) {
													l = (m[1].toLowerCase() === "saptrc") ? "1Q"
															: "2Q";
												}
												return l.toUpperCase();
											}
	...
	sap.ui
			.predefine(
					...
					[ 'jquery.sap.global', '../base/Interface',
							'../base/Object', 'sap/ui/core/LabelEnablement',
							'jquery.sap.act', 'jquery.sap.encoder',
							'jquery.sap.dom' ],
					function(q, I, B, L) {
						"use strict";
						var c = [ "renderControl", "write", "writeEscaped",
								"translate", "writeAcceleratorKey",
								"writeControlData",
								"writeInvisiblePlaceholderData",
								"writeElementData", "writeAttribute",
								"writeAttributeEscaped", "addClass",
								"writeClasses", "addStyle", "writeStyles",
						...
						R.prototype._setFocusHandler = function(f) {
							this.oFocusHandler = f;
						};
						var t = function(r, C) {
							r._bLocked = true;
							try {
						...
						R.prototype.renderControl = function(C) {
							...
							if (this.aRenderStack
									&& this.aRenderStack.length > 0) {
								q.sap.measure.pause(this.aRenderStack[0]
										+ "---renderControl");
							} else if (C.getParent()
									&& C.getParent().getMetadata().getName() == "sap.ui.core.UIArea") {
								q.sap.measure.pause(C.getParent().getId()
										+ "---rerender");
							}
							this.aRenderStack.unshift(C.getId());
							q.sap.measure
									.start(C.getId() + "---renderControl",
											"Rendering of "
													+ C.getMetadata().getName());
							var b = this.aBuffer.length;
							var o = {};
							if (C.aCustomStyleClasses
									&& C.aCustomStyleClasses.length > 0) {
							...
							if (v) {
								...
								var u = V
										&& V._oParent
										&& V._oParent.getName() == "sap.ui.core.Control";
								r = u ? a : m.getRenderer();
							}
							q.sap.measure
									.resume(C.getId() + "---renderControl");
							t(this, C);
							...
							if (this.aRenderStack
									&& this.aRenderStack.length > 0) {
								q.sap.measure.resume(this.aRenderStack[0]
										+ "---renderControl");
							} else if (C.getParent()
									&& C.getParent().getMetadata().getName() == "sap.ui.core.UIArea") {
								q.sap.measure.resume(C.getParent().getId()
										+ "---rerender");
							}
						};
						...
						(function() {
							var f = function(r, b, s) {
								var i, d = b.length;
								for (i = 0; i < d; i++) {
									b[i]._sapui_bInAfterRenderingPhase = true;
								}
								r._bLocked = true;
								try {
									for (i = 0; i < d; i++) {
										...
										if (C.bOutput
											...
											E.srcControl = C;
											q.sap.measure.start(C.getId()
													+ "---AfterRendering",
													"AfterRendering of "
															+ C.getMetadata()
																	.getName());
											C._handleEvent(E);
											q.sap.measure.end(C.getId()
													+ "---AfterRendering");
										}
									}
								} finally {
									for (i = 0; i < d; i++) {
										delete b[i]._sapui_bInAfterRenderingPhase;
									}
									r._bLocked = false;
								}
								try {
									r.oFocusHandler.restoreFocus(s);
								} catch (e) {
									q.sap.log.warning(
											"Problems while restoring the focus after rendering: "
													+ e, null, r);
								}
								for (i = 0; i < d; i++) {
									var C = b[i], g = C.aBindParameters;
									if (g && g.length > 0) {
										var D = q(C.getDomRef());
										if (D && D[0]) {
							...
							R.prototype.flush = function(T, d, v) {
								if (this.bRendererMode) {
									q.sap.log
											.info(
													"Flush must not be called from control renderers. Call ignored.",
													null, this);
									return;
								}
							...
							R.prototype.render = function(C, T) {
								if (this.bRendererMode) {
									q.sap.log
											.info(
													"Render must not be called from control renderers. Call ignored.",
													null, this);
									return;
								}
								if (this._bLocked) {
									q.sap.log
											.error(
													"Render must not be called within Before or After Rendering Phase. Call ignored.",
													null, this);
									return;
								}
								this.aRenderedControls = [];
								...
								this._fPutIntoDom = function(o, h) {
									if (C && T) {
										...
										if (R.isPreservedContent(b)) {
											b = q.sap
													.byId(sap.ui.core.RenderPrefixes.Dummy
															+ C.getId())[0]
													|| b;
										}
										if (!b) {
											b = q.sap
													.domById(sap.ui.core.RenderPrefixes.Invisible
															+ C.getId());
										}
												...
												if (b) {
													if (R.isInlineTemplate(b)) {
														q(b).html(h);
															...
															._isDomPathingEnabled()) {
														q.sap.replaceDOM(b, h,
																true);
													} else {
														q(b).replaceWith(h);
													}
						...
						R.forceRepaint = function(d) {
							...
							if (D) {
								q.sap.log.debug("forcing a repaint for "
										+ (D.id || String(D)));
						...
						R.createInvisiblePlaceholderId = function(e) {
							return sap.ui.core.RenderPrefixes.Invisible
									+ e.getId();
						};
						(function() {
							var b = "sap-ui-preserve", d = "sap-ui-static", A = "data-sap-ui-preserve", e = "data-sap-ui-area";
							function g() {
								var $ = q.sap.byId(b);
								if ($.length === 0) {
									$ = q("<DIV/>", {
										"aria-hidden" : "true",
										id : b
									}).addClass("sapUiHidden").addClass(
											"sapUiForcedHidden").css("width",
											"0").css("height", "0").css(
											"overflow", "hidden").appendTo(
											document.body);
								}
								return $;
							}
							function m(n) {
								q(
										"<DIV/>",
										{
											id : sap.ui.core.RenderPrefixes.Dummy
													+ n.id
							...
							R.preserveContent = function(r, p, P) {
								...
								q.sap.measure.start(
										r.id + "---preserveContent",
										"preserveContent for " + r.id);
								if (p) {
									h(r);
								} else {
						...
						R.prototype.writeClasses = function(e) {
							...
							var C;
							if (e) {
								C = e.aCustomStyleClasses;
							} else if (e === false) {
								C = [];
							} else {
								C = s.aCustomStyleClasses;
							}
							if (s.aClasses || C) {
						...
						R.prototype.writeInvisiblePlaceholderData = function(e) {
							var p = R.createInvisiblePlaceholderId(e), P = ' '
									+ 'id="' + p + '" '
						...
						R.prototype.writeElementData = function(e) {
							var s = e.getId();
							if (s) {
								this.writeAttribute("id", s).writeAttribute(
										"data-sap-ui", s);
							}
						...
						R.prototype.writeAttributeEscaped = function(n, v) {
							this.writeAttribute(n, q.sap.encodeHTML(String(v)));
							return this;
						};
						R.prototype.writeAccessibilityState = function(e, P) {
							...
							if (arguments.length == 1
									&& !(e instanceof sap.ui.core.Element)) {
								P = e;
								e = null;
							}
							var A = {};
							if (e != null) {
								...
								var d = function(E, s) {
									...
									if (o && o.multiple) {
										var k = e[o._sGetter]();
										if (E == "ariaLabelledBy") {
											var l = sap.ui.core.LabelEnablement
													.getReferencingLabels(e);
											var n = l.length;
											if (n) {
												var F = [];
												for (var i = 0; i < n; i++) {
													if (q.inArray(l[i], k) < 0) {
														F.push(l[i]);
													}
												}
												k = F.concat(k);
								...
								if (sap.ui.core.LabelEnablement.isRequired(e)) {
									A["required"] = "true";
								}
							...
							if (e instanceof sap.ui.core.Element
									&& e.getParent()
									&& e.getParent().enhanceAccessibilityState) {
								e.getParent().enhanceAccessibilityState(e, A);
							}
							for ( var p in A) {
								if (A[p] != null && A[p] !== "") {
									this.writeAttributeEscaped(p === "role" ? p
											: "aria-" + p, A[p]);
								}
							}
							return this;
						...
						R.prototype.writeIcon = function(u, C, A) {
							...
							var i = sap.ui.core.IconPool.isIconURI(u), s = i ? "<span "
									: "<img ", b, p, o, d;
							if (typeof C === "string") {
								C = [ C ];
							}
							if (i) {
								...
								if (!o) {
									q.sap.log
											.error("An unregistered icon: "
													+ u
													+ " is used in sap.ui.core.RenderManager's writeIcon method.");
									return this;
								}
								if (!C) {
									C = [];
							...
							if (i) {
								d = {
									...
									"role" : "presentation",
									"aria-label" : o.text || o.name,
									"title" : o.text || o.name
								};
								this.write("style=\"font-family: "
										+ o.fontFamily + ";\" ");
							} else {
								d = {
									role : "presentation",
							...
							if (typeof A === "object") {
								for (p in A) {
									if (A.hasOwnProperty(p) && A[p] !== null) {
						...
						R.prototype._isDomPathingEnabled = function() {
							if (this._bDomPathing === undefined) {
								this._bDomPathing = this.getConfiguration()
										.getDomPatching();
								if (this._bDomPathing) {
									q.sap.log
											.warning("DOM Patching is enabled: This feature should be used only for the testing purposes!");
								}
							}
	...
	sap.ui
			.predefine(
					...
					[ 'jquery.sap.global', 'sap/ui/base/Object',
							'jquery.sap.act', 'jquery.sap.script' ],
					function(q, B) {
						"use strict";
						var l = q.sap.log.getLogger(
								"sap.ui.core.ResizeHandler",
								q.sap.log.Level.ERROR);
						var c = null;
						var R = B.extend("sap.ui.core.ResizeHandler", {
							constructor : function(C) {
								...
								this.iIdCounter = 0;
								this.fDestroyHandler = q.proxy(this.destroy,
										this);
						...
						function a() {
							if (this.bRegistered) {
								this.bRegistered = false;
								sap.ui.getCore().detachIntervalTimer(
										this.checkSizes, this);
							}
						}
						function i() {
							if (!this.bRegistered
									&& this.aResizeListeners.length > 0) {
								this.bRegistered = true;
								sap.ui.getCore().attachIntervalTimer(
										this.checkSizes, this);
							}
						}
						...
						R.prototype.attachListener = function(r, h) {
							var I = r instanceof sap.ui.core.Control, d = I ? r
									.getDomRef() : r, w = d ? d.offsetWidth : 0, H = d ? d.offsetHeight
									: 0, s = "rs-" + new Date().valueOf() + "-"
									+ this.iIdCounter++, b;
							if (I) {
								b = ("Control " + r.getId());
							} else if (r.id) {
						...
						R.prototype.checkSizes = function() {
							...
							q
									.each(
											...
											function(b, r) {
												if (r) {
													var C = !!r.oControl, D = C ? r.oControl
															.getDomRef()
															: r.oDomRef;
													if (D
															&& q
																	.contains(
																			document.documentElement,
																			D)) {
														var o = r.iWidth, O = r.iHeight, n = D.offsetWidth, N = D.offsetHeight;
														if (o != n || O != N) {
															r.iWidth = n;
															r.iHeight = N;
															var e = q
															...
															e.control = C ? r.oControl
																	: null;
															if (d) {
																l
																		.debug("resize detected for '"
																				+ r.dbg
																				+ "': "
																				+ e.oldSize.width
																				+ "x"
						...
						R.deregisterAllForControl = function(C) {
							...
							var I = [];
							q.each(c.oResizeHandler.aResizeListeners,
									function(b, r) {
										if (r && r.oControl
												&& r.oControl.getId() === C) {
											I.push(r.sId);
	...
	sap.ui
			.predefine(
					...
					[ 'jquery.sap.global', 'sap/ui/Device',
							'sap/ui/base/Object', 'sap/ui/thirdparty/URI',
							'jquery.sap.script' ],
					function(q, D, B, U) {
						"use strict";
						...
						T.checkStyle = function(s, l) {
							...
							try {
								var r = !s
										|| !!((s.sheet && s.sheet.cssRules && s.sheet.cssRules.length > 0)
												|| !!(s.styleSheet
														&& s.styleSheet.cssText && s.styleSheet.cssText.length > 0) || !!(s.innerHTML && s.innerHTML.length > 0));
								var f = S.attr("sap-ui-ready");
								f = !!(f === "true" || f === "false");
								if (l) {
									q.sap.log
											.debug("ThemeCheck: Check styles '"
													+ S.attr("id") + "': " + r
													+ "/" + f + "/" + !!s);
								}
								return r || f;
							...
							if (l) {
								q.sap.log
										.debug("ThemeCheck: Error during check styles '"
												+ S.attr("id")
												+ "': false/false/" + !!s);
							}
							return false;
						...
						function a(t) {
							...
							var p = t._oCore._getThemePath("sap.ui.core", s)
									+ "custom.css";
							var r = true;
							if (!!t._customCSSAdded
									&& t._themeCheckedForCustom === s) {
								l[t._CUSTOMID] = {};
							}
							function e(f) {
								r = r
										&& T.checkStyle("sap-ui-theme-" + f,
												true);
								if (!!r) {
									if (D.browser.msie
											&& D.browser.version <= 9) {
										var S = q.sap.domById("sap-ui-theme-"
												+ f);
										var R = S && S.sheet && S.sheet.rules
												&& S.sheet.rules.length ? S.sheet.rules.length
												: 0;
										if (R === 4095) {
											var n = parseInt(q(S).attr(
													"sap-ui-css-count"), 10);
											if (isNaN(n)) {
												n = 1;
											} else {
									...
									if (t._themeCheckedForCustom != s) {
										if (b(t, f)) {
											q.sap.includeStyleSheet(p,
													t._CUSTOMID);
											t._customCSSAdded = true;
											q.sap.log
													.warning("ThemeCheck delivered custom CSS needs to be loaded, Theme not yet applied");
											t._themeCheckedForCustom = s;
											r = false;
											return false;
										} else {
							...
							if (!r) {
								q.sap.log
										.warning("ThemeCheck: Theme not yet applied.");
							} else {
								t._themeCheckedForCustom = s;
							}
							return r;
						...
						function b(t, l) {
							...
							if (q.sap.domById("sap-ui-theme-" + l)) {
								...
								if (e.sheet && e.sheet.cssRules) {
									R = e.sheet.cssRules;
								} else if (e.styleSheet && e.styleSheet.rules) {
									R = e.styleSheet.rules;
								}
							}
							if (R.length == 0) {
								q.sap.log
										.warning("Custom check: Failed retrieving a CSS rule from stylesheet "
												+ l);
								return false;
							}
							for (var i = 0; (i < r && i < R.length); i++) {
						...
						function d(f) {
							...
							if (!a(this) && !e) {
								this._sThemeCheckId = q.sap.delayedCall(2,
										this, d);
							} else if (!f) {
								c(this);
								T.themeLoaded = true;
								this._oCore.fireThemeChanged({
									theme : this._oCore.getConfiguration()
											.getTheme()
								});
								if (e) {
									q.sap.log
											.warning("ThemeCheck: max. check cycles reached.");
								}
							} else {
								T.themeLoaded = true;
							}
	...
	sap.ui
			.predefine(
					'sap/ui/core/UIArea',
					[ 'jquery.sap.global', 'sap/ui/base/ManagedObject',
							'./Element', './RenderManager', 'jquery.sap.act',
							'jquery.sap.ui', 'jquery.sap.keycodes' ],
					function(q, M, E, R) {
						"use strict";
						var r = q.sap.log
								.getLogger(
										"sap.ui.Rendering",
										((window["sap-ui-config"] && window["sap-ui-config"]["xx-debugRendering"]) || /sap-ui-xx-debug(R|-r)endering=(true|x|X)/
												.test(document.location.search)) ? q.sap.log.Level.DEBUG
												: Math.min(
														q.sap.log.Level.INFO,
														q.sap.log.getLevel())), d = function(
								c) {
							return c;
						}, D = q.noop, f = q.noop;
						if (r.isLoggable()) {
							...
							D = function(t, c) {
								var C = sap.ui.getCore(), m = {}, n, o;
								for (n in c) {
									o = C.byId(n);
									m[n] = {
										type : o ? o.getMetadata().getName()
												: (c[n].obj === t ? "UIArea"
														: "(no such control)"),
								...
								.extend(
										"sap.ui.core.UIArea",
										{
											constructor : function(c, o) {
												...
												if (o != null) {
													this.setRootNode(o);
													this.bNeedsRerendering = this.bNeedsRerendering
															&& !q.sap
																	.domById(o.id
																			+ "-Init");
												}
						...
						U.prototype.rerender = function(a) {
							...
							var b = this.bRenderSelf, C = this.aContentToRemove, I = this.mInvalidatedControls, u = false;
							c();
							q.sap.measure.pause("renderPendingUIUpdates");
							q.sap.measure.start(this.getId() + "---rerender",
									"Rerendering of "
											+ this.getMetadata().getName());
							D(this, I);
							if (b) {
								if (this.oRootNode) {
									r.debug("Full Rendering of UIArea '"
											+ this.getId() + "'");
									R.preserveContent(this.oRootNode, false,
											this.bInitial);
									this.bInitial = false;
									var g = function(p, v) {
										var l = p.length;
										var w;
										for (var i = 0; i < l; i++) {
											w = v ? p[i].getDomRef() : p[i];
											if (w
													&& !R.isPreservedContent(w)
													&& t.oRootNode === w.parentNode) {
												q(w).remove();
											}
										}
										return l;
									...
									var s = this.oCore.oFocusHandler
											.getControlFocusInfo();
									g(C);
									...
									for (var i = 0; i < l; i++) {
										if (h[i] && h[i].getParent() === this) {
											this.oCore.oRenderManager.render(
													h[i], this.oRootNode, true);
										}
									}
									u = true;
									if (F != o && o === document.activeElement) {
										try {
											this.oCore.oFocusHandler
													.restoreFocus(s);
										} catch (e) {
											q.sap.log.warning(
													"Problems while restoring the focus after full UIArea rendering: "
															+ e, null, this);
										}
									}
								} else {
									r.debug("Full Rendering of UIArea '"
											+ this.getId()
											+ "' postponed, no root node");
								}
							} else {
								var j = function(m) {
									return !!(m.getMetadata && m
											.getMetadata()
											.isInstanceOf(
						...
						U.rerenderControl = function(c) {
							...
							if (p) {
								var u = c.getUIArea();
								var a = u ? u.oCore.oRenderManager : sap.ui
										.getCore().createRenderManager();
								r
										.debug("Rerender Control '"
												+ c.getId()
												+ "'"
												+ (u ? ""
														: " (using a temp. RenderManager)"));
								...
								r
										.warning("Couldn't rerender '"
												+ c.getId()
												+ "', as its DOM location couldn't be determined");
							}
						};
						U.prototype._handleEvent = function(e) {
							...
							if (e.type === "contextmenu" && e.shiftKey
								...
								q.sap.log
										.info("Suppressed forwarding the contextmenu event as control event because CTRL+SHIFT+ALT is pressed!");
								return;
							}
							...
							a.push(e.type);
							var g = false;
							while (o && o instanceof E && o.isActive()
								...
								c = c.parentNode;
								o = null;
								if (e.isMarked("fromMouseout")
										&& q.sap.containsOrEquals(c,
												e.relatedTarget)) {
									break;
								}
							...
							if (e.isPropagationStopped()) {
								q.sap.log.debug("'" + e.type
										+ "' propagation has been stopped");
							}
							var n = e.type;
							if (n != "mousemove" && n != "mouseover"
									&& n != "scroll" && n != "mouseout") {
								var h = q(e.target).control(0);
								if (h) {
									q.sap.log.debug("Event fired: '" + e.type
											+ "' on " + h, "",
											"sap.ui.core.UIArea");
								} else {
									q.sap.log.debug("Event fired: '" + e.type
						...
						U.prototype._onattach = function() {
							...
							q(o).attr("data-sap-ui-area", o.id).bind(
									q.sap.ControlEvents.join(" "),
									q.proxy(this._handleEvent, this));
						};
						...
						U.prototype._handleGroupChange = function(e, o) {
							...
							if (e.type === "focusin") {
								if (U._iFieldGroupDelayTimer) {
									q.sap
											.clearDelayedCall(U._iFieldGroupDelayTimer);
									U._iFieldGroupDelayTimer = null;
								}
								U._iFieldGroupDelayTimer = q.sap.delayedCall(0,
										this, this.setFieldGroupControl, [ o ]);
								return true;
								...
								if (U._iFieldGroupTriggerDelay) {
									q.sap
											.clearDelayedCall(U._iFieldGroupTriggerDelay);
								}
								var c = this.getFieldGroupControl(), C = (c ? c
										.getFieldGroupIds() : []);
								if (C.length > 0) {
									c.triggerValidateFieldGroup(C);
								}
								return true;
							}
							return false;
						...
						U.prototype.setFieldGroupControl = function(e) {
							...
							if (e != c) {
								...
								var b = (c ? c.getFieldGroupIds() : []), n = (C ? C
										.getFieldGroupIds()
										: []), t = [];
						...
						U.prototype.getFieldGroupControl = function() {
							if (U._oFieldGroupControl
									&& !U._oFieldGroupControl.bIsDestroyed) {
	...
	sap.ui.predefine('sap/ui/core/message/ControlMessageProcessor', [
			'jquery.sap.global', 'sap/ui/core/message/MessageProcessor' ],
			function(q, M) {
				"use strict";
				...
				C.prototype.setMessages = function(m) {
					this.mOldMessages = this.mMessages === null ? {}
							: this.mMessages;
					this.mMessages = m || {};
					this.checkMessages();
				...
				C.prototype.checkMessages = function() {
					var m, t = this, a = q.extend(this.mMessages, {});
					...
					q.each(a, function(T) {
						var b, p = T.split('/'), c = sap.ui.getCore()
								.byId(p[0]);
						if (!c) {
							return;
						}
					...
					function(q, O, l, M) {
						...
						a.prototype.setType = function(t) {
							if (t in sap.ui.core.MessageType) {
								...
								q.sap.log
										.error("MessageType must be of type sap.ui.core.MessageType");
							}
						};
						a.prototype.getType = function() {
							return this.type;
						...
						a.prototype.setMessageProcessor = function(m) {
							if (m instanceof M) {
								...
								q.sap.log
										.error("MessageProcessor must be an instance of sap.ui.core.message.MessageProcessor");
							}
						};
	...
	sap.ui
			.predefine(
					...
					[ 'jquery.sap.global', 'sap/ui/base/EventProvider',
							'sap/ui/base/ManagedObject',
							'sap/ui/model/message/MessageModel', './Message',
							'./ControlMessageProcessor' ],
					function(q, E, M, c, d, C) {
						"use strict";
						var e = E
								.extend(
										"sap.ui.core.message.MessageManager",
						...
						e.prototype._handleError = function(o, h) {
							...
							if (h) {
								...
								if (this.mMessages[P] && this.mMessages[P][t]) {
									this.removeMessages(this.mMessages[P][t]);
								}
								var r = {};
								r[a.getId()] = {
									properties : {},
									fieldGroupIds : a.getFieldGroupIds ? a
											.getFieldGroupIds() : undefined
								};
						...
						e.prototype._removeMessage = function(m) {
							var a = this.mMessages[m.getMessageProcessor()
									.getId()];
							if (!a) {
								return;
							}
							...
							if (b) {
								for (var i = 0; i < b.length; i++) {
									var o = b[i];
									if (q.sap.equal(o, m) && !o.getPersistent()) {
										b.splice(i, 1);
										--i;
									}
								}
						...
						e.prototype.registerMessageProcessor = function(p) {
							...
							if (!this.mProcessors[P]) {
								...
								p.attachMessageChange(this.onMessageChange,
										this);
						...
						e.prototype.unregisterMessageProcessor = function(p) {
							...
							p.detachMessageChange(this.onMessageChange);
						};
							...
							if (!o instanceof M) {
								q.sap.log
										.error(this
												+ " : "
												+ o.toString()
												+ " is not an instance of sap.ui.base.ManagedObject");
								return;
							}
							o.attachValidationSuccess(h, this._handleSuccess,
									this);
						...
						e.prototype.destroy = function() {
							q.sap.log
									.warning("Deprecated: Do not call destroy on a MessageManager");
						};
	...
	sap.ui.predefine('sap/ui/core/message/MessageProcessor', [
			'jquery.sap.global', 'sap/ui/base/EventProvider' ], function(q, E) {
		"use strict";
		var M = E.extend("sap.ui.core.message.MessageProcessor", {
			constructor : function() {
				...
				this.mMessages = null;
				this.id = q.sap.uid();
				sap.ui.getCore().getMessageManager().registerMessageProcessor(
						this);
			},
			metadata : {
				"abstract" : true,
				publicMethods : [ "getId", "setMessages",
						"attachMessageChange", "detachMessageChange" ]
			}
		});
		M.M_EVENTS = {
		...
		M.prototype.destroy = function() {
			sap.ui.getCore().getMessageManager().unregisterMessageProcessor(
					this);
			E.prototype.destroy.apply(this, arguments);
		};
		return M;
	});
	sap.ui.predefine('sap/ui/model/Binding', [ 'jquery.sap.global',
			'sap/ui/base/EventProvider', './ChangeReason', './DataState' ],
			function(q, E, C, D) {
				"use strict";
				var B = E.extend("sap.ui.model.Binding", {
					...
					metadata : {
						"abstract" : true,
						publicMethods : [ "getPath", "getContext", "getModel",
								"attachChange", "detachChange", "refresh",
								"isInitial", "attachDataStateChange",
								"detachDataStateChange", "attachDataRequested",
								"detachDataRequested", "attachDataReceived",
								"detachDataReceived", "suspend", "resume" ]
					}
				});
				...
				B.prototype.checkDataState = function() {
					if (this.hasListeners("DataStateChange")) {
						var d = this._updateDataState();
						if (d && d.changed()) {
							this._fireDataStateChange({
								dataState : d
							});
							d.changed(false);
						}
				...
				B.prototype._updateDataState = function() {
					var d = this.getDataState();
					if (this.oModel && this.sPath) {
						var r = this.oModel.resolve(this.sPath, this.oContext);
						if (r) {
							d
									.setModelMessages(this.oModel
											.getMessagesByPath(r));
							d.setLaundering(this.oModel.isLaundering(
									this.sPath, this.oContext));
						}
					}
					return d;
				};
				...
				B.prototype.attachEvents = function(e) {
					...
					q.each(e, function(s, h) {
						var m = "attach" + s.substring(0, 1).toUpperCase()
								+ s.substring(1);
						if (t[m]) {
							t[m](h);
						} else {
							q.sap.log.warning(t.toString()
									+ " has no handler for event '" + s + "'");
						}
					});
					return this;
				};
				B.prototype.detachEvents = function(e) {
					...
					var t = this;
					q.each(e, function(s, h) {
						var m = "detach" + s.substring(0, 1).toUpperCase()
								+ s.substring(1);
						if (t[m]) {
							t[m](h);
						} else {
	...
	sap.ui.predefine('sap/ui/model/ClientContextBinding',
			[ './ContextBinding' ], function(C) {
				"use strict";
				...
				a.prototype.refresh = function(f) {
					var t = this;
					this.oModel.createBindingContext(this.sPath, this.oContext,
							this.mParameters, function(c) {
				...
				a.prototype.setContext = function(c) {
					...
					if (this.oContext != c) {
						this.oContext = c;
						this.oModel.createBindingContext(this.sPath,
								this.oContext, this.mParameters, function(c) {
									t.oElementContext = c;
									t._fireChange();
								});
					}
	...
	sap.ui
			.predefine(
					...
					[ 'jquery.sap.global', './ChangeReason', './Filter',
							'./FilterType', './ListBinding',
							'./FilterProcessor', './Sorter',
							'./SorterProcessor' ],
					function(q, C, F, a, L, b, S, c) {
						"use strict";
						...
						d.prototype._getContexts = function(s, l) {
							...
							if (!l) {
								l = Math.min(this.iLength,
										this.oModel.iSizeLimit);
							}
							var e = Math.min(s + l, this.aIndices.length), o, f = [], p = this.oModel
									.resolve(this.sPath, this.oContext);
							if (p && !q.sap.endsWith(p, "/")) {
								p += "/";
							}
							for (var i = s; i < e; i++) {
								o = this.oModel
										.getContext(p + this.aIndices[i]);
								f.push(o);
							}
							return f;
						};
						...
						d.prototype.applySort = function() {
							...
							this.aIndices = c.apply(this.aIndices,
									this.aSorters, function(r, p) {
										return t.oModel.getProperty(p,
												t.oList[r]);
									});
						};
						...
						d.prototype.applyFilter = function() {
							...
							var f = this.aFilters
									.concat(this.aApplicationFilters), t = this;
							this.aIndices = b.apply(this.aIndices, f, function(
									r, p) {
	...
	sap.ui
			.predefine(
					...
					[ 'jquery.sap.global', './ClientContextBinding',
							'./ClientListBinding', './ClientPropertyBinding',
							'./ClientTreeBinding', './Model' ],
					function(q, C, a, b, c, M) {
						"use strict";
						var d = M.extend("sap.ui.model.ClientModel", {
							...
							metadata : {
								publicMethods : [ "loadData", "setData",
										"getData", "setProperty",
										"forceNoCache" ]
							}
						});
						...
						d.prototype.createBindingContext = function(p, o, P, f) {
							...
							var s = this.resolve(p, o), n = (s == undefined) ? undefined
									: this.getContext(s ? s : "/");
							if (!n) {
								n = null;
							}
	...
	sap.ui.predefine('sap/ui/model/ClientPropertyBinding',
			[ './PropertyBinding' ], function(P) {
				"use strict";
	...
	sap.ui
			.predefine(
					...
					[ 'jquery.sap.global', './ChangeReason', './Context',
							'./TreeBinding', 'sap/ui/model/SorterProcessor',
							'sap/ui/model/FilterProcessor' ],
					function(q, C, a, T, S, F) {
						"use strict";
						var b = T.extend("sap.ui.model.ClientTreeBinding", {
							constructor : function(m, p, c, f, P, s) {
								...
								if (this.aFilters) {
									if (this.oModel._getObject(this.sPath,
											this.oContext)) {
										this.filter(f);
									}
								}
						...
						b.prototype.getRootContexts = function(s, l) {
							if (!s) {
								s = 0;
							}
							if (!l) {
							...
							if (!this.oModel.isList(this.sPath)) {
								...
								if (this.bDisplayRootNode) {
									...
									c = this.getNodeContexts(o);
								}
							} else {
								q
										.each(
												this.oModel
														._getObject(this.sPath),
												function(i, O) {
													t
															._saveSubContext(
																	O,
							...
							this._applySorter(c);
							this._setLengthCache(this.sPath, c.length);
							return c.slice(s, s + l);
						};
						b.prototype.getNodeContexts = function(c, s, l) {
							if (!s) {
								s = 0;
							}
							if (!l) {
							...
							if (!q.sap.startsWith(d, "/")) {
								d = "/" + d;
							}
							var e = [], t = this, n = this.oModel._getObject(d), A = this.mParameters
									&& this.mParameters.arrayNames, f;
							if (n) {
								if (A && q.isArray(A)) {
									q.each(A, function(i, g) {
										f = n[g];
										if (f) {
											q.each(f, function(h, o) {
												t._saveSubContext(o, e, d, g
														+ "/" + h);
											});
										}
									});
								} else {
									q.sap.each(n, function(N, o) {
										if (q.isArray(o)) {
											q.each(o, function(g, h) {
												t._saveSubContext(h, e, d, N
														+ "/" + g);
											});
										} else if (typeof o == "object") {
											t._saveSubContext(o, e, d, N);
										}
									});
								}
							}
						...
						b.prototype.hasChildren = function(c) {
							if (c) {
								if (this._mLengthsCache[c.sPath] !== undefined) {
									return this._mLengthsCache[c.sPath] > 0;
								} else {
						...
						b.prototype._saveSubContext = function(n, c, s, N) {
							if (n && typeof n == "object") {
								var o = this.oModel.getContext(s + N);
								if (this.aFilters && !this.bIsFiltering) {
									if (q.inArray(o,
											this.filterInfo.aFilteredContexts) != -1) {
										c.push(o);
									}
								} else {
									c.push(o);
						...
						b.prototype.filter = function(f) {
							...
							if (!f || !q.isArray(f) || f.length == 0) {
								...
								this.aFilters = f;
								var c = new a(this.oModel, this.sPath);
						...
						b.prototype.filterRecursive = function(p) {
							this.bIsFiltering = true;
							var c = this.getNodeContexts(p);
						...
						b.prototype.applyFilter = function(p) {
							if (!this.aFilters) {
								return;
							}
							var t = this, f = [];
							...
							this.bIsFiltering = false;
							f = F.apply(u, this.aFilters, function(c, P) {
								return t.oModel.getProperty(P, c);
							});
							if (f.length > 0) {
						...
						b.prototype._applySorter = function(c) {
							var t = this;
							S.apply(c, this.aSorters, function(o, p) {
								return t.oModel.getProperty(p, o);
							}, function(o) {
								return o.getPath();
							});
						};
						b.prototype._setLengthCache = function(k, l) {
	...
	sap.ui
			.predefine(
					...
					[ 'jquery.sap.global', './BindingMode', './ChangeReason',
							'./PropertyBinding', './CompositeType',
							'./DataState' ],
					function(q, B, C, P, a, D) {
						"use strict";
						var b = P.extend("sap.ui.model.CompositeBinding", {
						...
						b.prototype.setType = function(t, i) {
							if (t && !(t instanceof a)) {
								throw new Error(
										"Only CompositeType can be used as type for composite bindings!");
							}
						...
						b.prototype.setContext = function(c) {
							q.each(this.aBindings, function(i, o) {
								if (!c || o.updateRequired(c.getModel())) {
									o.setContext(c);
								}
							});
						};
						b.prototype.setValue = function(v) {
							var V;
							q.each(this.aBindings, function(i, o) {
								V = v[i];
								if (V !== undefined) {
						...
						b.prototype.setExternalValue = function(v) {
							var V, c;
							if (this.fnFormatter) {
								q.sap.log
										.warning("Tried to use twoway binding, but a formatter function is used");
								return;
							}
							if (this.oType) {
								if (this.oType.getParseWithValues()) {
									...
									if (this.bRawValues) {
										...
										q.each(this.aBindings, function(i, o) {
											c.push(o.getExternalValue());
										});
									}
								}
								V = this.oType.parseValue(v,
										this.sInternalType, c);
							} else {
								if (typeof v == "string") {
									V = v.split(" ");
								} else {
							...
							if (this.bRawValues) {
								...
								q.each(this.aBindings, function(i, o) {
									v = V[i];
									if (v !== undefined) {
										o.setExternalValue(v);
									}
								});
							}
						};
						b.prototype.getExternalValue = function() {
							var v = [];
							if (this.bRawValues) {
								v = this.getValue();
							} else {
								q.each(this.aBindings, function(i, o) {
									v.push(o.getExternalValue());
								});
							}
							return this._toExternalValue(v);
						};
						b.prototype._toExternalValue = function(v) {
							var V;
							if (this.fnFormatter) {
								V = this.fnFormatter.apply(this, v);
							} else if (this.oType) {
								V = this.oType.formatValue(v,
										this.sInternalType);
							} else {
								if (v.length > 1) {
									V = v.join(" ");
						...
						b.prototype.getBindings = function() {
							...
							if (this.aBindings) {
								q
										.each(
												...
												function(i, o) {
													o
															.attachDataStateChange(t.fDataStateChangeHandler);
												});
							}
						};
						b.prototype.detachDataStateChange = function(f, l) {
							...
							if (this.aBindings) {
								q
										.each(
												...
												function(i, o) {
													o
															.detachDataStateChange(t.fDataStateChangeHandler);
												});
							}
						};
						b.prototype.updateRequired = function(m) {
						...
						b.prototype._updateDataState = function() {
							var d = P.prototype._updateDataState.call(this), o = [], m = [], c = [], t = this;
							q.each(this.aBindings, function(i, e) {
								var I = e._updateDataState();
								if (t.bRawValues) {
									o.push(I.getOriginalValue());
								} else {
									o.push(I.getOriginalInternalValue());
								}
								if (I.getModelMessages()) {
									m = m.concat(I.getModelMessages());
								}
								if (I.getControlMessages()) {
									c = c.concat();
								}
							});
							d.setModelMessages(m);
							d.setControlMessages(c);
							d.setOriginalInternalValue(o);
							d.setValue(this._toExternalValue(d
									.getInternalValue()));
							d.setOriginalValue(this._toExternalValue(o));
							return d;
						};
						return b;
					});
	sap.ui.predefine('sap/ui/model/CompositeType', [ './FormatException',
			'./ParseException', './SimpleType', './ValidateException' ],
			function(F, P, S, V) {
				"use strict";
	...
	sap.ui.predefine('sap/ui/model/Context', [ 'sap/ui/base/Object' ],
			function(B) {
				...
				var C = B.extend("sap.ui.model.Context", {
					...
					metadata : {
						"abstract" : true,
						publicMethods : [ "getModel", "getPath", "getProperty",
								"getObject" ]
					}
				});
	...
	sap.ui
			.predefine(
					...
					function(q, B) {
						...
						D.prototype._updateProperty = function(p, v) {
							if (this._bChanged === false) {
								this.mChangedProperties = {};
							}
							if (!q.sap.equal(this.mProperties[p], v)) {
								var d = this.isDirty();
								if (!(p in this.mChangedProperties)) {
									this.mChangedProperties[p] = {
										oldValue : q
												.isArray(this.mProperties[p]) ? this.mProperties[p]
												.slice(0)
												: this.mProperties[p]
									};
									if (p === "modelMessages"
								...
								this.mProperties[p] = v;
								if ((!("dirty" in this.mChangedProperties))
										&& d !== this.isDirty()) {
						...
						D.prototype.getProperty = function(p) {
							...
							return this.mProperties[p];
						};
						D.prototype.getMessages = function() {
							var m = null, c = this.getControlMessages(), M = this
									.getModelMessages();
							if (M || c) {
								m = [].concat(M ? M : [], c ? c : []);
							}
						...
						D.prototype.setModelMessages = function(m) {
							return this._updateProperty("modelMessages", m
									|| null);
						};
						...
						D.prototype.setControlMessages = function(m) {
							return this._updateProperty("controlMessages", m
									|| null);
						};
						...
						D.prototype.getChanges = function() {
							for ( var n in this.mChangedProperties) {
								...
								if (this.mChangedProperties[n].oldValue === v) {
									delete this.mChangedProperties[n];
								} else {
									this.mChangedProperties[n].value = q
											.isArray(v) ? v.slice(0) : v;
								}
							}
										...
										"sap.ui.model.Filter",
										{
											constructor : function(p, o, v, V) {
												...
												if (!String.prototype.normalize
														&& typeof this.oValue1 == "string"
														&& !D.browser.mobile) {
													q.sap
															.require("jquery.sap.unicode");
												}
												if (q.isArray(this.aFilters)
														&& !this.sPath
														&& !this.sOperator
														&& !this.oValue1
														&& !this.oValue2) {
													...
													q
															.each(
																	...
																	function(i,
																		...
																		if (!(b instanceof a)) {
																			q.sap.log
																					.error("Filter in Aggregation of Multi filter has to be instance of sap.ui.model.Filter");
																		}
																	});
												} else if (!this.aFilters
														&& this.sPath !== undefined
														&& ((this.sOperator && this.oValue1 !== undefined) || this.fnTest)) {
													this._bMultiFilter = false;
												} else {
													q.sap.log
															.error("Wrong parameters defined for filter.");
												}
											}
										});
						return a;
			...
			.predefine(
					...
					function(q) {
						...
						F.apply = function(d, f, g) {
							...
							var t = this, o = {}, a, b = [], G = false, c = true;
							q.each(f, function(j, e) {
								if (e.sPath !== undefined) {
									a = o[e.sPath];
									if (!a) {
										a = o[e.sPath] = [];
									}
						...
						F._resolveMultiFilter = function(m, r, g) {
							var t = this, M = false, f = m.aFilters;
							if (f) {
						...
						F.getFilterFunction = function(f) {
							...
							var v = this.normalizeFilterValue(f.oValue1), V = this
									.normalizeFilterValue(f.oValue2);
							switch (f.sOperator) {
							case "EQ":
								f.fnTest = function(a) {
									return a == v;
							...
							case "StartsWith":
								f.fnTest = function(a) {
									...
									if (typeof a != "string") {
										throw new Error(
												"Only \"String\" values are supported for the FilterOperator: \"StartsWith\".");
									}
							...
							case "EndsWith":
								f.fnTest = function(a) {
									...
									if (typeof a != "string") {
										throw new Error(
												"Only \"String\" values are supported for the FilterOperator: \"EndsWith\".");
									}
	...
	sap.ui.predefine('sap/ui/model/FormatException', [ 'jquery.sap.global',
			'sap/ui/base/Exception' ], function(q, E) {
		"use strict";
		var F = function(m) {
	...
	sap.ui
			.predefine(
					...
					[ 'jquery.sap.global', './Binding', './Filter', './Sorter' ],
					function(q, B, F, S) {
						"use strict";
						var L = B.extend("sap.ui.model.ListBinding", {
							constructor : function(m, p, c, s, f, P) {
								B.call(this, m, p, c, P);
								this.aSorters = s;
								if (!q.isArray(this.aSorters)
										&& this.aSorters instanceof S) {
									this.aSorters = [ this.aSorters ];
								} else if (!q.isArray(this.aSorters)) {
									this.aSorters = [];
								}
								this.aFilters = [];
								if (!q.isArray(f) && f instanceof F) {
									f = [ f ];
								} else if (!q.isArray(f)) {
									f = [];
								}
							...
							metadata : {
								"abstract" : true,
								publicMethods : [ "getContexts",
										"getCurrentContexts", "sort",
										"attachSort", "detachSort", "filter",
										"attachFilter", "detachFilter",
										"getDistinctValues", "isGrouped",
										"getLength", "isLengthFinal" ]
							}
						});
						...
						L.prototype.enableExtendedChangeDetection = function() {
			...
			.predefine(
					...
					function(q, M, B, C) {
						...
						var a = M.extend("sap.ui.model.Model", {
							...
							metadata : {
								"abstract" : true,
								publicMethods : [ "bindProperty", "bindList",
										"bindTree", "bindContext",
										"createBindingContext",
										"destroyBindingContext", "getProperty",
						...
						a.prototype.attachRequestFailed = function(d, f, l) {
							this.attachEvent("requestFailed", d, f, l);
							return this;
						};
						a.prototype.detachRequestFailed = function(f, l) {
							this.detachEvent("requestFailed", f, l);
							return this;
						};
						a.prototype.fireRequestFailed = function(A) {
							this.fireEvent("requestFailed", A);
							return this;
						};
						a.prototype.attachParseError = function(d, f, l) {
							this.attachEvent("parseError", d, f, l);
							return this;
						};
						a.prototype.detachParseError = function(f, l) {
							this.detachEvent("parseError", f, l);
							return this;
						};
						a.prototype.fireParseError = function(A) {
							this.fireEvent("parseError", A);
							return this;
						};
						a.prototype.attachRequestSent = function(d, f, l) {
							this.attachEvent("requestSent", d, f, l);
							return this;
						};
						a.prototype.detachRequestSent = function(f, l) {
							this.detachEvent("requestSent", f, l);
							return this;
						};
						a.prototype.fireRequestSent = function(A) {
							this.fireEvent("requestSent", A);
							return this;
						};
						a.prototype.attachRequestCompleted = function(d, f, l) {
							this.attachEvent("requestCompleted", d, f, l);
							return this;
						};
						a.prototype.detachRequestCompleted = function(f, l) {
							this.detachEvent("requestCompleted", f, l);
							return this;
						};
						a.prototype.fireRequestCompleted = function(A) {
							this.fireEvent("requestCompleted", A);
							return this;
						};
						a.prototype.attachMessageChange = function(d, f, l) {
							this.attachEvent("messageChange", d, f, l);
							return this;
						};
						a.prototype.detachMessageChange = function(f, l) {
							this.detachEvent("messageChange", f, l);
							return this;
						};
						...
						a.prototype.resolve = function(p, c) {
							var i = typeof p == "string"
									&& !q.sap.startsWith(p, "/"), r = p, s;
							if (i) {
								if (c) {
									s = c.getPath();
									r = s + (q.sap.endsWith(s, "/") ? "" : "/")
											+ p;
								} else {
									r = this.isLegacySyntax() ? "/" + p
											: undefined;
								}
							}
							if (!p && c) {
						...
						a.prototype.addBinding = function(b) {
						...
						a.prototype.checkUpdate = function(f, A) {
							if (A) {
								if (!this.sUpdateTimer) {
									this.sUpdateTimer = q.sap.delayedCall(0,
											this, function() {
												this.checkUpdate(f);
											});
								}
						...
						a.prototype.setMessages = function(m) {
							this.mMessages = m || {};
							this.checkMessages();
						};
						...
						a.prototype.checkMessages = function() {
	...
	sap.ui.predefine('sap/ui/model/ParseException', [ 'jquery.sap.global',
			'sap/ui/base/Exception' ], function(q, E) {
		"use strict";
		var P = function(m) {
	...
	sap.ui
			.predefine(
					...
					[ 'jquery.sap.global', './Binding', './SimpleType',
							'./DataState' ],
					function(q, B, S, D) {
						"use strict";
						var P = B.extend("sap.ui.model.PropertyBinding", {
							...
							metadata : {
								"abstract" : true,
								publicMethods : [ "getValue", "setValue",
										"setType", "getType", "setFormatter",
										"getFormatter", "getExternalValue",
						...
						P.prototype._updateDataState = function() {
							var d = B.prototype._updateDataState.call(this);
							if (this.oModel && this.sPath) {
								d.setInvalidValue(this.vInvalidValue);
								try {
									var o = this.oModel.getOriginalProperty(
											this.sPath, this.oContext);
									d
									...
									q.sap.log
											.debug("type validation of original model value failed");
								}
								try {
									d.setValue(this.getExternalValue());
								} catch (e) {
									q.sap.log
											.debug("formatting of value failed");
								}
							}
							d.setInternalValue(this.getValue());
							return d;
						};
						return P;
					});
	sap.ui.predefine('sap/ui/model/SimpleType', [ 'sap/ui/base/DataType',
			'./FormatException', './ParseException', './Type',
			'./ValidateException' ], function(D, F, P, T, V) {
		"use strict";
		var S = T.extend("sap.ui.model.SimpleType", {
			...
			metadata : {
				"abstract" : true,
				publicMethods : [ "setConstraints", "setFormatOptions",
	...
	sap.ui.predefine('sap/ui/model/Sorter', [ 'sap/ui/base/Object' ], function(
			B) {
		"use strict";
		var S = B.extend("sap.ui.model.Sorter", {
			constructor : function(p, d, g) {
				if (typeof p === "object") {
					var s = p;
					p = s.path;
					d = s.descending;
			...
			function(q) {
				...
				S.apply = function(d, s, g, G) {
					...
					d.sort(function(a, b) {
						...
						var e = c[0][a], h = c[0][b];
						return t._applySortCompare(s, a, b, e, h, c, C, 0);
					});
					return d;
				};
				S._applySortCompare = function(s, a, b, v, c, d, C, D) {
					var o = s[D], f = C[D], r;
					r = f(v, c);
					if (o.bDescending) {
						r = -r;
					...
					if (r == 0 && s[D + 1]) {
						v = d[D + 1][a];
						c = d[D + 1][b];
						r = this._applySortCompare(s, a, b, v, c, d, C, D + 1);
					}
					return r;
				};
				return S;
			});
	sap.ui.predefine('sap/ui/model/TreeBinding', [ './Binding' ], function(B) {
		"use strict";
		var T = B.extend("sap.ui.model.TreeBinding", {
			...
			metadata : {
				"abstract" : true,
				publicMethods : [ "getRootContexts", "getNodeContexts",
						"hasChildren", "filter" ]
			}
		});
	...
	sap.ui.predefine('sap/ui/model/ValidateException', [ 'jquery.sap.global',
			'sap/ui/base/Exception' ], function(q, E) {
		"use strict";
		var V = function(m, v) {
	...
	sap.ui.predefine('sap/ui/model/message/MessageListBinding', [
			'jquery.sap.global', 'sap/ui/model/ChangeReason',
			'sap/ui/model/ClientListBinding' ], function(q, C, a) {
		"use strict";
		...
		M.prototype.getContexts = function(s, l) {
			...
			if (this.bUseExtendedChangeDetection) {
				...
				if (this.aLastContexts && s < this.iLastEndIndex) {
					var t = this;
					var d = q.sap.arrayDiff(this.aLastContexts, c, function(O,
							n) {
						return q.sap.equal(O && t.oLastContextData
								&& t.oLastContextData[O.getPath()], n && o
								&& o[n.getPath()]);
					});
					c.diff = d;
				}
		...
		M.prototype.checkUpdate = function(f) {
			...
			if (!this.bUseExtendedChangeDetection) {
				...
				var b = this._getContexts(this.iLastStartIndex,
						this.iLastLength);
				if (this.aLastContexts) {
					if (this.aLastContexts.length != b.length) {
						...
						q.each(this.aLastContexts, function(i, o) {
							if (!q.sap.equal(b[i].getObject(),
									t.oLastContextData[o.getPath()])) {
								c = true;
								return false;
							}
						});
	...
	sap.ui.predefine('sap/ui/model/message/MessageModel', [
			'jquery.sap.global', 'sap/ui/model/BindingMode',
			'sap/ui/model/ClientModel', 'sap/ui/model/Context',
			'./MessageListBinding', './MessagePropertyBinding' ], function(q,
			B, C, a, M, b) {
		"use strict";
	...
	sap.ui.predefine('sap/ui/model/message/MessagePropertyBinding', [
			'jquery.sap.global', 'sap/ui/model/ChangeReason',
			'sap/ui/model/ClientPropertyBinding' ], function(q, C, a) {
		"use strict";
