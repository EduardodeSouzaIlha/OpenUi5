 ...
 */
sap.ui.define([ 'jquery.sap.global', 'sap/ui/model/ChangeReason',
		'sap/ui/model/ClientListBinding' ], function(q, C, a) {
	"use strict";
	var J = a.extend("sap.ui.model.json.JSONListBinding");
	J.prototype.getContexts = function(s, l) {
	...
	J.prototype.getCurrentContexts = function() {
		if (this.bUseExtendedChangeDetection) {
	...
	J.prototype.updateIndices = function() {
		var i;
		this.aIndices = [];
		if (q.isArray(this.oList)) {
	...
	J.prototype.update = function() {
		...
		if (l) {
			if (q.isArray(l)) {
				...
				this.oList = q.extend(this.bUseExtendedChangeDetection, {}, l);
			}
			this.updateIndices();
			this.applyFilter();
			this.applySort();
	...
	J.prototype.checkUpdate = function(f) {
		...
		if (!this.bUseExtendedChangeDetection) {
			...
			var t = this;
			var l = this.oModel._getObject(this.sPath, this.oContext);
			if (l && this.oList.length != l.length) {
				c = true;
			}
			...
			if (this.aLastContexts) {
				if (this.aLastContexts.length != b.length) {
					...
					q.each(this.aLastContexts, function(i, o) {
						if (!q.sap.equal(b[i].getObject(), t.oLastContextData[o
								.getPath()])) {
							c = true;
							return false;
						}
